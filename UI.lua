...
local Themes = {
	...
	Light = {
		...
		AcrylicMain = Color3.fromRGB(245, 245, 245), -- ขาวนวล
		...
		ToggleToggled = Color3.fromRGB(0, 110, 255),
		...
		InputFocused = Color3.fromRGB(240, 240, 250),
		InputIndicator = Color3.fromRGB(180, 180, 180),
		InputIndicatorFocus = Color3.fromRGB(0, 110, 255),
		...
		DialogInputLine = Color3.fromRGB(0, 110, 255),
	...
	Balloon = {
		Name = "Balloon",
		Accent = Color3.fromRGB(20, 130, 255),
		AcrylicMain = Color3.fromRGB(210, 235, 255),
		AcrylicBorder = Color3.fromRGB(170, 210, 250),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(230, 245, 255), Color3.fromRGB(200, 225, 250)),
		AcrylicNoise = 0.9,
		TitleBarLine = Color3.fromRGB(150, 190, 240),
		Tab = Color3.fromRGB(180, 215, 250),
		Element = Color3.fromRGB(240, 250, 255),
		ElementBorder = Color3.fromRGB(160, 200, 240),
		InElementBorder = Color3.fromRGB(150, 190, 230),
		ElementTransparency = 0.80,
		ToggleSlider = Color3.fromRGB(130, 180, 240),
		ToggleToggled = Color3.fromRGB(20, 130, 255),
		SliderRail = Color3.fromRGB(160, 200, 240),
		DropdownFrame = Color3.fromRGB(240, 250, 255),
		DropdownHolder = Color3.fromRGB(210, 235, 255),
		DropdownBorder = Color3.fromRGB(160, 200, 240),
		DropdownOption = Color3.fromRGB(220, 240, 255),
		Keybind = Color3.fromRGB(220, 240, 255),
		Input = Color3.fromRGB(250, 252, 255),
		InputFocused = Color3.fromRGB(230, 245, 255),
		InputIndicator = Color3.fromRGB(150, 190, 240),
		InputIndicatorFocus = Color3.fromRGB(20, 130, 255),
		Dialog = Color3.fromRGB(240, 250, 255),
		DialogHolder = Color3.fromRGB(210, 235, 255),
		DialogHolderLine = Color3.fromRGB(170, 210, 250),
		DialogButton = Color3.fromRGB(230, 245, 255),
		DialogButtonBorder = Color3.fromRGB(160, 200, 240),
		DialogBorder = Color3.fromRGB(140, 180, 230),
		DialogInput = Color3.fromRGB(250, 252, 255),
		DialogInputLine = Color3.fromRGB(20, 130, 255),
		Text = Color3.fromRGB(20, 40, 70),
		SubText = Color3.fromRGB(80, 110, 150),
		Hover = Color3.fromRGB(220, 240, 255),
		HoverChange = 0.05
	},
	SoftCream = {
		Name = "SoftCream",
		Accent = Color3.fromRGB(230, 130, 30),
		AcrylicMain = Color3.fromRGB(255, 248, 235),
		AcrylicBorder = Color3.fromRGB(240, 220, 190),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 250, 240), Color3.fromRGB(250, 240, 220)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(230, 210, 180),
		Tab = Color3.fromRGB(240, 220, 190),
		Element = Color3.fromRGB(255, 255, 255),
		ElementBorder = Color3.fromRGB(240, 210, 170),
		InElementBorder = Color3.fromRGB(230, 200, 160),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(220, 190, 150),
		ToggleToggled = Color3.fromRGB(230, 130, 30),
		SliderRail = Color3.fromRGB(240, 220, 190),
		DropdownFrame = Color3.fromRGB(255, 255, 255),
		DropdownHolder = Color3.fromRGB(255, 248, 235),
		DropdownBorder = Color3.fromRGB(240, 210, 170),
		DropdownOption = Color3.fromRGB(250, 240, 220),
		Keybind = Color3.fromRGB(250, 240, 220),
		Input = Color3.fromRGB(255, 255, 255),
		InputFocused = Color3.fromRGB(255, 245, 230),
		InputIndicator = Color3.fromRGB(230, 200, 160),
		InputIndicatorFocus = Color3.fromRGB(230, 130, 30),
		Dialog = Color3.fromRGB(255, 255, 255),
		DialogHolder = Color3.fromRGB(255, 248, 235),
		DialogHolderLine = Color3.fromRGB(240, 220, 190),
		DialogButton = Color3.fromRGB(250, 240, 220),
		DialogButtonBorder = Color3.fromRGB(240, 210, 170),
		DialogBorder = Color3.fromRGB(220, 190, 150),
		DialogInput = Color3.fromRGB(255, 255, 255),
		DialogInputLine = Color3.fromRGB(230, 130, 30),
		Text = Color3.fromRGB(60, 40, 20),
		SubText = Color3.fromRGB(130, 100, 80),
		Hover = Color3.fromRGB(255, 245, 230),
		HoverChange = 0.05
	},
	Aqua = {
		Name = "Aqua",
		Accent = Color3.fromRGB(0, 255, 213),
		AcrylicMain = Color3.fromRGB(10, 25, 30),
		AcrylicBorder = Color3.fromRGB(25, 60, 70),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(8, 20, 25), Color3.fromRGB(12, 35, 40)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(30, 70, 80),
		Tab = Color3.fromRGB(15, 40, 50),
		Element = Color3.fromRGB(20, 50, 60),
		ElementBorder = Color3.fromRGB(30, 75, 85),
		InElementBorder = Color3.fromRGB(35, 85, 95),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(30, 75, 85),
		ToggleToggled = Color3.fromRGB(0, 200, 170),
		SliderRail = Color3.fromRGB(30, 75, 85),
		DropdownFrame = Color3.fromRGB(20, 50, 60),
		DropdownHolder = Color3.fromRGB(10, 25, 30),
		DropdownBorder = Color3.fromRGB(30, 75, 85),
		DropdownOption = Color3.fromRGB(25, 60, 70),
		Keybind = Color3.fromRGB(25, 60, 70),
		Input = Color3.fromRGB(20, 50, 60),
		InputFocused = Color3.fromRGB(15, 35, 45),
		InputIndicator = Color3.fromRGB(40, 95, 110),
		InputIndicatorFocus = Color3.fromRGB(0, 255, 213),
		Dialog = Color3.fromRGB(15, 40, 50),
		DialogHolder = Color3.fromRGB(10, 25, 30),
		DialogHolderLine = Color3.fromRGB(25, 60, 70),
		DialogButton = Color3.fromRGB(20, 50, 60),
		DialogButtonBorder = Color3.fromRGB(35, 85, 95),
		DialogBorder = Color3.fromRGB(40, 95, 110),
		DialogInput = Color3.fromRGB(15, 35, 45),
		DialogInputLine = Color3.fromRGB(0, 255, 213),
		Text = Color3.fromRGB(255, 255, 255),
		SubText = Color3.fromRGB(150, 200, 210),
		Hover = Color3.fromRGB(30, 70, 80),
		HoverChange = 0.05,
	},
	Amethyst = {
		Name = "Amethyst",
		...
		AcrylicBorder = Color3.fromRGB(45, 20, 65),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 2, 18), Color3.fromRGB(20, 8, 35)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(55, 25, 80),
		Tab = Color3.fromRGB(25, 10, 45),
		Element = Color3.fromRGB(35, 15, 60),
		ElementBorder = Color3.fromRGB(60, 25, 90),
		InElementBorder = Color3.fromRGB(70, 30, 100),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(60, 25, 90),
		ToggleToggled = Color3.fromRGB(180, 50, 255),
		SliderRail = Color3.fromRGB(60, 25, 90),
		DropdownFrame = Color3.fromRGB(35, 15, 60),
		DropdownHolder = Color3.fromRGB(15, 5, 25),
		DropdownBorder = Color3.fromRGB(60, 25, 90),
		DropdownOption = Color3.fromRGB(45, 20, 75),
		Keybind = Color3.fromRGB(45, 20, 75),
		Input = Color3.fromRGB(35, 15, 60),
		InputFocused = Color3.fromRGB(25, 10, 45),
		InputIndicator = Color3.fromRGB(80, 35, 120),
		InputIndicatorFocus = Color3.fromRGB(180, 50, 255),
		Dialog = Color3.fromRGB(25, 10, 45),
		DialogHolder = Color3.fromRGB(15, 5, 25),
		DialogHolderLine = Color3.fromRGB(45, 20, 65),
		DialogButton = Color3.fromRGB(35, 15, 60),
		DialogButtonBorder = Color3.fromRGB(60, 25, 90),
		DialogBorder = Color3.fromRGB(70, 30, 100),
		DialogInput = Color3.fromRGB(25, 10, 45),
		DialogInputLine = Color3.fromRGB(180, 50, 255),
		Text = Color3.fromRGB(255, 255, 255),
		SubText = Color3.fromRGB(180, 150, 210),
		Hover = Color3.fromRGB(50, 20, 80),
		HoverChange = 0.05
	},
	Rose = {
		Name = "Rose",
		Accent = Color3.fromRGB(255, 50, 120), 
		AcrylicMain = Color3.fromRGB(25, 10, 15),
		AcrylicBorder = Color3.fromRGB(60, 20, 35),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 5, 10), Color3.fromRGB(35, 15, 20)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(80, 25, 45),
		Tab = Color3.fromRGB(40, 15, 25),
		Element = Color3.fromRGB(55, 20, 35),
		ElementBorder = Color3.fromRGB(85, 30, 55),
		InElementBorder = Color3.fromRGB(100, 35, 65),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(85, 30, 55),
		ToggleToggled = Color3.fromRGB(255, 50, 120),
		SliderRail = Color3.fromRGB(85, 30, 55),
		DropdownFrame = Color3.fromRGB(55, 20, 35),
		DropdownHolder = Color3.fromRGB(25, 10, 15),
		DropdownBorder = Color3.fromRGB(85, 30, 55),
		DropdownOption = Color3.fromRGB(70, 25, 45),
		Keybind = Color3.fromRGB(70, 25, 45),
		Input = Color3.fromRGB(55, 20, 35),
		InputFocused = Color3.fromRGB(40, 15, 25),
		InputIndicator = Color3.fromRGB(120, 40, 75),
		InputIndicatorFocus = Color3.fromRGB(255, 50, 120),
		Dialog = Color3.fromRGB(40, 15, 25),
		DialogHolder = Color3.fromRGB(25, 10, 15),
		DialogHolderLine = Color3.fromRGB(60, 20, 35),
		DialogButton = Color3.fromRGB(55, 20, 35),
		DialogButtonBorder = Color3.fromRGB(85, 30, 55),
		DialogBorder = Color3.fromRGB(100, 35, 65),
		DialogInput = Color3.fromRGB(40, 15, 25),
		DialogInputLine = Color3.fromRGB(255, 50, 120),
		Text = Color3.fromRGB(255, 255, 255),
		SubText = Color3.fromRGB(210, 150, 170),
		Hover = Color3.fromRGB(75, 25, 50),
		HoverChange = 0.05
	},
	Midnight = {
		Name = "Midnight",
		...
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 10, 15), Color3.fromRGB(20, 20, 25)),
		AcrylicNoise = 0.95,
		...
		InElementBorder = Color3.fromRGB(65, 65, 80),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(55, 55, 70),
		ToggleToggled = Color3.fromRGB(100, 120, 255),
		SliderRail = Color3.fromRGB(55, 55, 70),
		DropdownFrame = Color3.fromRGB(35, 35, 45),
		DropdownHolder = Color3.fromRGB(15, 15, 20),
		DropdownBorder = Color3.fromRGB(55, 55, 70),
		DropdownOption = Color3.fromRGB(45, 45, 60),
		Keybind = Color3.fromRGB(45, 45, 60),
		Input = Color3.fromRGB(35, 35, 45),
		InputFocused = Color3.fromRGB(25, 25, 35),
		InputIndicator = Color3.fromRGB(75, 75, 95),
		InputIndicatorFocus = Color3.fromRGB(100, 120, 255),
		Dialog = Color3.fromRGB(25, 25, 35),
		DialogHolder = Color3.fromRGB(15, 15, 20),
		DialogHolderLine = Color3.fromRGB(35, 35, 45),
		DialogButton = Color3.fromRGB(35, 35, 45),
		DialogButtonBorder = Color3.fromRGB(55, 55, 70),
		DialogBorder = Color3.fromRGB(65, 65, 80),
	...
	Forest = {
		...
		AcrylicBorder = Color3.fromRGB(25, 45, 30),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(5, 15, 8), Color3.fromRGB(15, 25, 18)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(35, 65, 45),
		Tab = Color3.fromRGB(15, 30, 20),
		Element = Color3.fromRGB(25, 45, 30),
		ElementBorder = Color3.fromRGB(40, 75, 50),
		InElementBorder = Color3.fromRGB(50, 90, 60),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(40, 75, 50),
		ToggleToggled = Color3.fromRGB(40, 220, 100),
		SliderRail = Color3.fromRGB(40, 75, 50),
		DropdownFrame = Color3.fromRGB(25, 45, 30),
		DropdownHolder = Color3.fromRGB(10, 20, 12),
		DropdownBorder = Color3.fromRGB(40, 75, 50),
		DropdownOption = Color3.fromRGB(35, 60, 40),
		Keybind = Color3.fromRGB(35, 60, 40),
		Input = Color3.fromRGB(25, 45, 30),
		InputFocused = Color3.fromRGB(15, 30, 20),
		InputIndicator = Color3.fromRGB(55, 100, 70),
		InputIndicatorFocus = Color3.fromRGB(40, 220, 100),
		Dialog = Color3.fromRGB(15, 30, 20),
		DialogHolder = Color3.fromRGB(10, 20, 12),
		DialogHolderLine = Color3.fromRGB(25, 45, 30),
		DialogButton = Color3.fromRGB(25, 45, 30),
		DialogButtonBorder = Color3.fromRGB(40, 75, 50),
		DialogBorder = Color3.fromRGB(50, 90, 60),
		DialogInput = Color3.fromRGB(15, 30, 20),
		DialogInputLine = Color3.fromRGB(40, 220, 100),
		Text = Color3.fromRGB(255, 255, 255),
		SubText = Color3.fromRGB(150, 190, 160),
		Hover = Color3.fromRGB(35, 65, 45),
		HoverChange = 0.05
	},
	Sunset = {
		Name = "Sunset",
		Accent = Color3.fromRGB(255, 140, 0), 
		AcrylicMain = Color3.fromRGB(25, 15, 10),
		AcrylicBorder = Color3.fromRGB(50, 30, 20),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 10, 5), Color3.fromRGB(35, 20, 15)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(70, 40, 25),
		Tab = Color3.fromRGB(35, 20, 15),
		Element = Color3.fromRGB(50, 30, 20),
		ElementBorder = Color3.fromRGB(80, 45, 30),
		InElementBorder = Color3.fromRGB(95, 55, 40),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(80, 45, 30),
		ToggleToggled = Color3.fromRGB(255, 140, 0),
		SliderRail = Color3.fromRGB(80, 45, 30),
		DropdownFrame = Color3.fromRGB(50, 30, 20),
		DropdownHolder = Color3.fromRGB(25, 15, 10),
		DropdownBorder = Color3.fromRGB(80, 45, 30),
		DropdownOption = Color3.fromRGB(65, 40, 25),
		Keybind = Color3.fromRGB(65, 40, 25),
		Input = Color3.fromRGB(50, 30, 20),
		InputFocused = Color3.fromRGB(35, 20, 15),
		InputIndicator = Color3.fromRGB(110, 60, 40),
		InputIndicatorFocus = Color3.fromRGB(255, 140, 0),
		Dialog = Color3.fromRGB(35, 20, 15),
		DialogHolder = Color3.fromRGB(25, 15, 10),
		DialogHolderLine = Color3.fromRGB(50, 30, 20),
		DialogButton = Color3.fromRGB(50, 30, 20),
		DialogButtonBorder = Color3.fromRGB(80, 45, 30),
		DialogBorder = Color3.fromRGB(95, 55, 40),
		DialogInput = Color3.fromRGB(35, 20, 15),
		DialogInputLine = Color3.fromRGB(255, 140, 0),
		Text = Color3.fromRGB(255, 255, 255),
		SubText = Color3.fromRGB(210, 170, 150),
		Hover = Color3.fromRGB(70, 40, 25),
		HoverChange = 0.05
	},
	Ocean = {
		Name = "Ocean",
		...
		AcrylicBorder = Color3.fromRGB(25, 35, 50),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(8, 10, 20), Color3.fromRGB(15, 25, 35)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(40, 55, 80),
		Tab = Color3.fromRGB(20, 30, 40),
		Element = Color3.fromRGB(30, 45, 65),
		ElementBorder = Color3.fromRGB(50, 75, 105),
		InElementBorder = Color3.fromRGB(60, 90, 125),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(50, 75, 105),
		ToggleToggled = Color3.fromRGB(0, 180, 255),
		SliderRail = Color3.fromRGB(50, 75, 105),
		DropdownFrame = Color3.fromRGB(30, 45, 65),
		DropdownHolder = Color3.fromRGB(10, 15, 25),
		DropdownBorder = Color3.fromRGB(50, 75, 105),
		DropdownOption = Color3.fromRGB(40, 60, 85),
		Keybind = Color3.fromRGB(40, 60, 85),
		Input = Color3.fromRGB(30, 45, 65),
		InputFocused = Color3.fromRGB(20, 30, 40),
		InputIndicator = Color3.fromRGB(70, 105, 145),
		InputIndicatorFocus = Color3.fromRGB(0, 180, 255),
		Dialog = Color3.fromRGB(20, 30, 40),
		DialogHolder = Color3.fromRGB(10, 15, 25),
		DialogHolderLine = Color3.fromRGB(25, 35, 50),
		DialogButton = Color3.fromRGB(30, 45, 65),
		DialogButtonBorder = Color3.fromRGB(50, 75, 105),
		DialogBorder = Color3.fromRGB(60, 90, 125),
		DialogInput = Color3.fromRGB(20, 30, 40),
		DialogInputLine = Color3.fromRGB(0, 180, 255),
		Text = Color3.fromRGB(255, 255, 255),
		SubText = Color3.fromRGB(150, 180, 210),
		Hover = Color3.fromRGB(45, 65, 95),
		HoverChange = 0.05
	},
	Emerald = {
		Name = "Emerald",
		Accent = Color3.fromRGB(0, 220, 140),
		AcrylicMain = Color3.fromRGB(10, 20, 15),
		AcrylicBorder = Color3.fromRGB(25, 45, 35),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(8, 15, 10), Color3.fromRGB(15, 25, 20)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(35, 65, 50),
		Tab = Color3.fromRGB(15, 30, 25),
		Element = Color3.fromRGB(25, 45, 35),
		ElementBorder = Color3.fromRGB(45, 80, 65),
		InElementBorder = Color3.fromRGB(55, 95, 75),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(45, 80, 65),
		ToggleToggled = Color3.fromRGB(0, 220, 140),
		SliderRail = Color3.fromRGB(45, 80, 65),
		DropdownFrame = Color3.fromRGB(25, 45, 35),
		DropdownHolder = Color3.fromRGB(10, 20, 15),
		DropdownBorder = Color3.fromRGB(45, 80, 65),
		DropdownOption = Color3.fromRGB(35, 60, 50),
		Keybind = Color3.fromRGB(35, 60, 50),
		Input = Color3.fromRGB(25, 45, 35),
		InputFocused = Color3.fromRGB(15, 30, 25),
		InputIndicator = Color3.fromRGB(60, 110, 90),
		InputIndicatorFocus = Color3.fromRGB(0, 220, 140),
		Dialog = Color3.fromRGB(15, 30, 25),
		DialogHolder = Color3.fromRGB(10, 20, 15),
		DialogHolderLine = Color3.fromRGB(25, 45, 35),
		DialogButton = Color3.fromRGB(25, 45, 35),
		DialogButtonBorder = Color3.fromRGB(45, 80, 65),
		DialogBorder = Color3.fromRGB(55, 95, 75),
		DialogInput = Color3.fromRGB(15, 30, 25),
		DialogInputLine = Color3.fromRGB(0, 220, 140),
		Text = Color3.fromRGB(255, 255, 255),
		SubText = Color3.fromRGB(140, 190, 160),
		Hover = Color3.fromRGB(35, 65, 50),
		HoverChange = 0.05
	},
	Sapphire = {
		Name = "Sapphire",
		...
		AcrylicBorder = Color3.fromRGB(25, 35, 60),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(5, 10, 25), Color3.fromRGB(15, 20, 40)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(40, 55, 90),
		Tab = Color3.fromRGB(15, 25, 45),
		Element = Color3.fromRGB(25, 40, 70),
		ElementBorder = Color3.fromRGB(45, 70, 110),
		InElementBorder = Color3.fromRGB(55, 85, 130),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(45, 70, 110),
		ToggleToggled = Color3.fromRGB(20, 120, 255),
		SliderRail = Color3.fromRGB(45, 70, 110),
		DropdownFrame = Color3.fromRGB(25, 40, 70),
		DropdownHolder = Color3.fromRGB(10, 15, 30),
		DropdownBorder = Color3.fromRGB(45, 70, 110),
		DropdownOption = Color3.fromRGB(35, 55, 90),
		Keybind = Color3.fromRGB(35, 55, 90),
		Input = Color3.fromRGB(25, 40, 70),
		InputFocused = Color3.fromRGB(15, 25, 45),
		InputIndicator = Color3.fromRGB(60, 95, 145),
		InputIndicatorFocus = Color3.fromRGB(20, 120, 255),
		Dialog = Color3.fromRGB(15, 25, 45),
		DialogHolder = Color3.fromRGB(10, 15, 30),
		DialogHolderLine = Color3.fromRGB(25, 35, 60),
		DialogButton = Color3.fromRGB(25, 40, 70),
		DialogButtonBorder = Color3.fromRGB(45, 70, 110),
		DialogBorder = Color3.fromRGB(55, 85, 130),
		DialogInput = Color3.fromRGB(15, 25, 45),
		DialogInputLine = Color3.fromRGB(20, 120, 255),
		Text = Color3.fromRGB(255, 255, 255),
		SubText = Color3.fromRGB(160, 180, 220),
		Hover = Color3.fromRGB(35, 55, 90),
		HoverChange = 0.05
	},
	Cloud = {
		Name = "Cloud",
		...
		AcrylicBorder = Color3.fromRGB(40, 50, 60),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(15, 20, 25), Color3.fromRGB(25, 30, 35)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(60, 70, 80),
		Tab = Color3.fromRGB(30, 35, 45),
		Element = Color3.fromRGB(40, 50, 60),
		ElementBorder = Color3.fromRGB(70, 85, 100),
		InElementBorder = Color3.fromRGB(85, 100, 115),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(70, 85, 100),
		ToggleToggled = Color3.fromRGB(0, 200, 255),
		SliderRail = Color3.fromRGB(70, 85, 100),
		DropdownFrame = Color3.fromRGB(40, 50, 60),
		DropdownHolder = Color3.fromRGB(20, 25, 30),
		DropdownBorder = Color3.fromRGB(70, 85, 100),
		DropdownOption = Color3.fromRGB(55, 65, 80),
		Keybind = Color3.fromRGB(55, 65, 80),
		Input = Color3.fromRGB(40, 50, 60),
		InputFocused = Color3.fromRGB(30, 35, 45),
		InputIndicator = Color3.fromRGB(90, 110, 130),
		InputIndicatorFocus = Color3.fromRGB(0, 200, 255),
		Dialog = Color3.fromRGB(30, 35, 45),
		DialogHolder = Color3.fromRGB(20, 25, 30),
		DialogHolderLine = Color3.fromRGB(40, 50, 60),
		DialogButton = Color3.fromRGB(40, 50, 60),
		DialogButtonBorder = Color3.fromRGB(70, 85, 100),
		DialogBorder = Color3.fromRGB(85, 100, 115),
		DialogInput = Color3.fromRGB(30, 35, 45),
	...
	Grape = {
		...
		AcrylicMain = Color3.fromRGB(10, 5, 15),
		AcrylicBorder = Color3.fromRGB(25, 15, 35),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(5, 0, 10), Color3.fromRGB(15, 10, 20)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(45, 25, 60),
		Tab = Color3.fromRGB(20, 10, 30),
		Element = Color3.fromRGB(30, 15, 45),
		ElementBorder = Color3.fromRGB(55, 30, 80),
		InElementBorder = Color3.fromRGB(70, 40, 100),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(55, 30, 80),
		ToggleToggled = Color3.fromRGB(180, 80, 255),
		SliderRail = Color3.fromRGB(55, 30, 80),
		DropdownFrame = Color3.fromRGB(30, 15, 45),
		DropdownHolder = Color3.fromRGB(10, 5, 15),
		DropdownBorder = Color3.fromRGB(55, 30, 80),
		DropdownOption = Color3.fromRGB(40, 20, 60),
		Keybind = Color3.fromRGB(40, 20, 60),
		Input = Color3.fromRGB(30, 15, 45),
		InputFocused = Color3.fromRGB(20, 10, 30),
		InputIndicator = Color3.fromRGB(80, 45, 120),
		InputIndicatorFocus = Color3.fromRGB(180, 80, 255),
		Dialog = Color3.fromRGB(20, 10, 30),
		DialogHolder = Color3.fromRGB(10, 5, 15),
		DialogHolderLine = Color3.fromRGB(25, 15, 35),
		DialogButton = Color3.fromRGB(30, 15, 45),
		DialogButtonBorder = Color3.fromRGB(55, 30, 80),
		DialogBorder = Color3.fromRGB(70, 40, 100),
		DialogInput = Color3.fromRGB(20, 10, 30),
		DialogInputLine = Color3.fromRGB(180, 80, 255),
		Text = Color3.fromRGB(255, 255, 255),
		SubText = Color3.fromRGB(160, 130, 190),
		Hover = Color3.fromRGB(45, 25, 65),
		HoverChange = 0.05
	},
	Bloody = {
		Name = "Bloody",
		Accent = Color3.fromRGB(255, 40, 40), 
		AcrylicMain = Color3.fromRGB(15, 5, 5),
		AcrylicBorder = Color3.fromRGB(35, 10, 10),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 0, 0), Color3.fromRGB(20, 5, 5)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(60, 15, 15),
		Tab = Color3.fromRGB(25, 10, 10),
		Element = Color3.fromRGB(40, 10, 10),
		ElementBorder = Color3.fromRGB(80, 20, 20),
		InElementBorder = Color3.fromRGB(100, 25, 25),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(80, 20, 20),
		ToggleToggled = Color3.fromRGB(255, 40, 40),
		SliderRail = Color3.fromRGB(80, 20, 20),
		DropdownFrame = Color3.fromRGB(40, 10, 10),
		DropdownHolder = Color3.fromRGB(15, 5, 5),
		DropdownBorder = Color3.fromRGB(80, 20, 20),
		DropdownOption = Color3.fromRGB(55, 15, 15),
		Keybind = Color3.fromRGB(55, 15, 15),
		Input = Color3.fromRGB(40, 10, 10),
		InputFocused = Color3.fromRGB(25, 10, 10),
		InputIndicator = Color3.fromRGB(120, 30, 30),
		InputIndicatorFocus = Color3.fromRGB(255, 40, 40),
		Dialog = Color3.fromRGB(25, 10, 10),
		DialogHolder = Color3.fromRGB(15, 5, 5),
		DialogHolderLine = Color3.fromRGB(35, 10, 10),
		DialogButton = Color3.fromRGB(40, 10, 10),
		DialogButtonBorder = Color3.fromRGB(80, 20, 20),
		DialogBorder = Color3.fromRGB(100, 25, 25),
	...
	Arctic = {
		...
		AcrylicMain = Color3.fromRGB(10, 15, 20),
		AcrylicBorder = Color3.fromRGB(25, 35, 45),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(8, 12, 18), Color3.fromRGB(15, 20, 28)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(40, 55, 70),
		Tab = Color3.fromRGB(18, 25, 35),
		Element = Color3.fromRGB(28, 40, 55),
		ElementBorder = Color3.fromRGB(45, 65, 85),
		InElementBorder = Color3.fromRGB(55, 80, 105),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(45, 65, 85),
		ToggleToggled = Color3.fromRGB(0, 230, 255),
		SliderRail = Color3.fromRGB(45, 65, 85),
		DropdownFrame = Color3.fromRGB(28, 40, 55),
		DropdownHolder = Color3.fromRGB(10, 15, 20),
		DropdownBorder = Color3.fromRGB(45, 65, 85),
		DropdownOption = Color3.fromRGB(38, 55, 75),
		Keybind = Color3.fromRGB(38, 55, 75),
		Input = Color3.fromRGB(28, 40, 55),
		InputFocused = Color3.fromRGB(18, 25, 35),
		InputIndicator = Color3.fromRGB(65, 95, 125),
		InputIndicatorFocus = Color3.fromRGB(0, 230, 255),
		Dialog = Color3.fromRGB(18, 25, 35),
		DialogHolder = Color3.fromRGB(10, 15, 20),
		DialogHolderLine = Color3.fromRGB(25, 35, 45),
		DialogButton = Color3.fromRGB(28, 40, 55),
		DialogButtonBorder = Color3.fromRGB(45, 65, 85),
		DialogBorder = Color3.fromRGB(55, 80, 105),
		DialogInput = Color3.fromRGB(18, 25, 35),
		DialogInputLine = Color3.fromRGB(0, 230, 255),
		Text = Color3.fromRGB(255, 255, 255),
		SubText = Color3.fromRGB(160, 180, 200),
		Hover = Color3.fromRGB(40, 60, 80),
		HoverChange = 0.05
	},
	DeepBlue = {
		Name = "DeepBlue",
		Accent = Color3.fromRGB(0, 140, 255), 
		AcrylicMain = Color3.fromRGB(5, 7, 12), 
		AcrylicBorder = Color3.fromRGB(15, 22, 35),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(2, 3, 5), Color3.fromRGB(8, 12, 22)), 
		AcrylicNoise = 0.96,
		TitleBarLine = Color3.fromRGB(25, 35, 55),
		Tab = Color3.fromRGB(10, 14, 24),
		Element = Color3.fromRGB(15, 20, 32), 
		ElementBorder = Color3.fromRGB(30, 42, 65),
		InElementBorder = Color3.fromRGB(35, 50, 75),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(30, 42, 65),
		ToggleToggled = Color3.fromRGB(0, 140, 255),
		SliderRail = Color3.fromRGB(30, 42, 65),
		DropdownFrame = Color3.fromRGB(15, 20, 32),
		DropdownHolder = Color3.fromRGB(5, 7, 12),
		DropdownBorder = Color3.fromRGB(30, 42, 65),
		DropdownOption = Color3.fromRGB(20, 28, 45),
		Keybind = Color3.fromRGB(20, 28, 45),
		Input = Color3.fromRGB(15, 20, 32),
		InputFocused = Color3.fromRGB(8, 12, 20),
		InputIndicator = Color3.fromRGB(40, 60, 90),
		InputIndicatorFocus = Color3.fromRGB(0, 140, 255),
		Dialog = Color3.fromRGB(10, 14, 24),
		DialogHolder = Color3.fromRGB(5, 7, 12),
		DialogHolderLine = Color3.fromRGB(15, 22, 35),
		DialogButton = Color3.fromRGB(15, 20, 32),
		DialogButtonBorder = Color3.fromRGB(30, 42, 65),
		DialogBorder = Color3.fromRGB(35, 50, 75),
		DialogInput = Color3.fromRGB(10, 14, 24),
