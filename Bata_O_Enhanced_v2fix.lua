...
local Themes = {
	...
	Neon = {
		...
		AcrylicBorder = Color3.fromRGB(0, 200, 130),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(5, 5, 20), Color3.fromRGB(8, 8, 25)),
		AcrylicNoise = 0.96,
		TitleBarLine = Color3.fromRGB(0, 180, 110),
		Tab = Color3.fromRGB(0, 180, 110),
		Element = Color3.fromRGB(0, 140, 90),
		ElementBorder = Color3.fromRGB(0, 80, 50),
		InElementBorder = Color3.fromRGB(0, 120, 80),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(0, 180, 110),
		ToggleToggled = Color3.fromRGB(0, 30, 20),
		SliderRail = Color3.fromRGB(0, 180, 110),
		DropdownFrame = Color3.fromRGB(0, 200, 130),
		DropdownHolder = Color3.fromRGB(5, 30, 20),
		DropdownBorder = Color3.fromRGB(0, 80, 50),
		DropdownOption = Color3.fromRGB(0, 160, 100),
		Keybind = Color3.fromRGB(0, 160, 100),
		Input = Color3.fromRGB(0, 140, 90),
		InputFocused = Color3.fromRGB(0, 10, 5),
		InputIndicator = Color3.fromRGB(0, 220, 150),
		InputIndicatorFocus = Color3.fromRGB(0, 255, 170),
		Dialog = Color3.fromRGB(5, 25, 18),
		DialogHolder = Color3.fromRGB(5, 20, 15),
		DialogHolderLine = Color3.fromRGB(0, 60, 40),
		DialogButton = Color3.fromRGB(5, 30, 22),
		DialogButtonBorder = Color3.fromRGB(0, 100, 65),
		DialogBorder = Color3.fromRGB(0, 90, 58),
		DialogInput = Color3.fromRGB(5, 30, 22),
		DialogInputLine = Color3.fromRGB(0, 180, 110),
		Text = Color3.fromRGB(0, 255, 180),
		SubText = Color3.fromRGB(0, 200, 140),
	...
	Cyberpunk = {
		...
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 5, 25), Color3.fromRGB(15, 5, 35)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(255, 0, 150),
		Tab = Color3.fromRGB(180, 0, 110),
		Element = Color3.fromRGB(140, 0, 85),
		ElementBorder = Color3.fromRGB(80, 0, 50),
		InElementBorder = Color3.fromRGB(120, 0, 75),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(200, 0, 120),
		ToggleToggled = Color3.fromRGB(40, 0, 25),
		SliderRail = Color3.fromRGB(255, 230, 0),
		DropdownFrame = Color3.fromRGB(255, 0, 160),
		DropdownHolder = Color3.fromRGB(15, 5, 30),
		DropdownBorder = Color3.fromRGB(80, 0, 50),
		DropdownOption = Color3.fromRGB(200, 0, 120),
		Keybind = Color3.fromRGB(255, 230, 0),
		Input = Color3.fromRGB(140, 0, 85),
		InputFocused = Color3.fromRGB(5, 0, 10),
		InputIndicator = Color3.fromRGB(255, 0, 160),
		InputIndicatorFocus = Color3.fromRGB(255, 230, 0),
		Dialog = Color3.fromRGB(15, 5, 30),
		DialogHolder = Color3.fromRGB(10, 5, 25),
		DialogHolderLine = Color3.fromRGB(80, 0, 50),
		DialogButton = Color3.fromRGB(15, 5, 30),
		DialogButtonBorder = Color3.fromRGB(130, 0, 80),
		DialogBorder = Color3.fromRGB(200, 0, 120),
		DialogInput = Color3.fromRGB(20, 5, 35),
		DialogInputLine = Color3.fromRGB(255, 0, 160),
		Text = Color3.fromRGB(255, 230, 0),
		SubText = Color3.fromRGB(255, 160, 200),
		Hover = Color3.fromRGB(200, 0, 120),
		HoverChange = 0.04
	},
	Pastel = {
		Name = "Pastel",
		Accent = Color3.fromRGB(180, 130, 210),
		AcrylicMain = Color3.fromRGB(248, 240, 255),
		AcrylicBorder = Color3.fromRGB(210, 185, 235),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(250, 245, 255), Color3.fromRGB(240, 235, 252)),
		AcrylicNoise = 0.96,
		TitleBarLine = Color3.fromRGB(200, 175, 225),
		Tab = Color3.fromRGB(190, 155, 220),
		Element = Color3.fromRGB(220, 195, 245),
		ElementBorder = Color3.fromRGB(185, 160, 215),
		InElementBorder = Color3.fromRGB(200, 175, 230),
		ElementTransparency = 0.70,
		ToggleSlider = Color3.fromRGB(180, 130, 210),
		ToggleToggled = Color3.fromRGB(240, 235, 255),
		SliderRail = Color3.fromRGB(210, 175, 240),
		DropdownFrame = Color3.fromRGB(220, 195, 245),
		DropdownHolder = Color3.fromRGB(245, 238, 255),
		DropdownBorder = Color3.fromRGB(185, 160, 215),
		DropdownOption = Color3.fromRGB(200, 165, 235),
		Keybind = Color3.fromRGB(180, 140, 215),
		Input = Color3.fromRGB(220, 195, 245),
		InputFocused = Color3.fromRGB(150, 100, 185),
		InputIndicator = Color3.fromRGB(190, 155, 225),
		InputIndicatorFocus = Color3.fromRGB(180, 130, 210),
		Dialog = Color3.fromRGB(250, 245, 255),
		DialogHolder = Color3.fromRGB(245, 238, 255),
		DialogHolderLine = Color3.fromRGB(225, 205, 248),
		DialogButton = Color3.fromRGB(250, 245, 255),
		DialogButtonBorder = Color3.fromRGB(200, 175, 230),
		DialogBorder = Color3.fromRGB(190, 160, 222),
		DialogInput = Color3.fromRGB(238, 228, 252),
		DialogInputLine = Color3.fromRGB(195, 160, 230),
		Text = Color3.fromRGB(60, 40, 80),
		SubText = Color3.fromRGB(130, 100, 160),
		Hover = Color3.fromRGB(200, 175, 230),
		HoverChange = 0.04
	},
	Coffee = {
		Name = "Coffee",
		Accent = Color3.fromRGB(200, 140, 70),
		AcrylicMain = Color3.fromRGB(30, 18, 10),
		AcrylicBorder = Color3.fromRGB(90, 60, 35),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(25, 15, 8), Color3.fromRGB(30, 20, 12)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(90, 60, 35),
		Tab = Color3.fromRGB(120, 80, 45),
		Element = Color3.fromRGB(90, 60, 35),
		ElementBorder = Color3.fromRGB(50, 30, 15),
		InElementBorder = Color3.fromRGB(75, 50, 28),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(150, 100, 55),
		ToggleToggled = Color3.fromRGB(30, 18, 8),
		SliderRail = Color3.fromRGB(150, 100, 55),
		DropdownFrame = Color3.fromRGB(160, 110, 65),
		DropdownHolder = Color3.fromRGB(40, 25, 12),
		DropdownBorder = Color3.fromRGB(55, 35, 18),
		DropdownOption = Color3.fromRGB(130, 88, 50),
		Keybind = Color3.fromRGB(140, 95, 52),
		Input = Color3.fromRGB(100, 66, 38),
		InputFocused = Color3.fromRGB(15, 10, 5),
		InputIndicator = Color3.fromRGB(175, 125, 70),
		InputIndicatorFocus = Color3.fromRGB(200, 140, 70),
		Dialog = Color3.fromRGB(40, 25, 14),
		DialogHolder = Color3.fromRGB(35, 22, 12),
		DialogHolderLine = Color3.fromRGB(58, 38, 20),
		DialogButton = Color3.fromRGB(45, 28, 15),
		DialogButtonBorder = Color3.fromRGB(85, 56, 30),
		DialogBorder = Color3.fromRGB(78, 52, 28),
		DialogInput = Color3.fromRGB(55, 36, 20),
		DialogInputLine = Color3.fromRGB(155, 108, 60),
		Text = Color3.fromRGB(240, 220, 195),
		SubText = Color3.fromRGB(180, 150, 120),
		Hover = Color3.fromRGB(120, 80, 45),
		HoverChange = 0.04
	},
	Dracula = {
		Name = "Dracula",
		...
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 31, 40), Color3.fromRGB(35, 36, 48)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(68, 71, 90),
		Tab = Color3.fromRGB(100, 105, 135),
		Element = Color3.fromRGB(68, 71, 90),
		ElementBorder = Color3.fromRGB(40, 42, 54),
		InElementBorder = Color3.fromRGB(58, 61, 78),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(100, 105, 135),
		ToggleToggled = Color3.fromRGB(30, 31, 40),
		SliderRail = Color3.fromRGB(100, 105, 135),
		DropdownFrame = Color3.fromRGB(110, 115, 145),
		DropdownHolder = Color3.fromRGB(40, 42, 54),
		DropdownBorder = Color3.fromRGB(40, 42, 54),
		DropdownOption = Color3.fromRGB(90, 95, 120),
		Keybind = Color3.fromRGB(100, 105, 135),
		Input = Color3.fromRGB(68, 71, 90),
		InputFocused = Color3.fromRGB(20, 21, 28),
		InputIndicator = Color3.fromRGB(130, 138, 170),
		InputIndicatorFocus = Color3.fromRGB(189, 147, 249),
		Dialog = Color3.fromRGB(40, 42, 54),
		DialogHolder = Color3.fromRGB(33, 34, 44),
		DialogHolderLine = Color3.fromRGB(55, 58, 74),
		DialogButton = Color3.fromRGB(48, 50, 65),
		DialogButtonBorder = Color3.fromRGB(68, 71, 90),
		DialogBorder = Color3.fromRGB(98, 114, 164),
		DialogInput = Color3.fromRGB(50, 52, 68),
		DialogInputLine = Color3.fromRGB(130, 138, 170),
		Text = Color3.fromRGB(248, 248, 242),
		SubText = Color3.fromRGB(189, 147, 249),
		Hover = Color3.fromRGB(80, 85, 108),
		HoverChange = 0.04
	},
	Nord = {
		Name = "Nord",
		...
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(36, 41, 51), Color3.fromRGB(41, 46, 58)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(67, 76, 94),
		Tab = Color3.fromRGB(100, 115, 140),
		Element = Color3.fromRGB(67, 76, 94),
		ElementBorder = Color3.fromRGB(46, 52, 64),
		InElementBorder = Color3.fromRGB(58, 66, 80),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(100, 115, 140),
		ToggleToggled = Color3.fromRGB(30, 34, 43),
		SliderRail = Color3.fromRGB(136, 192, 208),
		DropdownFrame = Color3.fromRGB(110, 125, 152),
		DropdownHolder = Color3.fromRGB(46, 52, 64),
		DropdownBorder = Color3.fromRGB(46, 52, 64),
		DropdownOption = Color3.fromRGB(90, 103, 125),
		Keybind = Color3.fromRGB(100, 115, 140),
		Input = Color3.fromRGB(67, 76, 94),
		InputFocused = Color3.fromRGB(20, 23, 29),
		InputIndicator = Color3.fromRGB(136, 192, 208),
		InputIndicatorFocus = Color3.fromRGB(180, 222, 236),
		Dialog = Color3.fromRGB(46, 52, 64),
		DialogHolder = Color3.fromRGB(36, 41, 51),
		DialogHolderLine = Color3.fromRGB(58, 66, 80),
		DialogButton = Color3.fromRGB(52, 58, 72),
		DialogButtonBorder = Color3.fromRGB(76, 86, 106),
		DialogBorder = Color3.fromRGB(90, 103, 125),
		DialogInput = Color3.fromRGB(55, 62, 76),
		DialogInputLine = Color3.fromRGB(120, 145, 175),
	...
	Catppuccin = {
		...
		AcrylicMain = Color3.fromRGB(30, 30, 46),
		AcrylicBorder = Color3.fromRGB(49, 50, 68),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(24, 24, 37), Color3.fromRGB(30, 30, 46)),
		AcrylicNoise = 0.94,
		TitleBarLine = Color3.fromRGB(69, 71, 90),
		Tab = Color3.fromRGB(108, 112, 134),
		Element = Color3.fromRGB(69, 71, 90),
		ElementBorder = Color3.fromRGB(49, 50, 68),
		InElementBorder = Color3.fromRGB(60, 62, 80),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(108, 112, 134),
		ToggleToggled = Color3.fromRGB(24, 24, 37),
		SliderRail = Color3.fromRGB(150, 162, 218),
		DropdownFrame = Color3.fromRGB(120, 125, 148),
		DropdownHolder = Color3.fromRGB(40, 41, 58),
		DropdownBorder = Color3.fromRGB(49, 50, 68),
		DropdownOption = Color3.fromRGB(100, 104, 126),
		Keybind = Color3.fromRGB(116, 120, 144),
		Input = Color3.fromRGB(69, 71, 90),
		InputFocused = Color3.fromRGB(17, 17, 27),
		InputIndicator = Color3.fromRGB(148, 226, 213),
		InputIndicatorFocus = Color3.fromRGB(203, 166, 247),
		Dialog = Color3.fromRGB(40, 41, 58),
		DialogHolder = Color3.fromRGB(30, 30, 46),
		DialogHolderLine = Color3.fromRGB(58, 60, 78),
		DialogButton = Color3.fromRGB(49, 50, 68),
		DialogButtonBorder = Color3.fromRGB(80, 84, 104),
		DialogBorder = Color3.fromRGB(108, 112, 134),
		DialogInput = Color3.fromRGB(54, 56, 74),
		DialogInputLine = Color3.fromRGB(130, 140, 180),
		Text = Color3.fromRGB(205, 214, 244),
		SubText = Color3.fromRGB(166, 173, 200),
		Hover = Color3.fromRGB(80, 84, 104),
		HoverChange = 0.04
	},
	TokyoNight = {
		Name = "TokyoNight",
		Accent = Color3.fromRGB(122, 162, 247),
		AcrylicMain = Color3.fromRGB(26, 27, 38),
		AcrylicBorder = Color3.fromRGB(41, 46, 66),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 22, 30), Color3.fromRGB(26, 27, 38)),
		AcrylicNoise = 0.94,
		TitleBarLine = Color3.fromRGB(41, 46, 66),
		Tab = Color3.fromRGB(70, 80, 115),
		Element = Color3.fromRGB(41, 46, 66),
		ElementBorder = Color3.fromRGB(26, 27, 38),
		InElementBorder = Color3.fromRGB(35, 40, 58),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(70, 80, 115),
		ToggleToggled = Color3.fromRGB(16, 16, 28),
		SliderRail = Color3.fromRGB(122, 162, 247),
		DropdownFrame = Color3.fromRGB(78, 88, 126),
		DropdownHolder = Color3.fromRGB(32, 34, 48),
		DropdownBorder = Color3.fromRGB(26, 27, 38),
		DropdownOption = Color3.fromRGB(62, 70, 102),
		Keybind = Color3.fromRGB(70, 80, 115),
		Input = Color3.fromRGB(41, 46, 66),
		InputFocused = Color3.fromRGB(13, 14, 20),
		InputIndicator = Color3.fromRGB(187, 154, 247),
		InputIndicatorFocus = Color3.fromRGB(122, 162, 247),
		Dialog = Color3.fromRGB(32, 34, 48),
		DialogHolder = Color3.fromRGB(26, 27, 38),
		DialogHolderLine = Color3.fromRGB(44, 50, 72),
		DialogButton = Color3.fromRGB(36, 40, 58),
		DialogButtonBorder = Color3.fromRGB(60, 68, 98),
		DialogBorder = Color3.fromRGB(80, 90, 130),
		DialogInput = Color3.fromRGB(40, 45, 65),
		DialogInputLine = Color3.fromRGB(100, 120, 180),
		Text = Color3.fromRGB(192, 202, 245),
		SubText = Color3.fromRGB(130, 145, 190),
		Hover = Color3.fromRGB(55, 62, 90),
		HoverChange = 0.04
	},
	Monokai = {
		Name = "Monokai",
		...
		AcrylicBorder = Color3.fromRGB(62, 63, 56),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 31, 26), Color3.fromRGB(39, 40, 34)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(62, 63, 56),
		Tab = Color3.fromRGB(100, 100, 88),
		Element = Color3.fromRGB(62, 63, 56),
		ElementBorder = Color3.fromRGB(39, 40, 34),
		InElementBorder = Color3.fromRGB(50, 51, 45),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(100, 100, 88),
		ToggleToggled = Color3.fromRGB(25, 26, 22),
		SliderRail = Color3.fromRGB(166, 226, 46),
		DropdownFrame = Color3.fromRGB(110, 110, 96),
		DropdownHolder = Color3.fromRGB(44, 45, 38),
		DropdownBorder = Color3.fromRGB(39, 40, 34),
		DropdownOption = Color3.fromRGB(90, 90, 80),
		Keybind = Color3.fromRGB(100, 100, 88),
		Input = Color3.fromRGB(62, 63, 56),
		InputFocused = Color3.fromRGB(18, 18, 15),
		InputIndicator = Color3.fromRGB(230, 219, 116),
		InputIndicatorFocus = Color3.fromRGB(166, 226, 46),
		Dialog = Color3.fromRGB(45, 46, 39),
		DialogHolder = Color3.fromRGB(39, 40, 34),
		DialogHolderLine = Color3.fromRGB(58, 59, 52),
		DialogButton = Color3.fromRGB(50, 51, 44),
		DialogButtonBorder = Color3.fromRGB(74, 75, 67),
		DialogBorder = Color3.fromRGB(90, 91, 80),
		DialogInput = Color3.fromRGB(54, 55, 48),
		DialogInputLine = Color3.fromRGB(130, 135, 115),
		Text = Color3.fromRGB(248, 248, 242),
		SubText = Color3.fromRGB(200, 200, 180),
		Hover = Color3.fromRGB(75, 76, 68),
		HoverChange = 0.04
	},
	Gruvbox = {
		Name = "Gruvbox",
		...
		AcrylicBorder = Color3.fromRGB(80, 73, 69),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(29, 32, 33), Color3.fromRGB(40, 40, 40)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(80, 73, 69),
		Tab = Color3.fromRGB(124, 111, 100),
		Element = Color3.fromRGB(80, 73, 69),
		ElementBorder = Color3.fromRGB(50, 48, 47),
		InElementBorder = Color3.fromRGB(68, 62, 59),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(124, 111, 100),
		ToggleToggled = Color3.fromRGB(29, 32, 33),
		SliderRail = Color3.fromRGB(250, 189, 47),
		DropdownFrame = Color3.fromRGB(140, 130, 115),
		DropdownHolder = Color3.fromRGB(50, 48, 47),
		DropdownBorder = Color3.fromRGB(40, 40, 40),
		DropdownOption = Color3.fromRGB(110, 100, 90),
		Keybind = Color3.fromRGB(124, 111, 100),
		Input = Color3.fromRGB(80, 73, 69),
		InputFocused = Color3.fromRGB(20, 20, 20),
		InputIndicator = Color3.fromRGB(200, 170, 95),
		InputIndicatorFocus = Color3.fromRGB(250, 189, 47),
		Dialog = Color3.fromRGB(50, 48, 47),
		DialogHolder = Color3.fromRGB(40, 40, 40),
		DialogHolderLine = Color3.fromRGB(68, 62, 59),
		DialogButton = Color3.fromRGB(60, 56, 54),
		DialogButtonBorder = Color3.fromRGB(90, 80, 74),
		DialogBorder = Color3.fromRGB(108, 96, 88),
		DialogInput = Color3.fromRGB(64, 60, 58),
		DialogInputLine = Color3.fromRGB(150, 135, 120),
		Text = Color3.fromRGB(235, 219, 178),
		SubText = Color3.fromRGB(189, 174, 147),
		Hover = Color3.fromRGB(90, 80, 74),
		HoverChange = 0.04
	},
	OneDark = {
		Name = "OneDark",
		Accent = Color3.fromRGB(97, 175, 239),
		AcrylicMain = Color3.fromRGB(40, 44, 52),
		AcrylicBorder = Color3.fromRGB(60, 66, 78),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 33, 40), Color3.fromRGB(40, 44, 52)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(60, 66, 78),
		Tab = Color3.fromRGB(92, 100, 118),
		Element = Color3.fromRGB(60, 66, 78),
		ElementBorder = Color3.fromRGB(40, 44, 52),
		InElementBorder = Color3.fromRGB(52, 57, 68),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(92, 100, 118),
		ToggleToggled = Color3.fromRGB(24, 26, 31),
		SliderRail = Color3.fromRGB(97, 175, 239),
		DropdownFrame = Color3.fromRGB(104, 112, 132),
		DropdownHolder = Color3.fromRGB(44, 48, 58),
		DropdownBorder = Color3.fromRGB(40, 44, 52),
		DropdownOption = Color3.fromRGB(80, 88, 104),
		Keybind = Color3.fromRGB(92, 100, 118),
		Input = Color3.fromRGB(60, 66, 78),
		InputFocused = Color3.fromRGB(18, 20, 25),
		InputIndicator = Color3.fromRGB(152, 195, 121),
		InputIndicatorFocus = Color3.fromRGB(97, 175, 239),
		Dialog = Color3.fromRGB(44, 48, 58),
		DialogHolder = Color3.fromRGB(40, 44, 52),
		DialogHolderLine = Color3.fromRGB(55, 61, 73),
		DialogButton = Color3.fromRGB(48, 53, 64),
		DialogButtonBorder = Color3.fromRGB(70, 77, 92),
		DialogBorder = Color3.fromRGB(88, 95, 112),
		DialogInput = Color3.fromRGB(52, 57, 68),
		DialogInputLine = Color3.fromRGB(120, 140, 170),
		Text = Color3.fromRGB(171, 178, 191),
		SubText = Color3.fromRGB(130, 140, 160),
		Hover = Color3.fromRGB(68, 74, 88),
		HoverChange = 0.04
	},
	Synthwave = {
		Name = "Synthwave",
		Accent = Color3.fromRGB(255, 120, 255),
		AcrylicMain = Color3.fromRGB(22, 15, 40),
		AcrylicBorder = Color3.fromRGB(100, 50, 150),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(15, 10, 30), Color3.fromRGB(22, 15, 40)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(255, 60, 220),
		Tab = Color3.fromRGB(160, 80, 200),
		Element = Color3.fromRGB(100, 50, 150),
		ElementBorder = Color3.fromRGB(55, 25, 85),
		InElementBorder = Color3.fromRGB(80, 40, 120),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(160, 80, 200),
		ToggleToggled = Color3.fromRGB(15, 10, 28),
		SliderRail = Color3.fromRGB(255, 120, 255),
		DropdownFrame = Color3.fromRGB(180, 95, 220),
		DropdownHolder = Color3.fromRGB(28, 18, 50),
		DropdownBorder = Color3.fromRGB(55, 25, 85),
		DropdownOption = Color3.fromRGB(140, 70, 180),
		Keybind = Color3.fromRGB(160, 80, 200),
		Input = Color3.fromRGB(100, 50, 150),
		InputFocused = Color3.fromRGB(10, 6, 20),
		InputIndicator = Color3.fromRGB(200, 100, 255),
		InputIndicatorFocus = Color3.fromRGB(255, 120, 255),
		Dialog = Color3.fromRGB(28, 18, 50),
		DialogHolder = Color3.fromRGB(22, 15, 40),
		DialogHolderLine = Color3.fromRGB(60, 30, 90),
		DialogButton = Color3.fromRGB(35, 22, 60),
		DialogButtonBorder = Color3.fromRGB(100, 50, 150),
		DialogBorder = Color3.fromRGB(150, 75, 200),
		DialogInput = Color3.fromRGB(40, 25, 68),
		DialogInputLine = Color3.fromRGB(180, 90, 240),
		Text = Color3.fromRGB(255, 120, 255),
		SubText = Color3.fromRGB(200, 160, 240),
		Hover = Color3.fromRGB(120, 60, 160),
		HoverChange = 0.04
	},
	Matrix = {
		Name = "Matrix",
		Accent = Color3.fromRGB(0, 255, 65),
		AcrylicMain = Color3.fromRGB(0, 8, 0),
		AcrylicBorder = Color3.fromRGB(0, 80, 0),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 5, 0), Color3.fromRGB(0, 10, 0)),
		AcrylicNoise = 0.97,
		TitleBarLine = Color3.fromRGB(0, 80, 0),
		Tab = Color3.fromRGB(0, 120, 0),
		Element = Color3.fromRGB(0, 60, 0),
		ElementBorder = Color3.fromRGB(0, 30, 0),
		InElementBorder = Color3.fromRGB(0, 50, 0),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(0, 140, 0),
		ToggleToggled = Color3.fromRGB(0, 5, 0),
		SliderRail = Color3.fromRGB(0, 255, 65),
		DropdownFrame = Color3.fromRGB(0, 160, 0),
		DropdownHolder = Color3.fromRGB(0, 15, 0),
		DropdownBorder = Color3.fromRGB(0, 40, 0),
		DropdownOption = Color3.fromRGB(0, 100, 0),
		Keybind = Color3.fromRGB(0, 120, 0),
		Input = Color3.fromRGB(0, 50, 0),
		InputFocused = Color3.fromRGB(0, 3, 0),
		InputIndicator = Color3.fromRGB(0, 200, 50),
		InputIndicatorFocus = Color3.fromRGB(0, 255, 65),
		Dialog = Color3.fromRGB(0, 15, 0),
		DialogHolder = Color3.fromRGB(0, 10, 0),
		DialogHolderLine = Color3.fromRGB(0, 40, 0),
		DialogButton = Color3.fromRGB(0, 20, 0),
		DialogButtonBorder = Color3.fromRGB(0, 70, 0),
		DialogBorder = Color3.fromRGB(0, 90, 0),
		DialogInput = Color3.fromRGB(0, 22, 0),
		DialogInputLine = Color3.fromRGB(0, 160, 40),
		Text = Color3.fromRGB(0, 255, 65),
		SubText = Color3.fromRGB(0, 180, 45),
		Hover = Color3.fromRGB(0, 80, 0),
		HoverChange = 0.04
	},
	Aurora = {
		Name = "Aurora",
		Accent = Color3.fromRGB(136, 255, 210),
		AcrylicMain = Color3.fromRGB(10, 15, 30),
		AcrylicBorder = Color3.fromRGB(50, 90, 120),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 20, 40), Color3.fromRGB(15, 25, 50)),
		AcrylicNoise = 0.94,
		TitleBarLine = Color3.fromRGB(60, 130, 150),
		Tab = Color3.fromRGB(80, 150, 170),
		Element = Color3.fromRGB(55, 105, 130),
		ElementBorder = Color3.fromRGB(30, 60, 80),
		InElementBorder = Color3.fromRGB(45, 85, 108),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(90, 170, 185),
		ToggleToggled = Color3.fromRGB(8, 14, 25),
		SliderRail = Color3.fromRGB(136, 255, 210),
		DropdownFrame = Color3.fromRGB(100, 185, 200),
		DropdownHolder = Color3.fromRGB(14, 22, 42),
		DropdownBorder = Color3.fromRGB(35, 70, 90),
		DropdownOption = Color3.fromRGB(78, 148, 168),
		Keybind = Color3.fromRGB(85, 160, 175),
		Input = Color3.fromRGB(55, 105, 130),
		InputFocused = Color3.fromRGB(6, 10, 20),
		InputIndicator = Color3.fromRGB(160, 255, 230),
		InputIndicatorFocus = Color3.fromRGB(136, 255, 210),
		Dialog = Color3.fromRGB(14, 22, 42),
		DialogHolder = Color3.fromRGB(10, 16, 32),
		DialogHolderLine = Color3.fromRGB(40, 75, 95),
		DialogButton = Color3.fromRGB(18, 28, 52),
		DialogButtonBorder = Color3.fromRGB(60, 110, 135),
		DialogBorder = Color3.fromRGB(80, 145, 168),
		DialogInput = Color3.fromRGB(20, 32, 58),
		DialogInputLine = Color3.fromRGB(100, 190, 210),
		Text = Color3.fromRGB(215, 255, 245),
		SubText = Color3.fromRGB(160, 220, 210),
		Hover = Color3.fromRGB(65, 120, 145),
		HoverChange = 0.04
	},
	Inferno = {
		Name = "Inferno",
		Accent = Color3.fromRGB(255, 100, 20),
		AcrylicMain = Color3.fromRGB(20, 8, 0),
		AcrylicBorder = Color3.fromRGB(140, 40, 0),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(25, 5, 0), Color3.fromRGB(30, 8, 0)),
		AcrylicNoise = 0.94,
		TitleBarLine = Color3.fromRGB(180, 55, 0),
		Tab = Color3.fromRGB(200, 70, 10),
		Element = Color3.fromRGB(150, 50, 5),
		ElementBorder = Color3.fromRGB(80, 22, 0),
		InElementBorder = Color3.fromRGB(120, 38, 2),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(220, 80, 15),
		ToggleToggled = Color3.fromRGB(18, 5, 0),
		SliderRail = Color3.fromRGB(255, 100, 20),
		DropdownFrame = Color3.fromRGB(230, 90, 18),
		DropdownHolder = Color3.fromRGB(28, 10, 0),
		DropdownBorder = Color3.fromRGB(85, 25, 0),
		DropdownOption = Color3.fromRGB(180, 62, 8),
		Keybind = Color3.fromRGB(200, 70, 10),
		Input = Color3.fromRGB(140, 45, 4),
		InputFocused = Color3.fromRGB(10, 3, 0),
		InputIndicator = Color3.fromRGB(255, 140, 60),
		InputIndicatorFocus = Color3.fromRGB(255, 100, 20),
		Dialog = Color3.fromRGB(28, 9, 0),
		DialogHolder = Color3.fromRGB(22, 7, 0),
		DialogHolderLine = Color3.fromRGB(88, 28, 0),
		DialogButton = Color3.fromRGB(35, 12, 0),
		DialogButtonBorder = Color3.fromRGB(130, 40, 2),
		DialogBorder = Color3.fromRGB(175, 55, 5),
		DialogInput = Color3.fromRGB(40, 14, 0),
		DialogInputLine = Color3.fromRGB(210, 80, 15),
		Text = Color3.fromRGB(255, 220, 190),
		SubText = Color3.fromRGB(220, 160, 120),
		Hover = Color3.fromRGB(170, 58, 8),
		HoverChange = 0.04
	},
	Sakura = {
		Name = "Sakura",
		Accent = Color3.fromRGB(255, 130, 160),
		AcrylicMain = Color3.fromRGB(50, 25, 35),
		AcrylicBorder = Color3.fromRGB(180, 100, 130),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 20, 28), Color3.fromRGB(50, 25, 35)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(200, 120, 150),
		Tab = Color3.fromRGB(220, 140, 168),
		Element = Color3.fromRGB(175, 100, 125),
		ElementBorder = Color3.fromRGB(95, 48, 62),
		InElementBorder = Color3.fromRGB(145, 80, 102),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(240, 155, 180),
		ToggleToggled = Color3.fromRGB(35, 16, 22),
		SliderRail = Color3.fromRGB(255, 130, 160),
		DropdownFrame = Color3.fromRGB(245, 165, 190),
		DropdownHolder = Color3.fromRGB(58, 30, 40),
		DropdownBorder = Color3.fromRGB(95, 48, 62),
		DropdownOption = Color3.fromRGB(210, 120, 150),
		Keybind = Color3.fromRGB(220, 140, 168),
		Input = Color3.fromRGB(165, 94, 118),
		InputFocused = Color3.fromRGB(22, 11, 16),
		InputIndicator = Color3.fromRGB(255, 175, 200),
		InputIndicatorFocus = Color3.fromRGB(255, 130, 160),
		Dialog = Color3.fromRGB(58, 30, 40),
		DialogHolder = Color3.fromRGB(48, 24, 33),
		DialogHolderLine = Color3.fromRGB(110, 58, 76),
		DialogButton = Color3.fromRGB(65, 34, 46),
		DialogButtonBorder = Color3.fromRGB(148, 80, 105),
		DialogBorder = Color3.fromRGB(195, 110, 138),
		DialogInput = Color3.fromRGB(70, 36, 50),
		DialogInputLine = Color3.fromRGB(220, 140, 168),
		Text = Color3.fromRGB(255, 235, 240),
		SubText = Color3.fromRGB(240, 190, 205),
		Hover = Color3.fromRGB(185, 108, 135),
		HoverChange = 0.04
	},
	Slate = {
		Name = "Slate",
		...
		AcrylicBorder = Color3.fromRGB(30, 41, 59),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(8, 15, 30), Color3.fromRGB(15, 23, 42)),
		AcrylicNoise = 0.94,
		TitleBarLine = Color3.fromRGB(51, 65, 85),
		Tab = Color3.fromRGB(71, 85, 105),
		Element = Color3.fromRGB(30, 41, 59),
		ElementBorder = Color3.fromRGB(15, 23, 42),
		InElementBorder = Color3.fromRGB(30, 41, 59),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(71, 85, 105),
		ToggleToggled = Color3.fromRGB(8, 15, 30),
		SliderRail = Color3.fromRGB(148, 163, 184),
		DropdownFrame = Color3.fromRGB(100, 116, 139),
		DropdownHolder = Color3.fromRGB(20, 30, 48),
		DropdownBorder = Color3.fromRGB(15, 23, 42),
		DropdownOption = Color3.fromRGB(64, 80, 100),
		Keybind = Color3.fromRGB(71, 85, 105),
		Input = Color3.fromRGB(30, 41, 59),
		InputFocused = Color3.fromRGB(5, 9, 18),
		InputIndicator = Color3.fromRGB(148, 163, 184),
		InputIndicatorFocus = Color3.fromRGB(186, 200, 220),
		Dialog = Color3.fromRGB(20, 30, 48),
		DialogHolder = Color3.fromRGB(15, 23, 42),
		DialogHolderLine = Color3.fromRGB(36, 52, 72),
		DialogButton = Color3.fromRGB(24, 36, 56),
		DialogButtonBorder = Color3.fromRGB(51, 65, 85),
		DialogBorder = Color3.fromRGB(71, 85, 105),
		DialogInput = Color3.fromRGB(28, 40, 60),
		DialogInputLine = Color3.fromRGB(100, 116, 139),
	...
	Tidal = {
		Name = "Tidal",
		Accent = Color3.fromRGB(56, 200, 230),
		AcrylicMain = Color3.fromRGB(5, 25, 35),
		AcrylicBorder = Color3.fromRGB(20, 80, 110),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(5, 20, 30), Color3.fromRGB(8, 28, 40)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(25, 100, 135),
		Tab = Color3.fromRGB(40, 130, 165),
		Element = Color3.fromRGB(20, 80, 110),
		ElementBorder = Color3.fromRGB(10, 45, 65),
		InElementBorder = Color3.fromRGB(16, 65, 90),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(45, 148, 188),
		ToggleToggled = Color3.fromRGB(4, 18, 26),
		SliderRail = Color3.fromRGB(56, 200, 230),
		DropdownFrame = Color3.fromRGB(55, 168, 205),
		DropdownHolder = Color3.fromRGB(8, 34, 48),
		DropdownBorder = Color3.fromRGB(12, 50, 72),
		DropdownOption = Color3.fromRGB(35, 118, 150),
		Keybind = Color3.fromRGB(42, 140, 175),
		Input = Color3.fromRGB(20, 76, 105),
		InputFocused = Color3.fromRGB(3, 14, 20),
		InputIndicator = Color3.fromRGB(90, 220, 248),
		InputIndicatorFocus = Color3.fromRGB(56, 200, 230),
		Dialog = Color3.fromRGB(8, 34, 48),
		DialogHolder = Color3.fromRGB(6, 26, 38),
		DialogHolderLine = Color3.fromRGB(18, 68, 95),
		DialogButton = Color3.fromRGB(10, 42, 60),
		DialogButtonBorder = Color3.fromRGB(28, 94, 128),
		DialogBorder = Color3.fromRGB(40, 130, 165),
		DialogInput = Color3.fromRGB(12, 48, 68),
		DialogInputLine = Color3.fromRGB(50, 168, 205),
		Text = Color3.fromRGB(210, 245, 255),
		SubText = Color3.fromRGB(140, 210, 235),
		Hover = Color3.fromRGB(28, 98, 130),
		HoverChange = 0.04
	},
	Lava = {
		Name = "Lava",
		Accent = Color3.fromRGB(255, 60, 0),
		AcrylicMain = Color3.fromRGB(25, 5, 0),
		AcrylicBorder = Color3.fromRGB(120, 30, 0),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 4, 0), Color3.fromRGB(28, 7, 0)),
		AcrylicNoise = 0.94,
		TitleBarLine = Color3.fromRGB(160, 40, 0),
		Tab = Color3.fromRGB(185, 50, 5),
		Element = Color3.fromRGB(130, 32, 2),
		ElementBorder = Color3.fromRGB(70, 15, 0),
		InElementBorder = Color3.fromRGB(105, 26, 1),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(210, 65, 10),
		ToggleToggled = Color3.fromRGB(16, 4, 0),
		SliderRail = Color3.fromRGB(255, 60, 0),
		DropdownFrame = Color3.fromRGB(220, 75, 12),
		DropdownHolder = Color3.fromRGB(30, 8, 0),
		DropdownBorder = Color3.fromRGB(75, 18, 0),
		DropdownOption = Color3.fromRGB(168, 45, 4),
		Keybind = Color3.fromRGB(195, 55, 8),
		Input = Color3.fromRGB(125, 30, 2),
		InputFocused = Color3.fromRGB(10, 2, 0),
		InputIndicator = Color3.fromRGB(255, 120, 50),
		InputIndicatorFocus = Color3.fromRGB(255, 60, 0),
		Dialog = Color3.fromRGB(30, 8, 0),
		DialogHolder = Color3.fromRGB(24, 6, 0),
		DialogHolderLine = Color3.fromRGB(85, 22, 0),
		DialogButton = Color3.fromRGB(38, 10, 0),
		DialogButtonBorder = Color3.fromRGB(118, 30, 2),
		DialogBorder = Color3.fromRGB(165, 42, 4),
		DialogInput = Color3.fromRGB(42, 12, 0),
		DialogInputLine = Color3.fromRGB(200, 62, 10),
		Text = Color3.fromRGB(255, 225, 205),
		SubText = Color3.fromRGB(230, 165, 130),
		Hover = Color3.fromRGB(155, 42, 5),
		HoverChange = 0.04
	},
	Ivory = {
		Name = "Ivory",
		Accent = Color3.fromRGB(180, 150, 100),
		AcrylicMain = Color3.fromRGB(252, 248, 240),
		AcrylicBorder = Color3.fromRGB(215, 202, 178),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 252, 248), Color3.fromRGB(250, 246, 238)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(210, 195, 170),
		Tab = Color3.fromRGB(175, 155, 125),
		Element = Color3.fromRGB(238, 228, 210),
		ElementBorder = Color3.fromRGB(210, 195, 170),
		InElementBorder = Color3.fromRGB(222, 210, 188),
		ElementTransparency = 0.72,
		ToggleSlider = Color3.fromRGB(180, 155, 120),
		ToggleToggled = Color3.fromRGB(250, 246, 238),
		SliderRail = Color3.fromRGB(200, 175, 140),
		DropdownFrame = Color3.fromRGB(230, 218, 200),
		DropdownHolder = Color3.fromRGB(248, 243, 234),
		DropdownBorder = Color3.fromRGB(210, 195, 170),
		DropdownOption = Color3.fromRGB(200, 182, 155),
		Keybind = Color3.fromRGB(185, 162, 130),
		Input = Color3.fromRGB(238, 228, 210),
		InputFocused = Color3.fromRGB(140, 110, 75),
		InputIndicator = Color3.fromRGB(195, 172, 140),
		InputIndicatorFocus = Color3.fromRGB(180, 150, 100),
		Dialog = Color3.fromRGB(252, 248, 240),
		DialogHolder = Color3.fromRGB(248, 243, 234),
		DialogHolderLine = Color3.fromRGB(225, 212, 192),
		DialogButton = Color3.fromRGB(252, 248, 240),
		DialogButtonBorder = Color3.fromRGB(210, 195, 170),
		DialogBorder = Color3.fromRGB(195, 178, 152),
		DialogInput = Color3.fromRGB(240, 232, 218),
		DialogInputLine = Color3.fromRGB(200, 182, 155),
		Text = Color3.fromRGB(60, 45, 25),
		SubText = Color3.fromRGB(120, 100, 70),
		Hover = Color3.fromRGB(215, 200, 178),
		HoverChange = 0.04
	}
...
-- ============================================================
-- NEW ELEMENTS v2.0 (50+ new features and element types)
-- ============================================================
...
ElementsTable.ProgressBar = (function()
	...
	function Element:New(Idx, Config)
		...
		local ProgressFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)
		Progress.SetTitle = ProgressFrame.SetTitle
		Progress.SetDesc = ProgressFrame.SetDesc
		...
		PercentLabel.Parent = ProgressFrame.Frame

		function Progress:SetValue(Value)
			self.Value = math.clamp(Value, self.Min, self.Max)
			local pct = (self.Value - self.Min) / (self.Max - self.Min)
			TweenService:Create(FillFrame, TweenInfo.new(0.3, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
				Size = UDim2.new(pct, 0, 1, 0)
			}):Play()
			PercentLabel.Text = math.floor(pct * 100) .. "%"
			Library:SafeCallback(Progress.Callback, self.Value)
		end

		function Progress:OnChanged(Func)
			Progress.Changed = Func
			Func(Progress.Value)
		end
		...
		Progress:SetValue(Config.Default)
...
ElementsTable.Label = (function()
	...
	function Element:New(Config)
		...
		local LabelEl = Components.Element(Config.Title or "", Config.Content, self.Container, false, Config)
		LabelEl.Frame.BackgroundTransparency = 0.95
		if Config.Bold then
			LabelEl.TitleLabel.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold)
		end
		if Config.Color then
			LabelEl.TitleLabel.TextColor3 = Config.Color
		end
		return LabelEl
	end
...
ElementsTable.Separator = (function()
	...
	function Element:New(Config)
		...
		if Config and Config.Text and Config.Text ~= "" then
			...
			TextLabel.Parent = SepFrame
		end

		return { Frame = SepFrame }
	end

	return Element
end)()

-- Badge/Tag Button Element
ElementsTable.BadgeButton = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "BadgeButton"

	function Element:New(Config)
		assert(Config.Title, "BadgeButton - Missing Title")
		Config.Callback = Config.Callback or function() end
		Config.Badge = Config.Badge or ""
		Config.BadgeColor = Config.BadgeColor or Color3.fromRGB(255, 80, 80)
		...
		local BadgeLabel = New("TextLabel", {
			...
			TextSize = 11,
			TextColor3 = Color3.fromRGB(255, 255, 255),
			BackgroundColor3 = Config.BadgeColor,
			BackgroundTransparency = 0,
		...
		function ButtonFrame:SetBadge(text, color)
			BadgeLabel.Text = text
			if color then BadgeLabel.BackgroundColor3 = color end
		end
...
ElementsTable.Image = (function()
	...
	function Element:New(Config)
		...
		return { Frame = ImgFrame }
	end

	return Element
end)()

-- MultiButton Row Element (multiple buttons in a row)
	...
	function Element:New(Config)
		...
		for i, btn in ipairs(Config.Buttons) do
			local BtnFrame = New("TextButton", {
				Size = UDim2.new(1 / count, -(5 * (count - 1) / count), 1, 0),
			...
			local Motor, SetTrans = Creator.SpringMotor(0.87, BtnFrame, "BackgroundTransparency")
			Creator.AddSignal(BtnFrame.MouseEnter, function() SetTrans(0.80) end)
			Creator.AddSignal(BtnFrame.MouseLeave, function() SetTrans(0.87) end)
			Creator.AddSignal(BtnFrame.MouseButton1Down, function() SetTrans(0.92) end)
			Creator.AddSignal(BtnFrame.MouseButton1Up, function() SetTrans(0.80) end)
			Creator.AddSignal(BtnFrame.MouseButton1Click, function()
				Library:SafeCallback(btn.Callback)
			end)

			table.insert(btns, BtnFrame)
		end

		return { Frame = GroupFrame, Buttons = btns }
	end
...
ElementsTable.RadioGroup = (function()
	...
	function Element:New(Idx, Config)
		...
		assert(Config.Options, "RadioGroup - Missing Options")
		...
		local RadioFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)
		Radio.SetTitle = RadioFrame.SetTitle
		...
		for i, option in ipairs(Config.Options) do
			local isSelected = (option == Radio.Value)

			local OptionBtn = New("TextButton", {
				Size = UDim2.new(1, 0, 0, 28),
				BackgroundTransparency = isSelected and 0.82 or 0.95,
				Text = "",
			...
			local RadioRing = New("Frame", {
				...
				New("UIStroke", {
					Thickness = 2,
					Transparency = 0.3,
					ThemeTag = { Color = isSelected and "Accent" or "SubText" },
				}),
			})

			local function UpdateRadio(selected)
				TweenService:Create(OptionBtn, TweenInfo.new(0.2), {
					BackgroundTransparency = selected and 0.82 or 0.95
				}):Play()
				TweenService:Create(RadioDot, TweenInfo.new(0.2), {
					BackgroundTransparency = selected and 0 or 1,
					Size = selected and UDim2.fromOffset(14, 14) or UDim2.fromOffset(0, 0)
				}):Play()
				Creator.OverrideTag(RadioRing:FindFirstChild("UIStroke"), { Color = selected and "Accent" or "SubText" })
			end

			table.insert(radioButtons, { Frame = OptionBtn, Dot = RadioDot, Ring = RadioRing, Value = option, Update = UpdateRadio })

			Creator.AddSignal(OptionBtn.MouseButton1Click, function()
				Radio.Value = option
				for _, rb in ipairs(radioButtons) do
					rb.Update(rb.Value == option)
				end
				Library:SafeCallback(Radio.Callback, Radio.Value)
				Library:SafeCallback(Radio.Changed, Radio.Value)
			end)
		end
...
ElementsTable.Accordion = (function()
	...
	function Element:New(Config)
		...
		local AccordionFrame = New("Frame", {
			Size = UDim2.new(1, 0, 0, 36),
			BackgroundTransparency = 0.87,
			Parent = self.Container,
			LayoutOrder = 7,
		...
		return { Frame = AccordionFrame, Content = ContentFrame }
	end

	return Element
end)()

-- Notification Toast (inline, not popup) Element
ElementsTable.Toast = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "Toast"
	...
	function Element:New(Config)
		...
		local accentColor = Config.Color or Creator.GetThemeProperty("Accent")
		...
		local toast = { Frame = ToastFrame }

		function toast:SetText(text)
			local lbl = ToastFrame:FindFirstChild("TextLabel", true)
...
ElementsTable.Rating = (function()
	...
	function Element:New(Idx, Config)
		...
		local RatingFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)
		Rating.SetTitle = RatingFrame.SetTitle

		local StarsHolder = New("Frame", {
			Size = UDim2.fromOffset(Config.Max * 22, 22),
			AnchorPoint = Vector2.new(1, 0.5),
			Position = UDim2.new(1, -10, 0.5, 0),
			BackgroundTransparency = 1,
			Parent = RatingFrame.Frame,
		}, {
			New("UIListLayout", {
				FillDirection = Enum.FillDirection.Horizontal,
				Padding = UDim.new(0, 2),
		...
		local function UpdateStars(value)
			for i, star in ipairs(Stars) do
				TweenService:Create(star, TweenInfo.new(0.15), {
					ImageTransparency = i <= value and 0 or 0.7,
				}):Play()
				Creator.OverrideTag(star, { ImageColor3 = i <= value and "Accent" or "SubText" })
			end
		end
		...
		for i = 1, Config.Max do
			local Star = New("ImageButton", {
				...
				Size = UDim2.fromOffset(20, 20),
				BackgroundTransparency = 1,
				ImageTransparency = i <= Rating.Value and 0 or 0.7,
				Parent = StarsHolder,
				ThemeTag = { ImageColor3 = i <= Rating.Value and "Accent" or "SubText" },
			})
			...
			Creator.AddSignal(Star.MouseLeave, function()
				UpdateStars(Rating.Value)
			end)
		end

		function Rating:SetValue(Value)
			self.Value = math.clamp(math.floor(Value), 0, self.Max)
			UpdateStars(self.Value)
		end

		function Rating:OnChanged(Func)
			Rating.Changed = Func
			Func(Rating.Value)
		end

		function Rating:Destroy()
			RatingFrame:Destroy()
			Library.Options[Idx] = nil
		end

		Library.Options[Idx] = Rating
		return Rating
	end
...
ElementsTable.Counter = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "Counter"

	function Element:New(Idx, Config)
		assert(Config.Title, "Counter - Missing Title")
		Config.Default = Config.Default or 0
		Config.Min = Config.Min ~= nil and Config.Min or -math.huge
		Config.Max = Config.Max ~= nil and Config.Max or math.huge
		...
		local CounterFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)

		local CounterHolder = New("Frame", {
		...
		local function UpdateDisplay()
			ValueLabel.Text = tostring(Counter.Value)
		end
		...
		Creator.AddSignal(MinusBtn.MouseButton1Click, function()
			Counter:SetValue(Counter.Value - Config.Step)
		end)
		...
		function Counter:OnChanged(Func)
			Counter.Changed = Func
			Func(Counter.Value)
		end
...
-- Chip/Tag Multi-Select Element
ElementsTable.ChipSelect = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "ChipSelect"

	function Element:New(Idx, Config)
		assert(Config.Title, "ChipSelect - Missing Title")
		assert(Config.Values, "ChipSelect - Missing Values")
		...
		local ChipFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)
		...
		for _, value in ipairs(Config.Values) do
			local isSelected = Chip.Value[value] == true
			...
			local ChipBtn = New("TextButton", {
				...
				Parent = ChipsHolder,
				ThemeTag = { BackgroundColor3 = isSelected and "Accent" or "Element", TextColor3 = "Text" },
			}, {
				New("UICorner", { CornerRadius = UDim.new(1, 0) }),
				New("UIPadding", {
			...
			local function UpdateChip()
				local selected = Chip.Value[value] == true
				TweenService:Create(ChipBtn, TweenInfo.new(0.2), {
					BackgroundTransparency = selected and 0 or 0.85
				}):Play()
				Creator.OverrideTag(ChipBtn, {
					BackgroundColor3 = selected and "Accent" or "Element",
					TextColor3 = "Text"
				})
			end

			Creator.AddSignal(ChipBtn.MouseButton1Click, function()
				Chip.Value[value] = not Chip.Value[value] or nil
				UpdateChip()
				Library:SafeCallback(Chip.Callback, Chip.Value)
				Library:SafeCallback(Chip.Changed, Chip.Value)
			end)
		end

		function Chip:SetValue(newVal)
			self.Value = newVal
		end

		function Chip:OnChanged(Func)
			Chip.Changed = Func
			Func(Chip.Value)
		end
...
-- Tabbed Content Element (mini tabs within a section)
ElementsTable.MiniTabs = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "MiniTabs"

	function Element:New(Config)
		assert(Config.Tabs, "MiniTabs - Missing Tabs")

		local MiniTabFrame = New("Frame", {
			Size = UDim2.new(1, 0, 0, 0),
			AutomaticSize = Enum.AutomaticSize.Y,
			BackgroundTransparency = 1,
			Parent = self.Container,
		...
		local function SelectTab(idx)
			...
			for i, btn in ipairs(tabBtns) do
				TweenService:Create(btn, TweenInfo.new(0.2), {
					BackgroundTransparency = i == idx and 0.75 or 0.92
				}):Play()
			end
		end
		...
		for i, tab in ipairs(Config.Tabs) do
			...
			Creator.AddSignal(TabBtn.MouseButton1Click, function()
				SelectTab(capturedIdx)
			end)
		end

		return { Frame = MiniTabFrame, Contents = tabContents, Select = SelectTab }
	end

	return Element
end)()

-- Shortcut / Hotkey Display Element
ElementsTable.Shortcut = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "Shortcut"

	function Element:New(Config)
		assert(Config.Title, "Shortcut - Missing Title")
		Config.Keys = Config.Keys or {}

		local ShortcutFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)

		local KeysHolder = New("Frame", {
			Size = UDim2.new(0, 0, 0, 22),
			AnchorPoint = Vector2.new(1, 0.5),
			Position = UDim2.new(1, -10, 0.5, 0),
			BackgroundTransparency = 1,
			AutomaticSize = Enum.AutomaticSize.X,
			Parent = ShortcutFrame.Frame,
		}, {
			New("UIListLayout", {
				FillDirection = Enum.FillDirection.Horizontal,
				Padding = UDim.new(0, 4),
		...
		for i, key in ipairs(Config.Keys) do
			New("TextLabel", {
				...
				New("UICorner", { CornerRadius = UDim.new(0, 4) }),
				New("UIStroke", { Transparency = 0.5, ThemeTag = { Color = "ElementBorder" } }),
				New("UIPadding", {
					PaddingLeft = UDim.new(0, 6),
					PaddingRight = UDim.new(0, 6),
				}),
...
ElementsTable.Table = (function()
	...
	function Element:New(Config)
		assert(Config.Headers, "Table - Missing Headers")
		Config.Rows = Config.Rows or {}
		Config.MaxHeight = Config.MaxHeight or 200

		local colCount = #Config.Headers
		local rowHeight = 26

		local TableOuter = New("Frame", {
			Size = UDim2.new(1, 0, 0, 0),
			AutomaticSize = Enum.AutomaticSize.Y,
			BackgroundTransparency = 1,
			Parent = self.Container,
		...
		local DataScroll = New("ScrollingFrame", {
			Size = UDim2.new(1, 0, 0, math.min(#Config.Rows * rowHeight, Config.MaxHeight)),
			Position = UDim2.fromOffset(0, rowHeight + 2),
			BackgroundTransparency = 1,
			ScrollBarThickness = 3,
			CanvasSize = UDim2.new(0, 0, 0, #Config.Rows * rowHeight),
			Parent = TableOuter,
		}, {
		...
		TableOuter.Size = UDim2.new(1, 0, 0, rowHeight + 2 + math.min(#Config.Rows * rowHeight, Config.MaxHeight))

		return { Frame = TableOuter, Scroll = DataScroll }
	end

	return Element
end)()

-- Gradient Slider Element (RGB color channel style)
ElementsTable.GradientSlider = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "GradientSlider"

	function Element:New(Idx, Config)
		assert(Config.Title, "GradientSlider - Missing Title")
		Config.Default = Config.Default or 0
		Config.Min = Config.Min or 0
		Config.Max = Config.Max or 1
		Config.Gradient = Config.Gradient or ColorSequence.new(Color3.fromRGB(0,0,0), Color3.fromRGB(255,255,255))
		...
		local Dragging = false
		local GFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)
		...
		local TrackFrame = New("Frame", {
			...
			New("UICorner", { CornerRadius = UDim.new(1, 0) }),
			New("UIGradient", { Color = Config.Gradient, Rotation = 0 }),
		})
		...
		local ThumbDot = New("Frame", {
			...
			New("UICorner", { CornerRadius = UDim.new(1, 0) }),
			New("UIStroke", { Thickness = 2, Transparency = 0.3, Color = Color3.fromRGB(0,0,0) }),
		})

		local function UpdatePosition()
			local pct = (GSlider.Value - Config.Min) / (Config.Max - Config.Min)
			ThumbDot.Position = UDim2.new(pct, 0, 0.5, 0)
		end

		Creator.AddSignal(TrackFrame.InputBegan, function(Input)
		...
		Creator.AddSignal(UserInputService.InputChanged, function(Input)
			if Dragging then
				...
				GSlider.Value = Config.Min + (Config.Max - Config.Min) * pct
				UpdatePosition()
				Library:SafeCallback(GSlider.Callback, GSlider.Value)
				Library:SafeCallback(GSlider.Changed, GSlider.Value)
			end
		end)
		...
		function GSlider:OnChanged(Func)
			GSlider.Changed = Func
			Func(GSlider.Value)
		end

		function GSlider:Destroy()
			GFrame:Destroy()
			Library.Options[Idx] = nil
		end

		UpdatePosition()
		Library.Options[Idx] = GSlider
		return GSlider
	end
...
-- Countdown Timer Display Element
ElementsTable.Timer = (function()
	...
	function Element:New(Config)
		...
		local TimeLabel = New("TextLabel", {
			Text = string.format("%02d:%02d", math.floor(Config.Duration / 60), Config.Duration % 60),
			FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold),
			TextSize = 15,
			AnchorPoint = Vector2.new(1, 0.5),
		...
		local function UpdateDisplay()
			local m = math.floor(TimerEl.TimeLeft / 60)
			local s = math.floor(TimerEl.TimeLeft % 60)
		...
		Creator.AddSignal(StartBtn.MouseButton1Click, function()
			if TimerEl.Running then
				Stop()
			else
				TimerEl.Running = true
				StartBtn.Text = "Stop"
				if TimerEl.TimeLeft <= 0 then
					TimerEl.TimeLeft = Config.Duration
				end
				connection = RunService.Heartbeat:Connect(function(dt)
					TimerEl.TimeLeft = math.max(0, TimerEl.TimeLeft - dt)
					UpdateDisplay()
					if TimerEl.TimeLeft <= 0 then
						Stop()
						Library:SafeCallback(TimerEl.OnComplete)
					end
				end)
			end
		end)

		function TimerEl:Reset()
			Stop()
...
-- Color Swatch Row Element
ElementsTable.ColorSwatches = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "ColorSwatches"

	function Element:New(Idx, Config)
		assert(Config.Title, "ColorSwatches - Missing Title")
		...
		Config.Default = Config.Default or Config.Colors[1]
		...
		local SwFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)
		...
		local function SelectSwatch(color)
			...
			for _, sf in ipairs(swatchFrames) do
				local selected = sf.Color == color
				sf.Stroke.Thickness = selected and 2 or 0
			end
			Library:SafeCallback(Swatches.Callback, color)
			Library:SafeCallback(Swatches.Changed, color)
		end

		for _, color in ipairs(Config.Colors) do
			local isSelected = (color == Config.Default)
			local sf = {}
			sf.Color = color
			...
			table.insert(swatchFrames, sf)

			local capturedColor = color
			Creator.AddSignal(SwBtn.MouseButton1Click, function()
				SelectSwatch(capturedColor)
			end)
		end

		function Swatches:SetValue(color)
			SelectSwatch(color)
		end

		function Swatches:OnChanged(Func)
			Swatches.Changed = Func
			Func(Swatches.Value)
		end

		function Swatches:Destroy()
			SwFrame:Destroy()
			Library.Options[Idx] = nil
		end

		Library.Options[Idx] = Swatches
		return Swatches
	end
...
-- ============================================================
-- New Elements added to Elements metatable
-- ============================================================
...
-- Elements that don't use an Idx key (no saved Options entry)
local NoIdxElements = {
	Button = true, Label = true, Separator = true, BadgeButton = true,
	Image = true, ButtonGroup = true, Accordion = true, Toast = true,
	MiniTabs = true, Shortcut = true, Table = true, Timer = true,
	Paragraph = true,
}

for _, ElementComponent in pairs(ElementsTable) do
	local typeName = ElementComponent.__type
	if NoIdxElements[typeName] then
		-- These elements: New(Config) — no Idx
		Elements["Add" .. typeName] = function(self, Config)
		...
		-- These elements: New(Idx, Config) — registered in Library.Options
...
-- ============================================================
-- NEW LIBRARY FEATURES v2.0
-- ============================================================

-- Animate a frame with a pop-in effect
function Library:AnimateIn(frame, duration)
	duration = duration or 0.3
	local scale = Instance.new("UIScale")
	scale.Scale = 0.8
	scale.Parent = frame
	frame.BackgroundTransparency = 1
	TweenService:Create(scale, TweenInfo.new(duration, Enum.EasingStyle.Back, Enum.EasingDirection.Out), { Scale = 1 }):Play()
	TweenService:Create(frame, TweenInfo.new(duration, Enum.EasingStyle.Quart), { BackgroundTransparency = 0 }):Play()
	task.delay(duration + 0.05, function() if scale and scale.Parent then scale:Destroy() end end)
end

-- Shake a UI frame (error feedback)
function Library:ShakeElement(frame, intensity, count)
	intensity = intensity or 6
	count = count or 4
	local origin = frame.Position
	for i = 1, count * 2 do
		local dir = (i % 2 == 0) and 1 or -1
		local offset = intensity * dir * (1 - (i / (count * 2)))
...
-- Flash an element's background briefly (success feedback)
function Library:FlashElement(frame, color, duration)
	color = color or Creator.GetThemeProperty("Accent")
	duration = duration or 0.4
	local origColor = frame.BackgroundColor3
	local origTrans = frame.BackgroundTransparency
	TweenService:Create(frame, TweenInfo.new(0.1), { BackgroundColor3 = color, BackgroundTransparency = 0.5 }):Play()
	task.delay(duration, function()
		if frame and frame.Parent then
			TweenService:Create(frame, TweenInfo.new(0.2), { BackgroundColor3 = origColor, BackgroundTransparency = origTrans }):Play()
		end
	end)
end
...
function Library:NotifySuccess(title, content, duration)
	return self:Notify({ Title = title or "Success", Content = content or "", Duration = duration or 3 })
end

-- Quick error notification  
function Library:NotifyError(title, content, duration)
	return self:Notify({ Title = title or "Error", Content = content or "", Duration = duration or 4 })
end

-- Quick info notification
function Library:NotifyInfo(title, content, duration)
	return self:Notify({ Title = title or "Info", Content = content or "", Duration = duration or 3 })
end

-- Toggle all element interactivity
function Library:SetInteractive(enabled)
	if Library.GUI then
		for _, desc in ipairs(Library.GUI:GetDescendants()) do
...
-- Get list of all registered option keys
function Library:GetOptionKeys()
	local keys = {}
	for k, _ in pairs(Library.Options) do
		table.insert(keys, k)
	end
	table.sort(keys)
	return keys
...
function Library:ResetAll()
	for _, option in pairs(Library.Options) do
		if option.SetValue and option.Default ~= nil then
			pcall(function() option:SetValue(option.Default) end)
		end
	end
end

-- Export all options as a config table
function Library:ExportConfig()
	local config = {}
	for key, option in pairs(Library.Options) do
		if option.Type and option.Value ~= nil then
			config[key] = { type = option.Type, value = option.Value }
		end
	end
	return config
end

-- Import config from exported table
function Library:ImportConfig(config)
	if type(config) ~= "table" then return false end
	for key, data in pairs(config) do
		if Library.Options[key] and Library.Options[key].SetValue then
			pcall(function() Library.Options[key]:SetValue(data.value) end)
		end
	end
	return true
end

-- Apply a tint overlay to the window
function Library:SetWindowTint(color, transparency)
	if not Library.Window then return end
	transparency = transparency or 0.8
	local root = Library.Window.Root
	if not root then return end
	local existing = root:FindFirstChild("WindowTint")
...
-- Modal state (dim + lock)
function Library:SetModalState(enabled, message)
	if enabled then
		self:SetWindowTint(Color3.fromRGB(0, 0, 0), 0.6)
		if message then
			self:Notify({ Title = "Interface", Content = message, Duration = 3 })
		end
	else
		self:SetWindowTint(nil)
	end
end

-- Get current theme data table
...
function Library:HasOption(key)
	return Library.Options[key] ~= nil
end

-- Safe get option value
function Library:GetValue(key)
	if Library.Options[key] then
		return Library.Options[key].Value
	end
	return nil
end

-- Safe set option value
function Library:SetValue(key, value)
	if Library.Options[key] and Library.Options[key].SetValue then
		pcall(function() Library.Options[key]:SetValue(value) end)
		return true
	end
	return false
end

-- Highlight an option by key
function Library:HighlightOption(key, times)
	if not Library.Options[key] then return end
	local option = Library.Options[key]
	if option.Elements and option.Elements.Frame then
		times = times or 3
		local frame = option.Elements.Frame
		for i = 1, times do
			Library:FlashElement(frame, Creator.GetThemeProperty("Accent"), 0.3)
			task.wait(0.4)
		end
	end
end

-- Fade window in or out
function Library:FadeWindow(visible, duration)
	...
	for _, desc in ipairs(root:GetDescendants()) do
		if desc:IsA("CanvasGroup") then
			TweenService:Create(desc, TweenInfo.new(duration, Enum.EasingStyle.Quart), {
...
function Library:CreateTooltip(text)
	...
	local tooltipObj = {}
	function tooltipObj:Show() tooltip.Visible = true end
	function tooltipObj:Hide() tooltip.Visible = false end
	function tooltipObj:SetText(t)
		local lbl = tooltip:FindFirstChildOfClass("TextLabel")
		if lbl then lbl.Text = t end
	end
	function tooltipObj:Destroy()
		conn:Disconnect()
		tooltip:Destroy()
	end
	return tooltipObj
...
-- Attach tooltip to a UI element
function Library:AttachTooltip(element, text)
	local tooltip = self:CreateTooltip(text)
	if element and element.MouseEnter then
		Creator.AddSignal(element.MouseEnter, function() tooltip:Show() end)
		Creator.AddSignal(element.MouseLeave, function() tooltip:Hide() end)
	end
	return tooltip
end

-- Watermark overlay
function Library:CreateWatermark(text, position, size)
	position = position or UDim2.new(1, -10, 0, 10)
	size = size or 13
	local wm = New("TextLabel", {
		Text = text or "Bata v2.0",
		FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Medium),
		TextSize = size,
		AnchorPoint = Vector2.new(1, 0),
		Position = position,
		BackgroundTransparency = 0.6,
		AutomaticSize = Enum.AutomaticSize.X,
		Size = UDim2.fromOffset(0, size + 10),
		ZIndex = 999,
		Parent = Library.GUI,
		ThemeTag = { BackgroundColor3 = "AcrylicMain", TextColor3 = "Text" },
	}, {
		New("UICorner", { CornerRadius = UDim.new(0, 5) }),
		New("UIPadding", {
			PaddingLeft = UDim.new(0, 8),
	...
	local wmObj = { Frame = wm }
	function wmObj:SetText(t) wm.Text = t end
	function wmObj:SetVisible(v) wm.Visible = v end
	function wmObj:Destroy() wm:Destroy() end
	return wmObj
end

-- Clock watermark (auto-updating)
function Library:CreateClockWatermark(prefix, position)
	prefix = prefix or ""
	local wm = self:CreateWatermark("", position)
	local conn = RunService.Heartbeat:Connect(function()
		if wm and wm.Frame and wm.Frame.Parent then
			local t = os.date("*t")
			wm:SetText(string.format("%s%02d:%02d:%02d", prefix, t.hour, t.min, t.sec))
		end
	end)
	local origDestroy = wm.Destroy
	wm.Destroy = function(self)
		conn:Disconnect()
		origDestroy(self)
	end
	return wm
...
function Library:NextTheme()
	local themes = Themes.Names
	local idx = table.find(themes, Library.Theme) or 1
	local next_idx = idx % #themes + 1
	Library:SetTheme(themes[next_idx])
	return themes[next_idx]
end

-- Cycle to previous theme
function Library:PrevTheme()
	local themes = Themes.Names
	local idx = table.find(themes, Library.Theme) or 1
	local prev_idx = ((idx - 2) % #themes) + 1
	Library:SetTheme(themes[prev_idx])
	return themes[prev_idx]
end

-- Version helpers
function Library:GetVersion() return Library.Version end
function Library:IsVisible() return Library.Window and not Library.Window.Minimized end

-- Set window title dynamically
function Library:SetWindowTitle(title)
	if Library.Window and Library.Window.TitleBar then
		local lbl = Library.Window.TitleBar.Frame:FindFirstChild("TextLabel", true)
		if lbl then lbl.Text = title end
	end
end

-- Resize window
function Library:ResizeWindow(width, height, animated)
	if not Library.Window then return end
	local dur = animated and 0.3 or 0
	TweenService:Create(Library.Window.Root, TweenInfo.new(dur, Enum.EasingStyle.Quart), {
		Size = UDim2.fromOffset(width, height)
	}):Play()
	Library.Window.Size = UDim2.fromOffset(width, height)
end

-- Lock/unlock all options
function Library:LockOptions(locked, except)
	except = except or {}
	for key, option in pairs(Library.Options) do
		if not table.find(except, key) and option.Elements and option.Elements.Frame then
			option.Elements.Frame.Active = not locked
		end
	end
end

-- Get window position
function Library:GetWindowPosition()
	if Library.Window and Library.Window.Root then
		return Library.Window.Root.AbsolutePosition
	end
...
function Library:GetWindowSize()
	if Library.Window and Library.Window.Root then
		return Library.Window.Root.AbsoluteSize
	end
	return Vector2.new(0, 0)
end

-- Snap window to corner
function Library:SnapWindow(corner)
	if not Library.Window or not Library.Window.Root then return end
	local vp = Camera.ViewportSize
	local ws = Library.Window.Root.AbsoluteSize
	local pos
	if corner == "TopLeft" then pos = UDim2.fromOffset(10, 10)
	elseif corner == "TopRight" then pos = UDim2.fromOffset(vp.X - ws.X - 10, 10)
	elseif corner == "BottomLeft" then pos = UDim2.fromOffset(10, vp.Y - ws.Y - 10)
	elseif corner == "BottomRight" then pos = UDim2.fromOffset(vp.X - ws.X - 10, vp.Y - ws.Y - 10)
	else pos = UDim2.fromOffset((vp.X - ws.X) / 2, (vp.Y - ws.Y) / 2)
	end
	TweenService:Create(Library.Window.Root, TweenInfo.new(0.3, Enum.EasingStyle.Back), { Position = pos }):Play()
	Library.Window.Position = pos
end

-- Search through options
function Library:SearchOptions(keyword)
	keyword = keyword:lower()
	local results = {}
	for key, option in pairs(Library.Options) do
		if key:lower():find(keyword, 1, true) then
			table.insert(results, { key = key, option = option })
		end
	end
	return results
end
...
function Library:Confirm(title, message, onYes, onNo)
	if Library.Window then
		Library.Window:Dialog({
			Title = title or "Confirm",
			Content = message or "Are you sure?",
			Buttons = {
				{ Title = "Yes", Callback = onYes or function() end },
				{ Title = "No", Callback = onNo or function() end },
			},
		})
	end
end
...
function Library:BindKey(keyCode, callback, holdCtrl)
	Creator.AddSignal(UserInputService.InputBegan, function(input, gameProcessed)
		if gameProcessed then return end
		local matchKey = input.KeyCode == keyCode
		local matchCtrl = not holdCtrl or UserInputService:IsKeyDown(Enum.KeyCode.LeftControl)
		if matchKey and matchCtrl then
			Library:SafeCallback(callback)
		end
	end)
end
...
-- FPS Counter overlay
function Library:CreateFPSCounter(position)
	...
	local fpsObj = { Frame = fpsLabel }
	function fpsObj:Destroy() fpsConn:Disconnect(); fpsLabel:Destroy() end
	function fpsObj:SetVisible(v) fpsLabel.Visible = v end
	return fpsObj
end

-- Session data store
Library._SessionStore = {}
function Library:StoreData(key, value) Library._SessionStore[key] = value end
function Library:GetData(key) return Library._SessionStore[key] end
function Library:ClearData(key)
	if key then Library._SessionStore[key] = nil
	else Library._SessionStore = {} end
end
...
function Library:Log(message, level)
	level = level or "INFO"
	local entry = { time = os.time(), level = level, message = tostring(message) }
	table.insert(Library._Logs, entry)
	if #Library._Logs > 500 then table.remove(Library._Logs, 1) end
end
function Library:GetLogs(level)
	if not level then return Library._Logs end
	local filtered = {}
	for _, log in ipairs(Library._Logs) do
		if log.level == level then table.insert(filtered, log) end
	end
	return filtered
end
function Library:ClearLogs() Library._Logs = {} end

-- Event pub/sub system
Library._Events = {}
function Library:On(event, callback)
	if not Library._Events[event] then Library._Events[event] = {} end
	table.insert(Library._Events[event], callback)
end
function Library:Emit(event, ...)
	if Library._Events[event] then
		for _, cb in ipairs(Library._Events[event]) do
			Library:SafeCallback(cb, ...)
		end
	end
end
function Library:Off(event)
	Library._Events[event] = nil
end

-- Debug option dump
function Library:DebugOptions()
	local count = 0
	for key, opt in pairs(Library.Options) do
		count = count + 1
		print(string.format("[Bata v2] %-30s | %-15s | %s", key, opt.Type or "?", tostring(opt.Value)))
	end
	print(string.format("[Bata v2] Total: %d | Theme: %s | Version: %s", count, Library.Theme, Library.Version))
end

-- Version comparison
function Library:IsNewerThan(version)
	local function pv(v)
		local p = {}
		for n in v:gmatch("%d+") do table.insert(p, tonumber(n)) end
		return p
	end
	local a, b = pv(Library.Version), pv(version)
...
-- Auto-minimize on idle
function Library:AutoMinimize(idleSeconds)
	idleSeconds = idleSeconds or 60
	local lastActivity = tick()
	Creator.AddSignal(UserInputService.InputBegan, function() lastActivity = tick() end)
	Creator.AddSignal(RunService.Heartbeat, function()
		if tick() - lastActivity > idleSeconds and Library.Window and not Library.Window.Minimized then
			Library.Window:Minimize()
		end
	end)
end
...
function Library:AddTabBadge(tabIndex, text, color)
	pcall(function()
		if Library.Window then
			local tabHolder = Library.Window.TabHolder
			if tabHolder then
				local realTabs = {}
				for _, t in ipairs(tabHolder:GetChildren()) do
					if t:IsA("TextButton") then table.insert(realTabs, t) end
				end
				local tab = realTabs[tabIndex]
				if tab then
					local existing = tab:FindFirstChild("BadgeDot")
					if existing then existing:Destroy() end
					if text then
						color = color or Creator.GetThemeProperty("Accent")
						New("Frame", {
							Name = "BadgeDot",
							Size = UDim2.fromOffset(text == "" and 8 or 0, 18),
							AutomaticSize = text ~= "" and Enum.AutomaticSize.X or Enum.AutomaticSize.None,
							AnchorPoint = Vector2.new(1, 0),
...
function Library:SetThemeAnimated(themeName, duration)
	duration = duration or 0.4
	if not table.find(Themes.Names, themeName) then return end
	task.spawn(function()
		Library:FadeWindow(false, duration / 2)
		task.wait(duration / 2 + 0.05)
		Library:SetTheme(themeName)
		Library:FadeWindow(true, duration / 2)
	end)
end
