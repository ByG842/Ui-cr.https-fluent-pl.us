-- ================================================================
-- BATA X_ | Fluent UI Library — Reworked Edition
-- Version: 2.0.0
-- Based on: Bata_O_ v1.2.2
--
-- CHANGELOG v2.0.0 (Bata X Rework):
--   + 20 New Themes: Neon, CherryBlossom, Void, Copper, IceCave,
--     LavaMolten, PastelDream, Cyberpunk, DeepSea, Bronze,
--     Sakura, ElectricBlue, GoldenHour, ToxicGreen, Obsidian,
--     CottonCandy, RoyalPurple, SlateStorm, WarmChocolate, AuroraBoreal
--   + 60+ New API Functions (Toast, Watermark, FPS/Ping/Clock overlay,
--     Spotlight search, ExportConfig, ImportConfig, SetBadge,
--     SetStatus, CursorHighlight, PulseAccent, AddTheme, and more)
--   * TitleBar: 48px, SemiBold 14pt title, accent gradient underline
--   * Notification: Accent left bar, progress timer, SemiBold title
--   * Section: Accent left tick, icon color = Accent
--   * Tab: 36px, Medium 13pt, ActiveDot indicator
--   * Element: Corner radius 4→6
--   * Toggle: 42×22 pill, Frame circle, Back easing
--   * Slider: 18px dot, 6px rail
--   * Keybind: Pill-shaped, accent border
--   * Input: 170×32, animated focus line
--   * Colorpicker: 30×30 swatch, border
--   * Dropdown: 165×32, corner 7px
--   * Dialog/Notification: Corner 8→10px
--   * Window: Drop-shadow, corners 8→10px
-- ================================================================
...
local Themes = {
	...
	-- === 20 NEW THEMES (Bata X Rework) ===

	Neon = {
		Name = "Neon",
		Accent = Color3.fromRGB(0, 255, 180),
		AcrylicMain = Color3.fromRGB(5, 10, 20),
		AcrylicBorder = Color3.fromRGB(0, 200, 140),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(5, 15, 25), Color3.fromRGB(8, 20, 35)),
		AcrylicNoise = 0.97,
		TitleBarLine = Color3.fromRGB(0, 180, 120),
		Tab = Color3.fromRGB(0, 200, 150),
		Element = Color3.fromRGB(0, 160, 110),
		ElementBorder = Color3.fromRGB(0, 80, 60),
		InElementBorder = Color3.fromRGB(0, 140, 100),
		ElementTransparency = 0.88,
		ToggleSlider = Color3.fromRGB(0, 200, 150),
		ToggleToggled = Color3.fromRGB(0, 30, 20),
		SliderRail = Color3.fromRGB(0, 200, 150),
		DropdownFrame = Color3.fromRGB(0, 220, 160),
		DropdownHolder = Color3.fromRGB(5, 40, 30),
		DropdownBorder = Color3.fromRGB(0, 80, 60),
		DropdownOption = Color3.fromRGB(0, 200, 150),
		Keybind = Color3.fromRGB(0, 200, 150),
		Input = Color3.fromRGB(0, 180, 130),
		InputFocused = Color3.fromRGB(0, 20, 15),
		InputIndicator = Color3.fromRGB(0, 220, 170),
		InputIndicatorFocus = Color3.fromRGB(0, 255, 180),
		Dialog = Color3.fromRGB(5, 40, 30),
		DialogHolder = Color3.fromRGB(5, 30, 22),
		DialogHolderLine = Color3.fromRGB(0, 20, 15),
		DialogButton = Color3.fromRGB(5, 40, 30),
		DialogButtonBorder = Color3.fromRGB(0, 120, 90),
		DialogBorder = Color3.fromRGB(0, 100, 75),
		DialogInput = Color3.fromRGB(5, 50, 38),
		DialogInputLine = Color3.fromRGB(0, 200, 150),
		Text = Color3.fromRGB(220, 255, 245),
		SubText = Color3.fromRGB(100, 220, 180),
		Hover = Color3.fromRGB(0, 200, 150),
		HoverChange = 0.05
	},
	...
	CherryBlossom = {
		...
		AcrylicMain = Color3.fromRGB(55, 20, 30),
		AcrylicBorder = Color3.fromRGB(200, 100, 130),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(80, 30, 45), Color3.fromRGB(95, 40, 55)),
		AcrylicNoise = 0.91,
		TitleBarLine = Color3.fromRGB(210, 120, 145),
		Tab = Color3.fromRGB(230, 150, 175),
		Element = Color3.fromRGB(200, 110, 140),
		ElementBorder = Color3.fromRGB(110, 55, 70),
		InElementBorder = Color3.fromRGB(160, 85, 110),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(230, 140, 170),
		ToggleToggled = Color3.fromRGB(60, 25, 35),
		SliderRail = Color3.fromRGB(230, 140, 170),
		DropdownFrame = Color3.fromRGB(240, 160, 185),
		DropdownHolder = Color3.fromRGB(80, 35, 50),
		DropdownBorder = Color3.fromRGB(110, 55, 70),
		DropdownOption = Color3.fromRGB(230, 140, 170),
		Keybind = Color3.fromRGB(230, 140, 170),
		Input = Color3.fromRGB(220, 130, 160),
		InputFocused = Color3.fromRGB(40, 18, 25),
		InputIndicator = Color3.fromRGB(245, 170, 195),
		InputIndicatorFocus = Color3.fromRGB(255, 130, 160),
		Dialog = Color3.fromRGB(80, 35, 50),
		DialogHolder = Color3.fromRGB(70, 30, 43),
		DialogHolderLine = Color3.fromRGB(65, 25, 38),
		DialogButton = Color3.fromRGB(80, 35, 50),
		DialogButtonBorder = Color3.fromRGB(160, 85, 110),
		DialogBorder = Color3.fromRGB(140, 75, 100),
		DialogInput = Color3.fromRGB(95, 42, 58),
		DialogInputLine = Color3.fromRGB(230, 140, 170),
		Text = Color3.fromRGB(255, 240, 245),
		SubText = Color3.fromRGB(220, 170, 185),
		Hover = Color3.fromRGB(230, 140, 170),
		HoverChange = 0.04
	},
	...
	Void = {
		...
		AcrylicMain = Color3.fromRGB(0, 0, 5),
		AcrylicBorder = Color3.fromRGB(50, 10, 80),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 0, 8), Color3.fromRGB(5, 0, 15)),
		AcrylicNoise = 0.99,
		TitleBarLine = Color3.fromRGB(60, 15, 90),
		Tab = Color3.fromRGB(90, 30, 130),
		Element = Color3.fromRGB(70, 20, 100),
		ElementBorder = Color3.fromRGB(25, 5, 40),
		InElementBorder = Color3.fromRGB(55, 15, 80),
		ElementTransparency = 0.90,
		ToggleSlider = Color3.fromRGB(100, 35, 140),
		ToggleToggled = Color3.fromRGB(10, 3, 18),
		SliderRail = Color3.fromRGB(100, 35, 140),
		DropdownFrame = Color3.fromRGB(110, 40, 150),
		DropdownHolder = Color3.fromRGB(15, 5, 25),
		DropdownBorder = Color3.fromRGB(25, 5, 40),
		DropdownOption = Color3.fromRGB(100, 35, 140),
		Keybind = Color3.fromRGB(100, 35, 140),
		Input = Color3.fromRGB(90, 30, 130),
		InputFocused = Color3.fromRGB(5, 2, 10),
		InputIndicator = Color3.fromRGB(120, 50, 165),
		InputIndicatorFocus = Color3.fromRGB(138, 43, 226),
		Dialog = Color3.fromRGB(15, 5, 25),
		DialogHolder = Color3.fromRGB(12, 4, 20),
		DialogHolderLine = Color3.fromRGB(10, 3, 18),
		DialogButton = Color3.fromRGB(15, 5, 25),
		DialogButtonBorder = Color3.fromRGB(65, 20, 95),
		DialogBorder = Color3.fromRGB(55, 15, 80),
		DialogInput = Color3.fromRGB(20, 7, 32),
		DialogInputLine = Color3.fromRGB(110, 40, 155),
		Text = Color3.fromRGB(230, 210, 255),
		SubText = Color3.fromRGB(160, 120, 210),
		Hover = Color3.fromRGB(100, 35, 140),
		HoverChange = 0.04
	},
	...
	Copper = {
		...
		AcrylicMain = Color3.fromRGB(35, 20, 10),
		AcrylicBorder = Color3.fromRGB(140, 85, 40),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(55, 32, 15), Color3.fromRGB(65, 38, 18)),
		AcrylicNoise = 0.91,
		TitleBarLine = Color3.fromRGB(160, 100, 50),
		Tab = Color3.fromRGB(190, 130, 70),
		Element = Color3.fromRGB(170, 110, 55),
		ElementBorder = Color3.fromRGB(80, 48, 22),
		InElementBorder = Color3.fromRGB(130, 82, 38),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(190, 130, 70),
		ToggleToggled = Color3.fromRGB(40, 24, 10),
		SliderRail = Color3.fromRGB(190, 130, 70),
		DropdownFrame = Color3.fromRGB(200, 140, 80),
		DropdownHolder = Color3.fromRGB(55, 32, 15),
		DropdownBorder = Color3.fromRGB(80, 48, 22),
		DropdownOption = Color3.fromRGB(190, 130, 70),
		Keybind = Color3.fromRGB(190, 130, 70),
		Input = Color3.fromRGB(180, 120, 62),
		InputFocused = Color3.fromRGB(30, 18, 8),
		InputIndicator = Color3.fromRGB(210, 150, 90),
		InputIndicatorFocus = Color3.fromRGB(184, 115, 51),
		Dialog = Color3.fromRGB(55, 32, 15),
		DialogHolder = Color3.fromRGB(47, 27, 12),
		DialogHolderLine = Color3.fromRGB(42, 24, 10),
		DialogButton = Color3.fromRGB(55, 32, 15),
		DialogButtonBorder = Color3.fromRGB(120, 75, 35),
		DialogBorder = Color3.fromRGB(105, 65, 30),
		DialogInput = Color3.fromRGB(65, 40, 18),
		DialogInputLine = Color3.fromRGB(190, 130, 70),
		Text = Color3.fromRGB(255, 240, 220),
		SubText = Color3.fromRGB(200, 170, 130),
		Hover = Color3.fromRGB(190, 130, 70),
		HoverChange = 0.04
	},

	IceCave = {
		Name = "IceCave",
		Accent = Color3.fromRGB(140, 230, 255),
		AcrylicMain = Color3.fromRGB(8, 18, 35),
		AcrylicBorder = Color3.fromRGB(80, 160, 210),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 25, 50), Color3.fromRGB(15, 35, 65)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(100, 180, 230),
		Tab = Color3.fromRGB(120, 200, 245),
		Element = Color3.fromRGB(90, 170, 220),
		ElementBorder = Color3.fromRGB(40, 85, 120),
		InElementBorder = Color3.fromRGB(70, 135, 180),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(120, 200, 245),
		ToggleToggled = Color3.fromRGB(15, 35, 55),
		SliderRail = Color3.fromRGB(120, 200, 245),
		DropdownFrame = Color3.fromRGB(140, 215, 255),
		DropdownHolder = Color3.fromRGB(20, 50, 80),
		DropdownBorder = Color3.fromRGB(40, 85, 120),
		DropdownOption = Color3.fromRGB(120, 200, 245),
		Keybind = Color3.fromRGB(120, 200, 245),
		Input = Color3.fromRGB(110, 190, 235),
		InputFocused = Color3.fromRGB(8, 18, 30),
		InputIndicator = Color3.fromRGB(150, 220, 255),
		InputIndicatorFocus = Color3.fromRGB(140, 230, 255),
		Dialog = Color3.fromRGB(20, 50, 80),
		DialogHolder = Color3.fromRGB(15, 40, 65),
		DialogHolderLine = Color3.fromRGB(12, 32, 55),
		DialogButton = Color3.fromRGB(20, 50, 80),
		DialogButtonBorder = Color3.fromRGB(70, 150, 200),
		DialogBorder = Color3.fromRGB(60, 130, 180),
		DialogInput = Color3.fromRGB(25, 60, 95),
		DialogInputLine = Color3.fromRGB(120, 200, 245),
		Text = Color3.fromRGB(230, 248, 255),
		SubText = Color3.fromRGB(160, 215, 240),
		Hover = Color3.fromRGB(120, 200, 245),
		HoverChange = 0.04
	},
	...
	LavaMolten = {
		...
		AcrylicMain = Color3.fromRGB(25, 8, 0),
		AcrylicBorder = Color3.fromRGB(180, 60, 0),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(55, 15, 0), Color3.fromRGB(70, 20, 0)),
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(200, 80, 10),
		Tab = Color3.fromRGB(230, 100, 20),
		Element = Color3.fromRGB(200, 80, 10),
		ElementBorder = Color3.fromRGB(100, 35, 5),
		InElementBorder = Color3.fromRGB(160, 60, 8),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(230, 100, 20),
		ToggleToggled = Color3.fromRGB(30, 10, 2),
		SliderRail = Color3.fromRGB(230, 100, 20),
		DropdownFrame = Color3.fromRGB(245, 115, 30),
		DropdownHolder = Color3.fromRGB(60, 18, 3),
		DropdownBorder = Color3.fromRGB(100, 35, 5),
		DropdownOption = Color3.fromRGB(230, 100, 20),
		Keybind = Color3.fromRGB(230, 100, 20),
		Input = Color3.fromRGB(215, 90, 15),
		InputFocused = Color3.fromRGB(20, 7, 0),
		InputIndicator = Color3.fromRGB(250, 130, 45),
		InputIndicatorFocus = Color3.fromRGB(255, 80, 0),
		Dialog = Color3.fromRGB(60, 18, 3),
		DialogHolder = Color3.fromRGB(50, 15, 2),
		DialogHolderLine = Color3.fromRGB(45, 12, 2),
		DialogButton = Color3.fromRGB(60, 18, 3),
		DialogButtonBorder = Color3.fromRGB(160, 60, 8),
		DialogBorder = Color3.fromRGB(140, 50, 7),
		DialogInput = Color3.fromRGB(70, 22, 4),
		DialogInputLine = Color3.fromRGB(230, 100, 20),
	...
	PastelDream = {
		Name = "PastelDream",
		Accent = Color3.fromRGB(180, 140, 240),
		AcrylicMain = Color3.fromRGB(240, 235, 255),
		AcrylicBorder = Color3.fromRGB(210, 195, 240),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(250, 245, 255), Color3.fromRGB(240, 235, 250)),
		AcrylicNoise = 0.96,
		TitleBarLine = Color3.fromRGB(215, 205, 245),
		Tab = Color3.fromRGB(190, 160, 235),
		Element = Color3.fromRGB(200, 175, 240),
		ElementBorder = Color3.fromRGB(175, 155, 220),
		InElementBorder = Color3.fromRGB(195, 175, 235),
		ElementTransparency = 0.75,
		ToggleSlider = Color3.fromRGB(185, 155, 230),
		ToggleToggled = Color3.fromRGB(230, 220, 250),
		SliderRail = Color3.fromRGB(185, 155, 230),
		DropdownFrame = Color3.fromRGB(205, 185, 245),
		DropdownHolder = Color3.fromRGB(235, 228, 252),
		DropdownBorder = Color3.fromRGB(190, 170, 235),
		DropdownOption = Color3.fromRGB(185, 155, 230),
		Keybind = Color3.fromRGB(185, 155, 230),
		Input = Color3.fromRGB(195, 170, 235),
		InputFocused = Color3.fromRGB(160, 140, 200),
		InputIndicator = Color3.fromRGB(215, 195, 248),
		InputIndicatorFocus = Color3.fromRGB(180, 140, 240),
		Dialog = Color3.fromRGB(238, 232, 255),
		DialogHolder = Color3.fromRGB(232, 225, 252),
		DialogHolderLine = Color3.fromRGB(225, 218, 248),
		DialogButton = Color3.fromRGB(238, 232, 255),
		DialogButtonBorder = Color3.fromRGB(200, 180, 240),
		DialogBorder = Color3.fromRGB(195, 175, 235),
		DialogInput = Color3.fromRGB(228, 218, 250),
		DialogInputLine = Color3.fromRGB(195, 165, 235),
		Text = Color3.fromRGB(60, 40, 90),
		SubText = Color3.fromRGB(110, 85, 155),
		Hover = Color3.fromRGB(185, 155, 230),
		HoverChange = 0.03
	},
	...
	Cyberpunk = {
		...
		AcrylicMain = Color3.fromRGB(5, 0, 20),
		AcrylicBorder = Color3.fromRGB(255, 50, 130),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 5, 30), Color3.fromRGB(15, 5, 40)),
		AcrylicNoise = 0.97,
		TitleBarLine = Color3.fromRGB(255, 50, 130),
		Tab = Color3.fromRGB(0, 230, 255),
		Element = Color3.fromRGB(180, 0, 100),
		ElementBorder = Color3.fromRGB(80, 0, 45),
		InElementBorder = Color3.fromRGB(140, 0, 75),
		ElementTransparency = 0.88,
		ToggleSlider = Color3.fromRGB(255, 50, 130),
		ToggleToggled = Color3.fromRGB(8, 3, 20),
		SliderRail = Color3.fromRGB(0, 230, 255),
		DropdownFrame = Color3.fromRGB(0, 230, 255),
		DropdownHolder = Color3.fromRGB(10, 5, 30),
		DropdownBorder = Color3.fromRGB(80, 0, 45),
		DropdownOption = Color3.fromRGB(255, 50, 130),
		Keybind = Color3.fromRGB(0, 230, 255),
		Input = Color3.fromRGB(180, 0, 100),
		InputFocused = Color3.fromRGB(5, 0, 15),
		InputIndicator = Color3.fromRGB(255, 50, 130),
		InputIndicatorFocus = Color3.fromRGB(255, 220, 0),
		Dialog = Color3.fromRGB(10, 5, 30),
		DialogHolder = Color3.fromRGB(8, 3, 24),
		DialogHolderLine = Color3.fromRGB(5, 2, 20),
		DialogButton = Color3.fromRGB(10, 5, 30),
		DialogButtonBorder = Color3.fromRGB(255, 50, 130),
		DialogBorder = Color3.fromRGB(0, 200, 240),
		DialogInput = Color3.fromRGB(15, 8, 38),
		DialogInputLine = Color3.fromRGB(255, 50, 130),
		Text = Color3.fromRGB(255, 250, 200),
		SubText = Color3.fromRGB(180, 180, 255),
		Hover = Color3.fromRGB(255, 50, 130),
		HoverChange = 0.05
	},
	...
	DeepSea = {
		...
		AcrylicMain = Color3.fromRGB(5, 15, 30),
		AcrylicBorder = Color3.fromRGB(0, 100, 120),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(5, 20, 40), Color3.fromRGB(8, 28, 55)),
		AcrylicNoise = 0.94,
		TitleBarLine = Color3.fromRGB(0, 120, 140),
		Tab = Color3.fromRGB(0, 160, 180),
		Element = Color3.fromRGB(0, 130, 155),
		ElementBorder = Color3.fromRGB(0, 55, 70),
		InElementBorder = Color3.fromRGB(0, 100, 120),
		ElementTransparency = 0.88,
		ToggleSlider = Color3.fromRGB(0, 160, 180),
		ToggleToggled = Color3.fromRGB(5, 20, 30),
		SliderRail = Color3.fromRGB(0, 160, 180),
		DropdownFrame = Color3.fromRGB(0, 180, 200),
		DropdownHolder = Color3.fromRGB(5, 35, 55),
		DropdownBorder = Color3.fromRGB(0, 55, 70),
		DropdownOption = Color3.fromRGB(0, 160, 180),
		Keybind = Color3.fromRGB(0, 160, 180),
		Input = Color3.fromRGB(0, 150, 170),
		InputFocused = Color3.fromRGB(3, 12, 22),
		InputIndicator = Color3.fromRGB(0, 190, 210),
		InputIndicatorFocus = Color3.fromRGB(0, 200, 200),
		Dialog = Color3.fromRGB(5, 35, 55),
		DialogHolder = Color3.fromRGB(5, 28, 45),
		DialogHolderLine = Color3.fromRGB(4, 22, 38),
		DialogButton = Color3.fromRGB(5, 35, 55),
		DialogButtonBorder = Color3.fromRGB(0, 100, 120),
		DialogBorder = Color3.fromRGB(0, 88, 108),
		DialogInput = Color3.fromRGB(6, 42, 65),
		DialogInputLine = Color3.fromRGB(0, 160, 180),
		Text = Color3.fromRGB(200, 250, 255),
		SubText = Color3.fromRGB(120, 210, 225),
		Hover = Color3.fromRGB(0, 160, 180),
		HoverChange = 0.04
	},
	...
	Bronze = {
		...
		AcrylicMain = Color3.fromRGB(30, 20, 10),
		AcrylicBorder = Color3.fromRGB(150, 95, 40),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(50, 32, 15), Color3.fromRGB(60, 40, 18)),
		AcrylicNoise = 0.91,
		TitleBarLine = Color3.fromRGB(170, 110, 48),
		Tab = Color3.fromRGB(200, 135, 60),
		Element = Color3.fromRGB(175, 110, 48),
		ElementBorder = Color3.fromRGB(82, 52, 22),
		InElementBorder = Color3.fromRGB(138, 88, 38),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(200, 135, 60),
		ToggleToggled = Color3.fromRGB(35, 22, 10),
		SliderRail = Color3.fromRGB(200, 135, 60),
		DropdownFrame = Color3.fromRGB(215, 150, 72),
		DropdownHolder = Color3.fromRGB(55, 35, 15),
		DropdownBorder = Color3.fromRGB(82, 52, 22),
		DropdownOption = Color3.fromRGB(200, 135, 60),
		Keybind = Color3.fromRGB(200, 135, 60),
		Input = Color3.fromRGB(188, 125, 55),
		InputFocused = Color3.fromRGB(22, 14, 6),
		InputIndicator = Color3.fromRGB(220, 155, 78),
		InputIndicatorFocus = Color3.fromRGB(205, 127, 50),
		Dialog = Color3.fromRGB(55, 35, 15),
		DialogHolder = Color3.fromRGB(46, 30, 12),
		DialogHolderLine = Color3.fromRGB(40, 25, 10),
		DialogButton = Color3.fromRGB(55, 35, 15),
		DialogButtonBorder = Color3.fromRGB(128, 82, 35),
		DialogBorder = Color3.fromRGB(112, 72, 30),
		DialogInput = Color3.fromRGB(66, 42, 18),
		DialogInputLine = Color3.fromRGB(200, 135, 60),
		Text = Color3.fromRGB(255, 238, 210),
		SubText = Color3.fromRGB(200, 170, 125),
		Hover = Color3.fromRGB(200, 135, 60),
		HoverChange = 0.04
	},
	...
	Sakura = {
		...
		AcrylicMain = Color3.fromRGB(245, 225, 230),
		AcrylicBorder = Color3.fromRGB(230, 180, 195),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 240, 244), Color3.fromRGB(250, 232, 238)),
		AcrylicNoise = 0.97,
		TitleBarLine = Color3.fromRGB(235, 190, 205),
		Tab = Color3.fromRGB(240, 180, 195),
		Element = Color3.fromRGB(245, 190, 205),
		ElementBorder = Color3.fromRGB(220, 160, 175),
		InElementBorder = Color3.fromRGB(235, 175, 192),
		ElementTransparency = 0.72,
		ToggleSlider = Color3.fromRGB(238, 172, 190),
		ToggleToggled = Color3.fromRGB(235, 210, 218),
		SliderRail = Color3.fromRGB(238, 172, 190),
		DropdownFrame = Color3.fromRGB(248, 198, 212),
		DropdownHolder = Color3.fromRGB(252, 238, 242),
		DropdownBorder = Color3.fromRGB(228, 175, 190),
		DropdownOption = Color3.fromRGB(238, 172, 190),
		Keybind = Color3.fromRGB(238, 172, 190),
		Input = Color3.fromRGB(242, 182, 198),
		InputFocused = Color3.fromRGB(200, 160, 172),
		InputIndicator = Color3.fromRGB(252, 210, 222),
		InputIndicatorFocus = Color3.fromRGB(255, 192, 203),
		Dialog = Color3.fromRGB(252, 240, 244),
		DialogHolder = Color3.fromRGB(248, 235, 240),
		DialogHolderLine = Color3.fromRGB(242, 228, 235),
		DialogButton = Color3.fromRGB(252, 240, 244),
		DialogButtonBorder = Color3.fromRGB(228, 188, 200),
		DialogBorder = Color3.fromRGB(222, 180, 195),
		DialogInput = Color3.fromRGB(246, 232, 237),
		DialogInputLine = Color3.fromRGB(238, 172, 190),
		Text = Color3.fromRGB(80, 40, 55),
		SubText = Color3.fromRGB(145, 95, 115),
		Hover = Color3.fromRGB(238, 172, 190),
		HoverChange = 0.03
	},
	...
	ElectricBlue = {
		...
		AcrylicMain = Color3.fromRGB(5, 8, 25),
		AcrylicBorder = Color3.fromRGB(0, 80, 200),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(5, 12, 35), Color3.fromRGB(8, 18, 50)),
		AcrylicNoise = 0.96,
		TitleBarLine = Color3.fromRGB(0, 100, 230),
		Tab = Color3.fromRGB(30, 140, 255),
		Element = Color3.fromRGB(20, 110, 230),
		ElementBorder = Color3.fromRGB(8, 50, 110),
		InElementBorder = Color3.fromRGB(15, 85, 185),
		ElementTransparency = 0.88,
		ToggleSlider = Color3.fromRGB(30, 140, 255),
		ToggleToggled = Color3.fromRGB(5, 15, 40),
		SliderRail = Color3.fromRGB(30, 140, 255),
		DropdownFrame = Color3.fromRGB(40, 155, 255),
		DropdownHolder = Color3.fromRGB(8, 25, 65),
		DropdownBorder = Color3.fromRGB(8, 50, 110),
		DropdownOption = Color3.fromRGB(30, 140, 255),
		Keybind = Color3.fromRGB(30, 140, 255),
		Input = Color3.fromRGB(25, 130, 245),
		InputFocused = Color3.fromRGB(4, 8, 22),
		InputIndicator = Color3.fromRGB(50, 165, 255),
		InputIndicatorFocus = Color3.fromRGB(0, 120, 255),
		Dialog = Color3.fromRGB(8, 25, 65),
		DialogHolder = Color3.fromRGB(6, 20, 55),
		DialogHolderLine = Color3.fromRGB(5, 15, 45),
		DialogButton = Color3.fromRGB(8, 25, 65),
		DialogButtonBorder = Color3.fromRGB(15, 85, 185),
		DialogBorder = Color3.fromRGB(12, 70, 160),
		DialogInput = Color3.fromRGB(10, 30, 78),
		DialogInputLine = Color3.fromRGB(30, 140, 255),
		Text = Color3.fromRGB(210, 235, 255),
		SubText = Color3.fromRGB(130, 185, 255),
		Hover = Color3.fromRGB(30, 140, 255),
		HoverChange = 0.04
	},
	...
	GoldenHour = {
		...
		AcrylicMain = Color3.fromRGB(35, 25, 8),
		AcrylicBorder = Color3.fromRGB(200, 150, 40),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(70, 48, 10), Color3.fromRGB(85, 58, 12)),
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(220, 170, 50),
		Tab = Color3.fromRGB(245, 200, 65),
		Element = Color3.fromRGB(215, 165, 45),
		ElementBorder = Color3.fromRGB(105, 80, 20),
		InElementBorder = Color3.fromRGB(170, 130, 35),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(245, 200, 65),
		ToggleToggled = Color3.fromRGB(42, 30, 8),
		SliderRail = Color3.fromRGB(245, 200, 65),
		DropdownFrame = Color3.fromRGB(255, 215, 75),
		DropdownHolder = Color3.fromRGB(70, 50, 12),
		DropdownBorder = Color3.fromRGB(105, 80, 20),
		DropdownOption = Color3.fromRGB(245, 200, 65),
		Keybind = Color3.fromRGB(245, 200, 65),
		Input = Color3.fromRGB(230, 185, 55),
		InputFocused = Color3.fromRGB(28, 20, 5),
		InputIndicator = Color3.fromRGB(255, 218, 80),
		InputIndicatorFocus = Color3.fromRGB(255, 185, 30),
		Dialog = Color3.fromRGB(70, 50, 12),
		DialogHolder = Color3.fromRGB(60, 43, 10),
		DialogHolderLine = Color3.fromRGB(52, 37, 8),
		DialogButton = Color3.fromRGB(70, 50, 12),
		DialogButtonBorder = Color3.fromRGB(170, 130, 35),
		DialogBorder = Color3.fromRGB(150, 115, 30),
		DialogInput = Color3.fromRGB(82, 60, 14),
		DialogInputLine = Color3.fromRGB(245, 200, 65),
		Text = Color3.fromRGB(255, 248, 220),
		SubText = Color3.fromRGB(225, 195, 130),
		Hover = Color3.fromRGB(245, 200, 65),
		HoverChange = 0.04
	},

	ToxicGreen = {
		Name = "ToxicGreen",
		Accent = Color3.fromRGB(100, 255, 50),
		AcrylicMain = Color3.fromRGB(5, 15, 5),
		AcrylicBorder = Color3.fromRGB(50, 180, 20),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(8, 22, 8), Color3.fromRGB(10, 28, 10)),
		AcrylicNoise = 0.96,
		TitleBarLine = Color3.fromRGB(65, 200, 30),
		Tab = Color3.fromRGB(85, 230, 40),
		Element = Color3.fromRGB(65, 190, 28),
		ElementBorder = Color3.fromRGB(28, 85, 12),
		InElementBorder = Color3.fromRGB(50, 155, 22),
		ElementTransparency = 0.88,
		ToggleSlider = Color3.fromRGB(85, 230, 40),
		ToggleToggled = Color3.fromRGB(5, 20, 4),
		SliderRail = Color3.fromRGB(85, 230, 40),
		DropdownFrame = Color3.fromRGB(100, 245, 48),
		DropdownHolder = Color3.fromRGB(10, 35, 8),
		DropdownBorder = Color3.fromRGB(28, 85, 12),
		DropdownOption = Color3.fromRGB(85, 230, 40),
		Keybind = Color3.fromRGB(85, 230, 40),
		Input = Color3.fromRGB(78, 215, 36),
		InputFocused = Color3.fromRGB(3, 10, 3),
		InputIndicator = Color3.fromRGB(110, 248, 55),
		InputIndicatorFocus = Color3.fromRGB(100, 255, 50),
		Dialog = Color3.fromRGB(10, 35, 8),
		DialogHolder = Color3.fromRGB(8, 28, 6),
		DialogHolderLine = Color3.fromRGB(6, 22, 5),
		DialogButton = Color3.fromRGB(10, 35, 8),
		DialogButtonBorder = Color3.fromRGB(50, 155, 22),
		DialogBorder = Color3.fromRGB(44, 138, 20),
		DialogInput = Color3.fromRGB(12, 42, 10),
		DialogInputLine = Color3.fromRGB(85, 230, 40),
		Text = Color3.fromRGB(220, 255, 200),
		SubText = Color3.fromRGB(140, 230, 100),
		Hover = Color3.fromRGB(85, 230, 40),
		HoverChange = 0.05
	},
	...
	Obsidian = {
		...
		AcrylicBorder = Color3.fromRGB(50, 50, 58),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(12, 12, 14), Color3.fromRGB(15, 15, 18)),
		AcrylicNoise = 0.98,
		TitleBarLine = Color3.fromRGB(60, 60, 68),
		Tab = Color3.fromRGB(100, 100, 110),
		Element = Color3.fromRGB(75, 75, 85),
		ElementBorder = Color3.fromRGB(28, 28, 33),
		InElementBorder = Color3.fromRGB(55, 55, 63),
		...
		DropdownFrame = Color3.fromRGB(115, 115, 125),
		DropdownHolder = Color3.fromRGB(20, 20, 24),
		DropdownBorder = Color3.fromRGB(28, 28, 33),
		DropdownOption = Color3.fromRGB(100, 100, 110),
		Keybind = Color3.fromRGB(100, 100, 110),
		Input = Color3.fromRGB(92, 92, 102),
		InputFocused = Color3.fromRGB(6, 6, 8),
		InputIndicator = Color3.fromRGB(125, 125, 135),
		InputIndicatorFocus = Color3.fromRGB(180, 180, 190),
		Dialog = Color3.fromRGB(20, 20, 24),
		DialogHolder = Color3.fromRGB(16, 16, 20),
		DialogHolderLine = Color3.fromRGB(13, 13, 17),
		DialogButton = Color3.fromRGB(20, 20, 24),
		DialogButtonBorder = Color3.fromRGB(55, 55, 63),
		DialogBorder = Color3.fromRGB(48, 48, 56),
		DialogInput = Color3.fromRGB(24, 24, 29),
		DialogInputLine = Color3.fromRGB(100, 100, 110),
	...
	CottonCandy = {
		...
		AcrylicMain = Color3.fromRGB(255, 245, 252),
		AcrylicBorder = Color3.fromRGB(240, 200, 235),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 248, 255), Color3.fromRGB(252, 242, 252)),
		AcrylicNoise = 0.97,
		TitleBarLine = Color3.fromRGB(245, 210, 238),
		Tab = Color3.fromRGB(255, 175, 228),
		Element = Color3.fromRGB(252, 185, 232),
		ElementBorder = Color3.fromRGB(230, 175, 220),
		InElementBorder = Color3.fromRGB(245, 190, 228),
		ElementTransparency = 0.70,
		ToggleSlider = Color3.fromRGB(252, 168, 225),
		ToggleToggled = Color3.fromRGB(248, 230, 248),
		SliderRail = Color3.fromRGB(252, 168, 225),
		DropdownFrame = Color3.fromRGB(255, 188, 235),
		DropdownHolder = Color3.fromRGB(253, 242, 253),
		DropdownBorder = Color3.fromRGB(238, 190, 228),
		DropdownOption = Color3.fromRGB(252, 168, 225),
		Keybind = Color3.fromRGB(252, 168, 225),
		Input = Color3.fromRGB(253, 175, 228),
		InputFocused = Color3.fromRGB(210, 175, 208),
		InputIndicator = Color3.fromRGB(255, 200, 240),
		InputIndicatorFocus = Color3.fromRGB(255, 160, 220),
		Dialog = Color3.fromRGB(255, 245, 255),
		DialogHolder = Color3.fromRGB(252, 240, 252),
		DialogHolderLine = Color3.fromRGB(248, 235, 248),
		DialogButton = Color3.fromRGB(255, 245, 255),
		DialogButtonBorder = Color3.fromRGB(238, 198, 232),
		DialogBorder = Color3.fromRGB(232, 190, 228),
		DialogInput = Color3.fromRGB(252, 238, 250),
		DialogInputLine = Color3.fromRGB(252, 168, 225),
		Text = Color3.fromRGB(90, 45, 80),
		SubText = Color3.fromRGB(165, 105, 150),
		Hover = Color3.fromRGB(252, 168, 225),
		HoverChange = 0.03
	},
	...
	RoyalPurple = {
		...
		AcrylicMain = Color3.fromRGB(20, 10, 45),
		AcrylicBorder = Color3.fromRGB(90, 35, 150),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 15, 62), Color3.fromRGB(38, 20, 78)),
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(105, 45, 170),
		Tab = Color3.fromRGB(140, 60, 215),
		Element = Color3.fromRGB(115, 48, 185),
		ElementBorder = Color3.fromRGB(55, 22, 88),
		InElementBorder = Color3.fromRGB(88, 36, 145),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(140, 60, 215),
		ToggleToggled = Color3.fromRGB(24, 12, 50),
		SliderRail = Color3.fromRGB(140, 60, 215),
		DropdownFrame = Color3.fromRGB(155, 70, 228),
		DropdownHolder = Color3.fromRGB(38, 18, 75),
		DropdownBorder = Color3.fromRGB(55, 22, 88),
		DropdownOption = Color3.fromRGB(140, 60, 215),
		Keybind = Color3.fromRGB(140, 60, 215),
		Input = Color3.fromRGB(130, 55, 200),
		InputFocused = Color3.fromRGB(14, 7, 30),
		InputIndicator = Color3.fromRGB(162, 78, 232),
		InputIndicatorFocus = Color3.fromRGB(120, 40, 200),
		Dialog = Color3.fromRGB(38, 18, 75),
		DialogHolder = Color3.fromRGB(32, 15, 65),
		DialogHolderLine = Color3.fromRGB(27, 12, 55),
		DialogButton = Color3.fromRGB(38, 18, 75),
		DialogButtonBorder = Color3.fromRGB(95, 40, 155),
		DialogBorder = Color3.fromRGB(82, 35, 135),
		DialogInput = Color3.fromRGB(46, 22, 90),
		DialogInputLine = Color3.fromRGB(140, 60, 215),
		Text = Color3.fromRGB(240, 225, 255),
		SubText = Color3.fromRGB(185, 150, 230),
		Hover = Color3.fromRGB(140, 60, 215),
		HoverChange = 0.04
	},
	...
	SlateStorm = {
		...
		AcrylicMain = Color3.fromRGB(20, 25, 32),
		AcrylicBorder = Color3.fromRGB(65, 85, 105),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(25, 32, 42), Color3.fromRGB(30, 38, 50)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(80, 100, 125),
		Tab = Color3.fromRGB(105, 135, 165),
		Element = Color3.fromRGB(85, 112, 140),
		ElementBorder = Color3.fromRGB(38, 50, 65),
		InElementBorder = Color3.fromRGB(65, 85, 108),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(105, 135, 165),
		ToggleToggled = Color3.fromRGB(25, 32, 42),
		SliderRail = Color3.fromRGB(105, 135, 165),
		DropdownFrame = Color3.fromRGB(120, 150, 180),
		DropdownHolder = Color3.fromRGB(35, 45, 58),
		DropdownBorder = Color3.fromRGB(38, 50, 65),
		DropdownOption = Color3.fromRGB(105, 135, 165),
		Keybind = Color3.fromRGB(105, 135, 165),
		Input = Color3.fromRGB(98, 126, 155),
		InputFocused = Color3.fromRGB(16, 20, 27),
		InputIndicator = Color3.fromRGB(128, 160, 192),
		InputIndicatorFocus = Color3.fromRGB(100, 160, 200),
		Dialog = Color3.fromRGB(35, 45, 58),
		DialogHolder = Color3.fromRGB(28, 36, 48),
		DialogHolderLine = Color3.fromRGB(24, 30, 40),
		DialogButton = Color3.fromRGB(35, 45, 58),
		DialogButtonBorder = Color3.fromRGB(70, 92, 118),
		DialogBorder = Color3.fromRGB(62, 82, 105),
		DialogInput = Color3.fromRGB(42, 55, 70),
		DialogInputLine = Color3.fromRGB(105, 135, 165),
		Text = Color3.fromRGB(220, 232, 245),
		SubText = Color3.fromRGB(155, 180, 205),
		Hover = Color3.fromRGB(105, 135, 165),
		HoverChange = 0.04
	},

	WarmChocolate = {
		Name = "WarmChocolate",
		Accent = Color3.fromRGB(165, 95, 50),
		AcrylicMain = Color3.fromRGB(28, 18, 12),
		AcrylicBorder = Color3.fromRGB(120, 75, 40),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(48, 30, 18), Color3.fromRGB(58, 36, 22)),
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(138, 88, 48),
		Tab = Color3.fromRGB(170, 110, 62),
		Element = Color3.fromRGB(148, 92, 50),
		ElementBorder = Color3.fromRGB(68, 42, 22),
		InElementBorder = Color3.fromRGB(112, 70, 38),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(170, 110, 62),
		ToggleToggled = Color3.fromRGB(34, 21, 12),
		SliderRail = Color3.fromRGB(170, 110, 62),
		DropdownFrame = Color3.fromRGB(185, 122, 70),
		DropdownHolder = Color3.fromRGB(52, 32, 18),
		DropdownBorder = Color3.fromRGB(68, 42, 22),
		DropdownOption = Color3.fromRGB(170, 110, 62),
		Keybind = Color3.fromRGB(170, 110, 62),
		Input = Color3.fromRGB(160, 102, 56),
		InputFocused = Color3.fromRGB(20, 13, 8),
		InputIndicator = Color3.fromRGB(188, 128, 75),
		InputIndicatorFocus = Color3.fromRGB(165, 95, 50),
		Dialog = Color3.fromRGB(52, 32, 18),
		DialogHolder = Color3.fromRGB(44, 27, 15),
		DialogHolderLine = Color3.fromRGB(38, 23, 12),
		DialogButton = Color3.fromRGB(52, 32, 18),
		DialogButtonBorder = Color3.fromRGB(112, 70, 38),
		DialogBorder = Color3.fromRGB(98, 62, 33),
		DialogInput = Color3.fromRGB(62, 38, 22),
		DialogInputLine = Color3.fromRGB(170, 110, 62),
		Text = Color3.fromRGB(255, 242, 228),
		SubText = Color3.fromRGB(205, 172, 140),
		Hover = Color3.fromRGB(170, 110, 62),
		HoverChange = 0.04
	},
	...
	AuroraBoreal = {
		...
		AcrylicMain = Color3.fromRGB(5, 12, 25),
		AcrylicBorder = Color3.fromRGB(0, 180, 130),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(8, 18, 40), Color3.fromRGB(12, 25, 55)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(0, 200, 150),
		Tab = Color3.fromRGB(0, 220, 168),
		Element = Color3.fromRGB(0, 175, 128),
		ElementBorder = Color3.fromRGB(0, 80, 60),
		InElementBorder = Color3.fromRGB(0, 140, 105),
		ElementTransparency = 0.88,
		ToggleSlider = Color3.fromRGB(0, 220, 168),
		ToggleToggled = Color3.fromRGB(5, 18, 38),
		SliderRail = Color3.fromRGB(0, 220, 168),
		DropdownFrame = Color3.fromRGB(0, 235, 178),
		DropdownHolder = Color3.fromRGB(8, 28, 55),
		DropdownBorder = Color3.fromRGB(0, 80, 60),
		DropdownOption = Color3.fromRGB(0, 220, 168),
		Keybind = Color3.fromRGB(0, 220, 168),
		Input = Color3.fromRGB(0, 208, 158),
		InputFocused = Color3.fromRGB(4, 10, 22),
		InputIndicator = Color3.fromRGB(0, 240, 185),
		InputIndicatorFocus = Color3.fromRGB(0, 255, 160),
		Dialog = Color3.fromRGB(8, 28, 55),
		DialogHolder = Color3.fromRGB(6, 22, 45),
		DialogHolderLine = Color3.fromRGB(5, 18, 38),
		DialogButton = Color3.fromRGB(8, 28, 55),
		DialogButtonBorder = Color3.fromRGB(0, 148, 110),
		DialogBorder = Color3.fromRGB(0, 130, 98),
		DialogInput = Color3.fromRGB(10, 34, 65),
		DialogInputLine = Color3.fromRGB(0, 220, 168),
		Text = Color3.fromRGB(210, 255, 240),
		SubText = Color3.fromRGB(120, 225, 190),
		Hover = Color3.fromRGB(0, 220, 168),
		HoverChange = 0.04
	}
...
Components.Section = (function()
	...
	return function(Title, Parent, Icon)
		...
		Creator.AddSignal(Section.Layout:GetPropertyChangedSignal("AbsoluteContentSize"), function()
			...
			Section.Root.Size = UDim2.new(1, 0, 0, Section.Layout.AbsoluteContentSize.Y + 27)
		end)
...
Components.Tab = (function()
	...
	function TabModule:New(Title, Icon, Parent)
		...
		Tab.Frame = New("TextButton", {
			...
			-- Active indicator dot (Bata X style)
			New("Frame", {
				Name = "ActiveDot",
			...
			New("TextLabel", {
				AnchorPoint = Vector2.new(0, 0.5),
				Position = not fischbypass and Icon and UDim2.new(0, 32, 0.5, 0) or UDim2.new(0, 14, 0.5, 0),
				Text = Title,
				RichText = true,
		...
		-- Bata X: Wrap SetTransparency to also update ActiveDot
		local _originalSetTransparency = Tab.SetTransparency
		Tab.SetTransparency = function(v, instant)
			_originalSetTransparency(v, instant)
			local dot = Tab.Frame:FindFirstChild("ActiveDot")
			if dot then
				local isSelected = (v <= 0.89)
...
Components.Notification = (function()
	...
	function Notification:New(Config)
		...
		-- Accent left border (Bata X style)
		...
		-- Progress bar (timer) at the bottom of notification
		...
		function NewNotification:Open()
			...
			local notifHeight = 62 + ContentSize
			NewNotification.Holder.Size = UDim2.new(1, 0, 0, notifHeight)
			...
			-- Animate progress bar if duration set
			if Config.Duration and NewNotification.ProgressBar then
				local fill = NewNotification.ProgressBar:FindFirstChild("Fill")
				if fill then
					fill.Size = UDim2.fromScale(1, 1)
					TweenService:Create(fill, TweenInfo.new(Config.Duration, Enum.EasingStyle.Linear), {
						Size = UDim2.fromScale(0, 1),
					}):Play()
				end
			end
...
Components.TitleBar = (function()
	...
	return function(Config)
		...
		TitleBar.Frame = New("Frame", {
			...
			-- Accent underline (Bata X rework style)
			New("Frame", {
				Name = "AccentLine",
				BackgroundTransparency = 0,
...
Components.Window = (function()
	...
	return function(Config)
		...
		-- Bata X: outer glow/shadow effect
		local ShadowFrame = New("ImageLabel", {
			Name = "BataXShadow",
			Image = "rbxassetid://6014260935",
			ImageColor3 = Color3.fromRGB(0, 0, 0),
...
ElementsTable.Button = (function()
	...
	function Element:New(Config)
		...
		Creator.AddSignal(ButtonFrame.Frame.MouseButton1Click, function()
			-- Bata X: button press scale feedback
			local scaleObj = ButtonFrame.Frame:FindFirstChildOfClass("UIScale")
			if not scaleObj then
				scaleObj = New("UIScale", { Scale = 1, Parent = ButtonFrame.Frame })
			end
			TweenService:Create(scaleObj, TweenInfo.new(0.08, Enum.EasingStyle.Quint), { Scale = 0.97 }):Play()
			task.delay(0.08, function()
				TweenService:Create(scaleObj, TweenInfo.new(0.18, Enum.EasingStyle.Back, Enum.EasingDirection.Out), { Scale = 1 }):Play()
			end)
	...
	function Element:New(Idx, Config)
		...
		function Toggle:SetValue(Value)
			...
			TweenService:Create(
				...
				{ Position = UDim2.new(0, Toggle.Value and 23 or 3, 0.5, 0) }
			):Play()
			TweenService:Create(
				ToggleSlider,
			...
			ToggleCircle.BackgroundTransparency = Toggle.Value and 0 or 0.3
...
ElementsTable.Paragraph = (function()
	...
	function Paragraph:New(Config)
		...
		Paragraph.Frame.BackgroundTransparency = 0.93
		Paragraph.Border.Transparency = 0.7
		-- Bata X: italic description text for paragraphs
		if Paragraph.DescLabel then
			Paragraph.DescLabel.FontFace = Font.new(
				"rbxasset://fonts/families/GothamSSm.json",
				Enum.FontWeight.Regular,
...
ElementsTable.Slider = (function()
	...
	function Element:New(Idx, Config)
		...
		local SliderDot = New("Frame", {
			...
			New("UICorner", { CornerRadius = UDim.new(1, 0) }),
			New("UIStroke", { Transparency = 0.5, Thickness = 1.5, ThemeTag = { Color = "AcrylicMain" } }),
		})
...
ElementsTable.Input = (function()
	...
	function Element:New(Idx, Config)
		...
		Textbox.Frame.Size = UDim2.fromOffset(170, 32)
		Textbox.Input.Text = Config.Default or ""
		Textbox.Input.PlaceholderText = Config.Placeholder or ""
		-- Bata X: accent focus line at bottom of input
		local InputFocusLine = New("Frame", {
			Name = "FocusLine",
		...
		InputFocusLine.Parent = Textbox.Frame
		Creator.AddSignal(Textbox.Input.Focused, function()
			TweenService:Create(InputFocusLine, TweenInfo.new(0.2, Enum.EasingStyle.Quint), {
...
-- ============================================================
-- BATA X REWORK — 50+ NEW FEATURES & UTILITIES
-- ============================================================

-- [1] Toast Notification (lightweight, auto-dismiss)
function Library:Toast(text, duration)
	...
	local ToastFrame = New("Frame", {
		...
		New("UIStroke", {
			Transparency = 0.6,
			Color = Creator.GetThemeProperty("AcrylicBorder"),
		}),
		New("TextLabel", {
			Text = text,
	...
	ToastFrame.Position = UDim2.new(0.5, 0, 1, 80)
	TweenService:Create(ToastFrame, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
		Position = UDim2.new(0.5, 0, 1, -24),
	}):Play()

	task.delay(duration, function()
		TweenService:Create(ToastFrame, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {
...
-- [2] Confirm Dialog (returns promise-style via callback)
function Library:Confirm(title, message, onConfirm, onCancel)
	if Library.Window then
		Library.Window:Dialog({
			Title = title,
			Content = message,
			Buttons = {
				{ Title = "Confirm", Callback = onConfirm or function() end },
				{ Title = "Cancel", Callback = onCancel or function() end },
			},
		})
	end
end

-- [3] Timed Progress Notification
function Library:ProgressNotify(title, duration, onComplete)
...
-- [4] Get all option values as table
function Library:GetAllValues()
	local result = {}
	for idx, option in pairs(Library.Options) do
		if option.Value ~= nil then
			result[idx] = option.Value
		end
	end
	return result
end

-- [5] Set multiple options at once
function Library:SetValues(tbl)
	for idx, val in pairs(tbl) do
		if Library.Options[idx] and Library.Options[idx].SetValue then
			Library.Options[idx]:SetValue(val)
		end
	end
end

-- [6] Reset all options to default
...
-- [7] Get option by index
function Library:GetOption(idx)
	return Library.Options[idx]
end

-- [8] Check if option exists
function Library:HasOption(idx)
	return Library.Options[idx] ~= nil
end

-- [9] Set option visibility by index
function Library:SetOptionVisible(idx, visible)
...
-- [10] Cycle through themes
local _themeIdx = 1
function Library:NextTheme()
	local themes = Library.Themes
	_themeIdx = (_themeIdx % #themes) + 1
	Library:SetTheme(themes[_themeIdx])
	return themes[_themeIdx]
end

function Library:PreviousTheme()
	local themes = Library.Themes
	_themeIdx = ((_themeIdx - 2) % #themes) + 1
	Library:SetTheme(themes[_themeIdx])
	return themes[_themeIdx]
end

-- [11] Get current theme name
function Library:GetTheme()
	return Library.Theme
end

-- [12] Check if current theme is dark
function Library:IsDarkTheme()
	local bg = Creator.GetThemeProperty("AcrylicMain")
	if bg then
...
-- [13] Watermark display (top-left label)
local _watermarkGui = nil
function Library:SetWatermark(text, options)
	options = options or {}
	if _watermarkGui then _watermarkGui:Destroy() end
	if not text or text == "" then return end

	local New = Creator.New
	_watermarkGui = New("ScreenGui", {
		Name = "BataXWatermark",
		DisplayOrder = 998,
		IgnoreGuiInset = true,
		ResetOnSpawn = false,
	})
	ProtectGui(_watermarkGui)
	_watermarkGui.Parent = game:GetService("CoreGui")

	local wFrame = New("Frame", {
		Size = UDim2.fromOffset(0, 28),
		AutomaticSize = Enum.AutomaticSize.X,
		AnchorPoint = Vector2.new(0, 0),
		Position = UDim2.new(0, options.X or 10, 0, options.Y or 10),
		BackgroundColor3 = Creator.GetThemeProperty("AcrylicMain"),
		BackgroundTransparency = 0.15,
		Parent = _watermarkGui,
	}, {
	...
	Library._watermarkFrame = wFrame
end

function Library:UpdateWatermark(text)
	if Library._watermarkFrame then
		local lbl = Library._watermarkFrame:FindFirstChildWhichIsA("TextLabel")
		if lbl then lbl.Text = text end
	end
end

function Library:HideWatermark()
	if _watermarkGui then _watermarkGui:Destroy(); _watermarkGui = nil end
end

-- [14] Screen flash effect
function Library:Flash(color, duration)
	color = color or Creator.GetThemeProperty("Accent")
	duration = duration or 0.3
	local New = Creator.New
	local FlashGui = New("ScreenGui", {
		Name = "BataXFlash",
		DisplayOrder = 9998,
		IgnoreGuiInset = true,
	})
	...
	TweenService:Create(FlashFrame, TweenInfo.new(duration, Enum.EasingStyle.Quint), {
		BackgroundTransparency = 1,
	}):Play()
	task.delay(duration + 0.1, function() FlashGui:Destroy() end)
end

-- [15] Window title updater
function Library:SetTitle(title)
	if Library.Window and Library.Window.TitleLabel then
		Library.Window.TitleLabel.Text = title
	end
end
...
-- [17] Resize window (if not locked)
function Library:ResizeWindow(width, height)
	if Library.Window and Library.Window.Root and not Library.Window.SizeLocked then
		TweenService:Create(Library.Window.Root, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {
			Size = UDim2.fromOffset(width, height),
		}):Play()
	end
end

-- [18] Toggle window minimized state
...
-- [19] Show/hide window entirely
function Library:SetVisible(visible)
	if Library.Window and Library.Window.Root then
		Library.Window.Root.Visible = visible
	end
end

-- [20] Check if window is visible
function Library:IsVisible()
	if Library.Window and Library.Window.Root then
		return Library.Window.Root.Visible
	end
	return false
end

-- [21] Keybind to toggle visibility
function Library:BindToggleKey(keyCode)
...
-- [24] Animation speed multiplier
Library.AnimSpeed = 1.0
function Library:SetAnimSpeed(multiplier)
	Library.AnimSpeed = math.clamp(multiplier, 0.1, 5.0)
end

-- [25] Blur toggle (acrylic effect)
function Library:SetBlur(enabled)
	Library:ToggleAcrylic(enabled)
end

-- [26] Count registered options
function Library:OptionCount()
	local count = 0
	for _ in pairs(Library.Options) do count = count + 1 end
	return count
end

-- [27] Export options to JSON string
function Library:ExportConfig()
	local data = Library:GetAllValues()
...
-- [28] Import options from JSON string
function Library:ImportConfig(jsonStr)
	local success, data = pcall(function()
		return game:GetService("HttpService"):JSONDecode(jsonStr)
	end)
	if success and type(data) == "table" then
		Library:SetValues(data)
		return true
	end
	return false
end

-- [29] Search options by title substring
function Library:SearchOptions(query)
	query = query:lower()
	local results = {}
	for idx, option in pairs(Library.Options) do
		if tostring(idx):lower():find(query) then
			results[idx] = option
		end
	end
	return results
...
-- [30] Theme randomizer
function Library:RandomTheme()
	local themes = Library.Themes
	local idx = math.random(1, #themes)
	Library:SetTheme(themes[idx])
	return themes[idx]
end

-- [31] Get all theme names
function Library:GetThemes()
	return Library.Themes
end

-- [32] Check if a theme exists
function Library:ThemeExists(name)
	return Themes[name] ~= nil
end

-- [33] Add a custom theme at runtime
function Library:AddTheme(name, themeData)
	...
	Library.Themes = Themes.Names
end

-- [34] Remove a custom theme (can't remove built-ins)
local _builtInThemes = {}
do
	for _, n in ipairs(Themes.Names) do _builtInThemes[n] = true end
end
function Library:RemoveTheme(name)
	if _builtInThemes[name] then return false, "Cannot remove built-in theme" end
	Themes[name] = nil
	for i, v in ipairs(Themes.Names) do
		if v == name then table.remove(Themes.Names, i); break end
	end
	Library.Themes = Themes.Names
	return true
end

-- [35] Pulse accent animation (visual flair)
function Library:PulseAccent(times)
	times = times or 3
	local accent = Creator.GetThemeProperty("Accent")
	local bright = Color3.new(
		math.min(accent.R + 0.25, 1),
		math.min(accent.G + 0.25, 1),
		math.min(accent.B + 0.25, 1)
	)
	local count = 0
	local function doPulse()
		if count >= times then return end
		count = count + 1
		Themes[Library.Theme].Accent = bright
		Creator.UpdateTheme()
		task.wait(0.18)
		Themes[Library.Theme].Accent = accent
		Creator.UpdateTheme()
		task.wait(0.18)
		doPulse()
	end
...
-- [36] Notification badge (counter on window)
Library._badgeCount = 0
local _badgeLabel = nil
function Library:SetBadge(count)
	Library._badgeCount = count
	if Library.Window and Library.Window.Root then
		if not _badgeLabel then
			local New = Creator.New
			_badgeLabel = New("TextLabel", {
				Name = "BataXBadge",
				Size = UDim2.fromOffset(20, 20),
				AnchorPoint = Vector2.new(1, 0),
			...
			_badgeLabel.Text = tostring(count)
			_badgeLabel.Visible = count > 0
		end
	end
end

function Library:ClearBadge()
	Library:SetBadge(0)
	if _badgeLabel then _badgeLabel.Visible = false end
end

-- [37] FPS display overlay
local _fpsGui = nil
local _fpsConn = nil
function Library:ShowFPS(enabled)
	if not enabled then
		if _fpsGui then _fpsGui:Destroy(); _fpsGui = nil end
		if _fpsConn then _fpsConn:Disconnect(); _fpsConn = nil end
		return
	end
	local New = Creator.New
	_fpsGui = New("ScreenGui", {
		Name = "BataXFPS",
		DisplayOrder = 997,
		IgnoreGuiInset = true,
		ResetOnSpawn = false,
	...
	local last = tick()
	local frames = 0
	_fpsConn = RunService.RenderStepped:Connect(function()
		frames = frames + 1
		local now = tick()
		if now - last >= 0.5 then
			local fps = math.round(frames / (now - last))
			fpsLabel.Text = "FPS: " .. fps
			fpsLabel.TextColor3 = fps >= 55 and Color3.fromRGB(100, 220, 100)
...
-- [38] Ping display overlay
local _pingGui = nil
local _pingConn = nil
function Library:ShowPing(enabled)
	if not enabled then
		if _pingGui then _pingGui:Destroy(); _pingGui = nil end
		if _pingConn then _pingConn:Disconnect(); _pingConn = nil end
		return
	end
	local New = Creator.New
	_pingGui = New("ScreenGui", {
		Name = "BataXPing",
		DisplayOrder = 997,
		IgnoreGuiInset = true,
		ResetOnSpawn = false,
	...
	ProtectGui(_pingGui)
	_pingGui.Parent = game:GetService("CoreGui")
	...
	_pingConn = RunService.Heartbeat:Connect(function()
		...
		pingLabel.TextColor3 = ping <= 80 and Color3.fromRGB(100, 220, 100)
			or ping <= 150 and Color3.fromRGB(255, 200, 50)
			or Color3.fromRGB(255, 80, 80)
	end)
end

-- [39] Clock overlay (top-right)
local _clockGui = nil
local _clockConn = nil
function Library:ShowClock(enabled, format24)
	if not enabled then
		if _clockGui then _clockGui:Destroy(); _clockGui = nil end
		if _clockConn then _clockConn:Disconnect(); _clockConn = nil end
		return
	end
	local New = Creator.New
	_clockGui = New("ScreenGui", {
		Name = "BataXClock",
		DisplayOrder = 996,
		IgnoreGuiInset = true,
		ResetOnSpawn = false,
	})
	ProtectGui(_clockGui)
	_clockGui.Parent = game:GetService("CoreGui")
	local clockLabel = New("TextLabel", {
		Size = UDim2.fromOffset(85, 22),
		AnchorPoint = Vector2.new(1, 0),
		Position = UDim2.new(1, -10, 0, 66),
		BackgroundColor3 = Creator.GetThemeProperty("AcrylicMain"),
		BackgroundTransparency = 0.2,
	...
	_clockConn = RunService.Heartbeat:Connect(function()
		local t = os.date("*t")
		if format24 then
			...
			clockLabel.Text = string.format("%d:%02d %s", h, t.min, t.hour >= 12 and "PM" or "AM")
		end
	end)
end

-- [40] Spotlight search overlay (search all options)
Library._spotlightOpen = false
local _spotlightGui = nil
function Library:OpenSpotlight()
	if Library._spotlightOpen then return end
	Library._spotlightOpen = true
	local New = Creator.New
	_spotlightGui = New("ScreenGui", {
		Name = "BataXSpotlight",
		DisplayOrder = 10000,
		IgnoreGuiInset = true,
	})
	ProtectGui(_spotlightGui)
	_spotlightGui.Parent = game:GetService("CoreGui")
	...
	local panel = New("Frame", {
		...
		New("UIStroke", { Color = Creator.GetThemeProperty("Accent"), Transparency = 0.4 }),
	})
	...
	local function refreshResults(query)
		...
		local results = Library:SearchOptions(query)
		local count = 0
...
function Library:CloseSpotlight()
	Library._spotlightOpen = false
	if _spotlightGui then _spotlightGui:Destroy(); _spotlightGui = nil end
end

-- [41] Keybind spotlight open
function Library:BindSpotlight(keyCode)
	keyCode = keyCode or Enum.KeyCode.Slash
	Creator.AddSignal(UserInputService.InputBegan, function(input, gpe)
		if gpe then return end
		if input.KeyCode == keyCode then
			if Library._spotlightOpen then Library:CloseSpotlight()
			else Library:OpenSpotlight() end
		end
	end)
end

-- [42] Typewriter effect for labels
function Library:Typewrite(label, text, speed)
	speed = speed or 0.04
	task.spawn(function()
		label.Text = ""
		for i = 1, #text do
...
-- [43] Color utility: lerp between two Color3s
function Library:LerpColor(c1, c2, t)
	return Color3.new(
		c1.R + (c2.R - c1.R) * t,
		c1.G + (c2.G - c1.G) * t,
		c1.B + (c2.B - c1.B) * t
...
-- [44] Color utility: Color3 to hex string
...
-- [45] Color utility: hex string to Color3
...
-- [46] Tween shortcut (any Instance)
...
-- [47] Debounce wrapper
function Library:Debounce(fn, wait)
	wait = wait or 0.5
	local last = 0
	return function(...)
		local now = tick()
...
-- [48] Throttle wrapper (max once per interval)
function Library:Throttle(fn, interval)
	...
	return function(...)
		...
		running = true
		fn(...)
		task.delay(interval, function() running = false end)
	end
end

-- [49] Memoize (cache function results)
function Library:Memoize(fn)
	local cache = {}
	return function(key)
...
-- [50] Safe pcall wrapper with notification on error
function Library:Try(fn, ...)
...
-- [51] Toggle option value programmatically
function Library:ToggleOption(idx)
	local opt = Library.Options[idx]
	if opt and opt.Type == "Toggle" and opt.SetValue then
		opt:SetValue(not opt.Value)
	end
end

-- [52] Increment slider value
function Library:IncrementSlider(idx, amount)
	local opt = Library.Options[idx]
	if opt and opt.Type == "Slider" and opt.SetValue then
		local newVal = math.clamp(
			(opt.Value or 0) + (amount or 1),
			opt.Min or 0,
			opt.Max or 100
		)
		opt:SetValue(newVal)
...
-- [53] Set dropdown to random value
function Library:RandomDropdown(idx)
	local opt = Library.Options[idx]
	if opt and opt.Type == "Dropdown" and opt.Values and #opt.Values > 0 then
		local randomVal = opt.Values[math.random(1, #opt.Values)]
		opt:SetValue(randomVal)
	end
end

-- [54] Screenshot overlay (capture feedback visual)
function Library:Screenshot()
	Library:Flash(Creator.GetThemeProperty("Accent"), 0.15)
	Library:Toast("📷 Screenshot taken", 2)
end

-- [55] Status indicator (colored dot on titlebar)
local _statusDot = nil
function Library:SetStatus(state)
	-- state: "online" | "idle" | "busy" | "offline"
	local colors = {
		online = Color3.fromRGB(80, 220, 100),
		idle = Color3.fromRGB(255, 200, 50),
		busy = Color3.fromRGB(255, 80, 80),
		offline = Color3.fromRGB(140, 140, 140),
	}
	local color = colors[state] or colors.offline
	if Library.Window and Library.Window.Root then
		if not _statusDot then
			local New = Creator.New
			_statusDot = New("Frame", {
				Name = "BataXStatus",
			...
			TweenService:Create(_statusDot, TweenInfo.new(0.2), { BackgroundColor3 = color }):Play()
		end
	end
	Library._currentStatus = state
end

function Library:GetStatus()
	return Library._currentStatus or "offline"
end

-- [56] Cursor highlight (glow ring around mouse)
local _cursorGui = nil
local _cursorConn = nil
function Library:SetCursorHighlight(enabled, color)
	if not enabled then
	...
	color = color or Creator.GetThemeProperty("Accent")
	local New = Creator.New
	_cursorGui = New("ScreenGui", {
		Name = "BataXCursor",
		DisplayOrder = 9990,
		IgnoreGuiInset = true,
	})
	ProtectGui(_cursorGui)
	_cursorGui.Parent = game:GetService("CoreGui")
	local ring = New("Frame", {
		...
		New("UICorner", { CornerRadius = UDim.new(1, 0) }),
		New("UIStroke", { Color = color, Thickness = 2, Transparency = 0.3 }),
	})
	_cursorConn = RunService.RenderStepped:Connect(function()
		local pos = UserInputService:GetMouseLocation()
		ring.Position = UDim2.fromOffset(pos.X, pos.Y)
	end)
end

-- [57] Option group enable/disable
function Library:SetGroupEnabled(indices, enabled)
	for _, idx in ipairs(indices) do
		Library:SetOptionVisible(idx, enabled)
	end
end

-- [58] Delayed callback runner
function Library:After(seconds, fn)
	task.delay(seconds, fn)
end

-- [59] Repeating callback runner
function Library:Every(seconds, fn, stopAfter)
	local count = 0
	local conn
	...
	task.spawn(function()
		while true do
			...
			fn()
			count = count + 1
			if stopAfter and count >= stopAfter then
				conn:Disconnect()
				break
			end
		end
...
-- [60] Get library version
function Library:GetVersion()
	return Library.Version
end

-- ============================================================
-- UI REWORK HELPERS (Bata X Style Upgrades)
-- ============================================================

-- [UI-1] Gradient accent line on window titlebar
function Library:AddTitlebarAccentLine()
	if Library.Window and Library.Window.Root then
		local New = Creator.New
		local existing = Library.Window.Root:FindFirstChild("BataXAccentLine")
		if existing then existing:Destroy() end
		New("Frame", {
			Name = "BataXAccentLine",
...
-- [UI-2] Ripple effect on button click
function Library:AddRipple(button)
	Creator.AddSignal(button.MouseButton1Click, function()
		local New = Creator.New
		local mouse = UserInputService:GetMouseLocation()
		local pos = button.AbsolutePosition
		local relX = mouse.X - pos.X
		local relY = mouse.Y - pos.Y
		...
		TweenService:Create(ripple, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {
...
-- [UI-3] Smooth window open animation
function Library:AnimateWindowOpen()
	if Library.Window and Library.Window.Root then
		local root = Library.Window.Root
		root.GroupTransparency = 1
		local s = root:FindFirstChildOfClass("UIScale") or Creator.New("UIScale", { Scale = 0.92, Parent = root })
		TweenService:Create(root, TweenInfo.new(0.35, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
			GroupTransparency = 0,
		}):Play()
		TweenService:Create(s, TweenInfo.new(0.35, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
			Scale = 1,
		}):Play()
	end
end

-- [UI-4] Shake window (error feedback)
function Library:ShakeWindow()
	if Library.Window and Library.Window.Root then
		local root = Library.Window.Root
		...
		task.spawn(function()
			for _, ox in ipairs(offsets) do
				root.Position = UDim2.new(origPos.X.Scale, origPos.X.Offset + ox, origPos.Y.Scale, origPos.Y.Offset)
				task.wait(0.04)
			end
...
-- [UI-5] Highlight a specific option element briefly
function Library:HighlightOption(idx)
	local opt = Library.Options[idx]
