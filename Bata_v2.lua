...
local Themes = {
	...
	Neon = {
		...
		AcrylicMain = Color3.fromRGB(5, 5, 20),
		AcrylicBorder = Color3.fromRGB(0, 200, 140),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(5, 5, 20), Color3.fromRGB(10, 10, 30)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(0, 180, 120),
		Tab = Color3.fromRGB(0, 160, 110),
		Element = Color3.fromRGB(0, 130, 90),
		ElementBorder = Color3.fromRGB(0, 80, 60),
		InElementBorder = Color3.fromRGB(0, 150, 100),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(0, 200, 140),
		ToggleToggled = Color3.fromRGB(5, 15, 10),
		SliderRail = Color3.fromRGB(0, 180, 120),
		DropdownFrame = Color3.fromRGB(0, 200, 150),
		DropdownHolder = Color3.fromRGB(5, 30, 25),
		DropdownBorder = Color3.fromRGB(0, 100, 70),
		DropdownOption = Color3.fromRGB(0, 180, 130),
		Keybind = Color3.fromRGB(0, 180, 130),
		Input = Color3.fromRGB(0, 160, 110),
		InputFocused = Color3.fromRGB(3, 10, 8),
		InputIndicator = Color3.fromRGB(0, 220, 160),
		InputIndicatorFocus = Color3.fromRGB(0, 255, 180),
		Dialog = Color3.fromRGB(5, 30, 25),
		DialogHolder = Color3.fromRGB(3, 20, 18),
		DialogHolderLine = Color3.fromRGB(0, 100, 70),
		DialogButton = Color3.fromRGB(5, 35, 28),
		DialogButtonBorder = Color3.fromRGB(0, 150, 100),
		DialogBorder = Color3.fromRGB(0, 120, 85),
		DialogInput = Color3.fromRGB(5, 40, 32),
		DialogInputLine = Color3.fromRGB(0, 200, 140),
		Text = Color3.fromRGB(200, 255, 240),
		SubText = Color3.fromRGB(120, 200, 170),
		Hover = Color3.fromRGB(0, 180, 130),
		HoverChange = 0.05
	},

	Cyberpunk = {
		Name = "Cyberpunk",
		Accent = Color3.fromRGB(255, 240, 0),
		AcrylicMain = Color3.fromRGB(10, 5, 25),
		AcrylicBorder = Color3.fromRGB(200, 0, 120),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 5, 40), Color3.fromRGB(10, 2, 25)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(255, 0, 150),
		Tab = Color3.fromRGB(180, 0, 100),
		Element = Color3.fromRGB(150, 0, 85),
		ElementBorder = Color3.fromRGB(80, 0, 50),
		InElementBorder = Color3.fromRGB(200, 0, 120),
		ElementTransparency = 0.82,
		ToggleSlider = Color3.fromRGB(255, 240, 0),
		ToggleToggled = Color3.fromRGB(20, 15, 5),
		SliderRail = Color3.fromRGB(200, 0, 120),
		DropdownFrame = Color3.fromRGB(255, 100, 180),
		DropdownHolder = Color3.fromRGB(15, 5, 35),
		DropdownBorder = Color3.fromRGB(180, 0, 100),
		DropdownOption = Color3.fromRGB(220, 0, 130),
		Keybind = Color3.fromRGB(220, 0, 130),
		Input = Color3.fromRGB(200, 0, 120),
		InputFocused = Color3.fromRGB(8, 3, 15),
		InputIndicator = Color3.fromRGB(255, 100, 180),
		InputIndicatorFocus = Color3.fromRGB(255, 240, 0),
		Dialog = Color3.fromRGB(15, 5, 35),
		DialogHolder = Color3.fromRGB(10, 3, 25),
		DialogHolderLine = Color3.fromRGB(150, 0, 90),
		DialogButton = Color3.fromRGB(18, 6, 40),
		DialogButtonBorder = Color3.fromRGB(200, 0, 120),
		DialogBorder = Color3.fromRGB(160, 0, 95),
		DialogInput = Color3.fromRGB(20, 8, 45),
	...
	Latte = {
		...
		AcrylicMain = Color3.fromRGB(255, 248, 238),
		AcrylicBorder = Color3.fromRGB(220, 195, 165),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 250, 242), Color3.fromRGB(248, 240, 228)),
		AcrylicNoise = 0.97,
		TitleBarLine = Color3.fromRGB(200, 175, 145),
		Tab = Color3.fromRGB(165, 125, 85),
		Element = Color3.fromRGB(230, 210, 185),
		ElementBorder = Color3.fromRGB(195, 170, 140),
		InElementBorder = Color3.fromRGB(215, 190, 160),
		ElementTransparency = 0.70,
		ToggleSlider = Color3.fromRGB(180, 130, 80),
		ToggleToggled = Color3.fromRGB(255, 250, 242),
		SliderRail = Color3.fromRGB(195, 155, 110),
		DropdownFrame = Color3.fromRGB(215, 190, 160),
		DropdownHolder = Color3.fromRGB(248, 242, 232),
		DropdownBorder = Color3.fromRGB(200, 175, 145),
		DropdownOption = Color3.fromRGB(190, 155, 115),
		Keybind = Color3.fromRGB(190, 155, 115),
		Input = Color3.fromRGB(220, 198, 170),
		InputFocused = Color3.fromRGB(160, 125, 85),
		InputIndicator = Color3.fromRGB(195, 165, 130),
		InputIndicatorFocus = Color3.fromRGB(180, 130, 80),
		Dialog = Color3.fromRGB(252, 246, 238),
		DialogHolder = Color3.fromRGB(248, 240, 228),
		DialogHolderLine = Color3.fromRGB(230, 215, 195),
		DialogButton = Color3.fromRGB(252, 248, 240),
		DialogButtonBorder = Color3.fromRGB(205, 178, 148),
		DialogBorder = Color3.fromRGB(195, 168, 138),
		DialogInput = Color3.fromRGB(242, 230, 215),
		DialogInputLine = Color3.fromRGB(180, 150, 110),
		Text = Color3.fromRGB(50, 35, 20),
		SubText = Color3.fromRGB(120, 90, 60),
		Hover = Color3.fromRGB(205, 178, 148),
		HoverChange = 0.08
	},
	...
	Dracula = {
		...
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 32, 44), Color3.fromRGB(40, 42, 54)),
		AcrylicNoise = 0.94,
		TitleBarLine = Color3.fromRGB(68, 71, 90),
		Tab = Color3.fromRGB(98, 114, 164),
		Element = Color3.fromRGB(68, 71, 90),
		ElementBorder = Color3.fromRGB(40, 42, 54),
		InElementBorder = Color3.fromRGB(80, 85, 110),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(189, 147, 249),
		ToggleToggled = Color3.fromRGB(30, 32, 44),
		SliderRail = Color3.fromRGB(139, 110, 210),
		DropdownFrame = Color3.fromRGB(120, 130, 180),
		DropdownHolder = Color3.fromRGB(40, 42, 56),
		DropdownBorder = Color3.fromRGB(68, 71, 90),
		DropdownOption = Color3.fromRGB(98, 114, 164),
		Keybind = Color3.fromRGB(98, 114, 164),
		Input = Color3.fromRGB(80, 85, 110),
		InputFocused = Color3.fromRGB(20, 21, 30),
		InputIndicator = Color3.fromRGB(139, 110, 210),
		InputIndicatorFocus = Color3.fromRGB(189, 147, 249),
		Dialog = Color3.fromRGB(44, 47, 60),
		DialogHolder = Color3.fromRGB(35, 38, 50),
		DialogHolderLine = Color3.fromRGB(60, 64, 82),
		DialogButton = Color3.fromRGB(48, 52, 66),
		DialogButtonBorder = Color3.fromRGB(80, 88, 120),
		DialogBorder = Color3.fromRGB(68, 71, 90),
		DialogInput = Color3.fromRGB(55, 58, 75),
		DialogInputLine = Color3.fromRGB(139, 110, 210),
		Text = Color3.fromRGB(248, 248, 242),
		SubText = Color3.fromRGB(189, 188, 200),
		Hover = Color3.fromRGB(98, 114, 164),
		HoverChange = 0.04
	},
	...
	Nord = {
		...
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(36, 42, 54), Color3.fromRGB(46, 52, 64)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(67, 76, 94),
		Tab = Color3.fromRGB(97, 110, 135),
		Element = Color3.fromRGB(67, 76, 94),
		ElementBorder = Color3.fromRGB(46, 52, 64),
		InElementBorder = Color3.fromRGB(80, 91, 112),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(136, 192, 208),
		ToggleToggled = Color3.fromRGB(36, 42, 54),
		SliderRail = Color3.fromRGB(129, 161, 193),
		DropdownFrame = Color3.fromRGB(115, 135, 165),
		DropdownHolder = Color3.fromRGB(50, 56, 68),
		DropdownBorder = Color3.fromRGB(67, 76, 94),
		DropdownOption = Color3.fromRGB(97, 110, 135),
		Keybind = Color3.fromRGB(97, 110, 135),
		Input = Color3.fromRGB(80, 91, 112),
		InputFocused = Color3.fromRGB(26, 30, 40),
		InputIndicator = Color3.fromRGB(115, 145, 175),
		InputIndicatorFocus = Color3.fromRGB(136, 192, 208),
		Dialog = Color3.fromRGB(52, 58, 70),
		DialogHolder = Color3.fromRGB(42, 48, 60),
		DialogHolderLine = Color3.fromRGB(62, 68, 82),
		DialogButton = Color3.fromRGB(56, 62, 74),
		DialogButtonBorder = Color3.fromRGB(76, 86, 106),
		DialogBorder = Color3.fromRGB(67, 76, 94),
		DialogInput = Color3.fromRGB(60, 68, 82),
		DialogInputLine = Color3.fromRGB(129, 161, 193),
		Text = Color3.fromRGB(236, 239, 244),
		SubText = Color3.fromRGB(180, 192, 210),
		Hover = Color3.fromRGB(97, 110, 135),
		HoverChange = 0.04
	},
	...
	Catppuccin = {
		...
		AcrylicBorder = Color3.fromRGB(88, 91, 112),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(24, 24, 37), Color3.fromRGB(30, 30, 46)),
		AcrylicNoise = 0.94,
		TitleBarLine = Color3.fromRGB(54, 54, 72),
		Tab = Color3.fromRGB(110, 115, 145),
		Element = Color3.fromRGB(54, 55, 75),
		ElementBorder = Color3.fromRGB(35, 35, 52),
		InElementBorder = Color3.fromRGB(70, 72, 96),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(203, 166, 247),
		ToggleToggled = Color3.fromRGB(22, 22, 34),
		SliderRail = Color3.fromRGB(165, 130, 210),
		DropdownFrame = Color3.fromRGB(130, 130, 170),
		DropdownHolder = Color3.fromRGB(36, 36, 55),
		DropdownBorder = Color3.fromRGB(54, 54, 72),
		DropdownOption = Color3.fromRGB(110, 112, 145),
		Keybind = Color3.fromRGB(110, 112, 145),
		Input = Color3.fromRGB(75, 78, 105),
		InputFocused = Color3.fromRGB(18, 18, 28),
		InputIndicator = Color3.fromRGB(150, 120, 200),
		InputIndicatorFocus = Color3.fromRGB(203, 166, 247),
		Dialog = Color3.fromRGB(36, 36, 54),
		DialogHolder = Color3.fromRGB(28, 28, 44),
		DialogHolderLine = Color3.fromRGB(50, 52, 70),
		DialogButton = Color3.fromRGB(40, 40, 60),
		DialogButtonBorder = Color3.fromRGB(80, 82, 110),
		DialogBorder = Color3.fromRGB(65, 67, 90),
		DialogInput = Color3.fromRGB(46, 47, 68),
		DialogInputLine = Color3.fromRGB(160, 130, 215),
		Text = Color3.fromRGB(205, 214, 244),
		SubText = Color3.fromRGB(157, 164, 198),
		Hover = Color3.fromRGB(108, 111, 145),
		HoverChange = 0.04
	},
	...
	TokyoNight = {
		...
		AcrylicBorder = Color3.fromRGB(52, 59, 88),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 22, 32), Color3.fromRGB(26, 27, 38)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(40, 45, 68),
		Tab = Color3.fromRGB(85, 100, 150),
		Element = Color3.fromRGB(50, 56, 82),
		ElementBorder = Color3.fromRGB(30, 33, 50),
		InElementBorder = Color3.fromRGB(60, 68, 98),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(122, 162, 247),
		ToggleToggled = Color3.fromRGB(18, 18, 28),
		SliderRail = Color3.fromRGB(90, 130, 210),
		DropdownFrame = Color3.fromRGB(100, 125, 185),
		DropdownHolder = Color3.fromRGB(30, 33, 50),
		DropdownBorder = Color3.fromRGB(45, 50, 75),
		DropdownOption = Color3.fromRGB(85, 107, 158),
		Keybind = Color3.fromRGB(85, 107, 158),
		Input = Color3.fromRGB(60, 70, 105),
		InputFocused = Color3.fromRGB(15, 16, 24),
		InputIndicator = Color3.fromRGB(105, 140, 220),
		InputIndicatorFocus = Color3.fromRGB(122, 162, 247),
		Dialog = Color3.fromRGB(32, 34, 50),
		DialogHolder = Color3.fromRGB(24, 26, 40),
		DialogHolderLine = Color3.fromRGB(45, 50, 75),
		DialogButton = Color3.fromRGB(36, 38, 55),
		DialogButtonBorder = Color3.fromRGB(60, 70, 105),
		DialogBorder = Color3.fromRGB(50, 57, 88),
		DialogInput = Color3.fromRGB(40, 44, 65),
		DialogInputLine = Color3.fromRGB(100, 140, 215),
		Text = Color3.fromRGB(192, 202, 245),
		SubText = Color3.fromRGB(135, 148, 185),
		Hover = Color3.fromRGB(82, 100, 150),
		HoverChange = 0.04
	},
	...
	Monokai = {
		...
		AcrylicBorder = Color3.fromRGB(73, 72, 62),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 31, 26), Color3.fromRGB(39, 40, 34)),
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(60, 60, 52),
		Tab = Color3.fromRGB(117, 113, 94),
		Element = Color3.fromRGB(68, 68, 58),
		ElementBorder = Color3.fromRGB(39, 40, 34),
		InElementBorder = Color3.fromRGB(78, 78, 66),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(166, 226, 46),
		ToggleToggled = Color3.fromRGB(25, 26, 22),
		SliderRail = Color3.fromRGB(130, 180, 35),
		DropdownFrame = Color3.fromRGB(135, 130, 108),
		DropdownHolder = Color3.fromRGB(42, 43, 36),
		DropdownBorder = Color3.fromRGB(58, 58, 50),
		DropdownOption = Color3.fromRGB(117, 113, 94),
		Keybind = Color3.fromRGB(117, 113, 94),
		Input = Color3.fromRGB(80, 80, 68),
		InputFocused = Color3.fromRGB(22, 22, 18),
		InputIndicator = Color3.fromRGB(130, 180, 40),
		InputIndicatorFocus = Color3.fromRGB(166, 226, 46),
		Dialog = Color3.fromRGB(44, 44, 38),
		DialogHolder = Color3.fromRGB(35, 36, 30),
		DialogHolderLine = Color3.fromRGB(55, 55, 47),
		DialogButton = Color3.fromRGB(48, 48, 42),
		DialogButtonBorder = Color3.fromRGB(73, 73, 62),
		DialogBorder = Color3.fromRGB(60, 60, 52),
		DialogInput = Color3.fromRGB(52, 52, 45),
		DialogInputLine = Color3.fromRGB(130, 180, 40),
		Text = Color3.fromRGB(248, 248, 242),
		SubText = Color3.fromRGB(180, 180, 165),
		Hover = Color3.fromRGB(117, 113, 94),
		HoverChange = 0.04
	},
	...
	Solarized = {
		...
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 35, 44), Color3.fromRGB(0, 43, 54)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(7, 65, 80),
		Tab = Color3.fromRGB(88, 110, 117),
		Element = Color3.fromRGB(7, 54, 66),
		ElementBorder = Color3.fromRGB(0, 43, 54),
		InElementBorder = Color3.fromRGB(20, 68, 82),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(38, 139, 210),
		ToggleToggled = Color3.fromRGB(0, 28, 36),
		SliderRail = Color3.fromRGB(30, 110, 165),
		DropdownFrame = Color3.fromRGB(100, 130, 140),
		DropdownHolder = Color3.fromRGB(5, 48, 60),
		DropdownBorder = Color3.fromRGB(7, 54, 66),
		DropdownOption = Color3.fromRGB(88, 110, 117),
		Keybind = Color3.fromRGB(88, 110, 117),
		Input = Color3.fromRGB(20, 72, 88),
		InputFocused = Color3.fromRGB(0, 25, 32),
		InputIndicator = Color3.fromRGB(50, 140, 190),
		InputIndicatorFocus = Color3.fromRGB(38, 139, 210),
		Dialog = Color3.fromRGB(5, 48, 60),
		DialogHolder = Color3.fromRGB(0, 40, 52),
		DialogHolderLine = Color3.fromRGB(10, 60, 74),
		DialogButton = Color3.fromRGB(6, 52, 65),
		DialogButtonBorder = Color3.fromRGB(20, 72, 88),
		DialogBorder = Color3.fromRGB(15, 65, 80),
		DialogInput = Color3.fromRGB(8, 58, 72),
		DialogInputLine = Color3.fromRGB(50, 135, 185),
		Text = Color3.fromRGB(131, 148, 150),
		SubText = Color3.fromRGB(88, 110, 117),
		Hover = Color3.fromRGB(88, 110, 117),
		HoverChange = 0.04
	},
	...
	GruvBox = {
		...
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(60, 56, 54),
		Tab = Color3.fromRGB(146, 131, 116),
		Element = Color3.fromRGB(60, 56, 54),
		ElementBorder = Color3.fromRGB(40, 40, 40),
		InElementBorder = Color3.fromRGB(72, 68, 65),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(250, 189, 47),
		ToggleToggled = Color3.fromRGB(25, 25, 25),
		SliderRail = Color3.fromRGB(200, 150, 35),
		DropdownFrame = Color3.fromRGB(160, 145, 130),
		DropdownHolder = Color3.fromRGB(45, 43, 41),
		DropdownBorder = Color3.fromRGB(60, 56, 54),
		DropdownOption = Color3.fromRGB(146, 131, 116),
		Keybind = Color3.fromRGB(146, 131, 116),
		Input = Color3.fromRGB(72, 68, 65),
		InputFocused = Color3.fromRGB(22, 21, 20),
		InputIndicator = Color3.fromRGB(195, 150, 35),
		InputIndicatorFocus = Color3.fromRGB(250, 189, 47),
		Dialog = Color3.fromRGB(50, 48, 46),
		DialogHolder = Color3.fromRGB(40, 38, 36),
		DialogHolderLine = Color3.fromRGB(60, 57, 55),
		DialogButton = Color3.fromRGB(54, 52, 50),
		DialogButtonBorder = Color3.fromRGB(80, 75, 72),
		DialogBorder = Color3.fromRGB(68, 64, 62),
		DialogInput = Color3.fromRGB(58, 56, 53),
		DialogInputLine = Color3.fromRGB(195, 150, 40),
		Text = Color3.fromRGB(235, 219, 178),
		SubText = Color3.fromRGB(168, 153, 132),
		Hover = Color3.fromRGB(146, 131, 116),
		HoverChange = 0.04
	},
	...
	OneDark = {
		...
		AcrylicBorder = Color3.fromRGB(57, 63, 74),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 34, 42), Color3.fromRGB(40, 44, 52)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(52, 58, 68),
		Tab = Color3.fromRGB(100, 110, 130),
		Element = Color3.fromRGB(55, 60, 70),
		ElementBorder = Color3.fromRGB(35, 39, 48),
		InElementBorder = Color3.fromRGB(65, 72, 85),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(97, 175, 239),
		ToggleToggled = Color3.fromRGB(25, 28, 35),
		SliderRail = Color3.fromRGB(75, 140, 195),
		DropdownFrame = Color3.fromRGB(120, 135, 160),
		DropdownHolder = Color3.fromRGB(44, 48, 58),
		DropdownBorder = Color3.fromRGB(52, 58, 68),
		DropdownOption = Color3.fromRGB(100, 110, 130),
		Keybind = Color3.fromRGB(100, 110, 130),
		Input = Color3.fromRGB(68, 74, 88),
		InputFocused = Color3.fromRGB(20, 22, 28),
		InputIndicator = Color3.fromRGB(90, 155, 210),
		InputIndicatorFocus = Color3.fromRGB(97, 175, 239),
		Dialog = Color3.fromRGB(46, 50, 60),
		DialogHolder = Color3.fromRGB(36, 40, 50),
		DialogHolderLine = Color3.fromRGB(55, 62, 74),
		DialogButton = Color3.fromRGB(50, 55, 65),
		DialogButtonBorder = Color3.fromRGB(70, 78, 92),
		DialogBorder = Color3.fromRGB(60, 68, 80),
		DialogInput = Color3.fromRGB(54, 60, 72),
		DialogInputLine = Color3.fromRGB(88, 150, 205),
		Text = Color3.fromRGB(171, 178, 191),
		SubText = Color3.fromRGB(130, 140, 158),
		Hover = Color3.fromRGB(100, 110, 130),
		HoverChange = 0.04
	},
	...
	PastelDream = {
		...
		AcrylicBorder = Color3.fromRGB(240, 210, 235),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 248, 255), Color3.fromRGB(250, 240, 252)),
		AcrylicNoise = 0.96,
		TitleBarLine = Color3.fromRGB(235, 200, 225),
		Tab = Color3.fromRGB(210, 175, 210),
		Element = Color3.fromRGB(245, 220, 242),
		ElementBorder = Color3.fromRGB(220, 190, 220),
		InElementBorder = Color3.fromRGB(235, 208, 235),
		ElementTransparency = 0.72,
		ToggleSlider = Color3.fromRGB(255, 160, 200),
		ToggleToggled = Color3.fromRGB(250, 240, 250),
		SliderRail = Color3.fromRGB(240, 180, 220),
		DropdownFrame = Color3.fromRGB(240, 205, 235),
		DropdownHolder = Color3.fromRGB(252, 242, 252),
		DropdownBorder = Color3.fromRGB(225, 195, 225),
		DropdownOption = Color3.fromRGB(218, 185, 218),
		Keybind = Color3.fromRGB(218, 185, 218),
		Input = Color3.fromRGB(238, 212, 238),
		InputFocused = Color3.fromRGB(200, 170, 200),
		InputIndicator = Color3.fromRGB(245, 190, 225),
		InputIndicatorFocus = Color3.fromRGB(255, 160, 200),
		Dialog = Color3.fromRGB(255, 247, 255),
		DialogHolder = Color3.fromRGB(252, 242, 252),
		DialogHolderLine = Color3.fromRGB(238, 218, 238),
		DialogButton = Color3.fromRGB(255, 248, 255),
		DialogButtonBorder = Color3.fromRGB(228, 200, 228),
		DialogBorder = Color3.fromRGB(220, 192, 220),
		DialogInput = Color3.fromRGB(248, 238, 248),
		DialogInputLine = Color3.fromRGB(240, 185, 225),
		Text = Color3.fromRGB(80, 50, 80),
		SubText = Color3.fromRGB(160, 120, 155),
		Hover = Color3.fromRGB(235, 205, 235),
		HoverChange = 0.06
	},
	...
	CherryBlossom = {
		...
		AcrylicBorder = Color3.fromRGB(180, 80, 100),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(55, 20, 30), Color3.fromRGB(45, 25, 35)),
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(180, 90, 110),
		Tab = Color3.fromRGB(220, 130, 155),
		Element = Color3.fromRGB(185, 90, 115),
		ElementBorder = Color3.fromRGB(85, 40, 55),
		InElementBorder = Color3.fromRGB(160, 75, 98),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(255, 150, 170),
		ToggleToggled = Color3.fromRGB(35, 15, 22),
		SliderRail = Color3.fromRGB(225, 120, 145),
		DropdownFrame = Color3.fromRGB(230, 155, 175),
		DropdownHolder = Color3.fromRGB(60, 28, 38),
		DropdownBorder = Color3.fromRGB(130, 55, 75),
		DropdownOption = Color3.fromRGB(210, 125, 148),
		Keybind = Color3.fromRGB(210, 125, 148),
		Input = Color3.fromRGB(195, 100, 125),
		InputFocused = Color3.fromRGB(30, 12, 18),
		InputIndicator = Color3.fromRGB(240, 155, 175),
		InputIndicatorFocus = Color3.fromRGB(255, 100, 130),
		Dialog = Color3.fromRGB(65, 28, 40),
		DialogHolder = Color3.fromRGB(52, 22, 32),
		DialogHolderLine = Color3.fromRGB(90, 40, 55),
		DialogButton = Color3.fromRGB(72, 32, 45),
		DialogButtonBorder = Color3.fromRGB(160, 72, 95),
		DialogBorder = Color3.fromRGB(130, 58, 78),
		DialogInput = Color3.fromRGB(80, 38, 52),
		DialogInputLine = Color3.fromRGB(225, 135, 158),
		Text = Color3.fromRGB(255, 230, 235),
		SubText = Color3.fromRGB(210, 170, 180),
		Hover = Color3.fromRGB(200, 115, 138),
		HoverChange = 0.05
	},
	...
	DeepSpace = {
		...
		AcrylicMain = Color3.fromRGB(5, 2, 20),
		AcrylicBorder = Color3.fromRGB(60, 30, 120),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(8, 3, 25), Color3.fromRGB(5, 2, 15)),
		AcrylicNoise = 0.97,
		TitleBarLine = Color3.fromRGB(50, 25, 100),
		Tab = Color3.fromRGB(80, 50, 160),
		Element = Color3.fromRGB(50, 25, 100),
		ElementBorder = Color3.fromRGB(25, 10, 55),
		InElementBorder = Color3.fromRGB(70, 40, 140),
		ElementTransparency = 0.88,
		ToggleSlider = Color3.fromRGB(120, 80, 255),
		ToggleToggled = Color3.fromRGB(5, 2, 15),
		SliderRail = Color3.fromRGB(90, 60, 200),
		DropdownFrame = Color3.fromRGB(100, 65, 200),
		DropdownHolder = Color3.fromRGB(8, 5, 28),
		DropdownBorder = Color3.fromRGB(40, 20, 80),
		DropdownOption = Color3.fromRGB(80, 50, 160),
		Keybind = Color3.fromRGB(80, 50, 160),
		Input = Color3.fromRGB(55, 30, 110),
		InputFocused = Color3.fromRGB(3, 1, 10),
		InputIndicator = Color3.fromRGB(105, 70, 225),
		InputIndicatorFocus = Color3.fromRGB(120, 80, 255),
		Dialog = Color3.fromRGB(10, 5, 30),
		DialogHolder = Color3.fromRGB(8, 3, 22),
		DialogHolderLine = Color3.fromRGB(45, 22, 92),
		DialogButton = Color3.fromRGB(12, 6, 35),
		DialogButtonBorder = Color3.fromRGB(65, 35, 130),
		DialogBorder = Color3.fromRGB(50, 26, 105),
		DialogInput = Color3.fromRGB(14, 8, 40),
		DialogInputLine = Color3.fromRGB(100, 65, 210),
		Text = Color3.fromRGB(200, 190, 255),
		SubText = Color3.fromRGB(140, 120, 200),
		Hover = Color3.fromRGB(80, 50, 160),
		HoverChange = 0.04
	},

	GoldenHour = {
		Name = "GoldenHour",
		Accent = Color3.fromRGB(255, 195, 50),
		AcrylicMain = Color3.fromRGB(35, 20, 10),
		AcrylicBorder = Color3.fromRGB(180, 120, 40),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 22, 8), Color3.fromRGB(30, 17, 6)),
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(160, 100, 30),
		Tab = Color3.fromRGB(200, 145, 60),
		Element = Color3.fromRGB(160, 105, 35),
		ElementBorder = Color3.fromRGB(75, 45, 12),
		InElementBorder = Color3.fromRGB(140, 88, 28),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(255, 215, 80),
		ToggleToggled = Color3.fromRGB(22, 12, 4),
		SliderRail = Color3.fromRGB(220, 170, 50),
		DropdownFrame = Color3.fromRGB(215, 165, 70),
		DropdownHolder = Color3.fromRGB(42, 24, 8),
		DropdownBorder = Color3.fromRGB(130, 80, 22),
		DropdownOption = Color3.fromRGB(195, 140, 55),
		Keybind = Color3.fromRGB(195, 140, 55),
		Input = Color3.fromRGB(168, 112, 38),
		InputFocused = Color3.fromRGB(18, 10, 3),
		InputIndicator = Color3.fromRGB(230, 180, 65),
		InputIndicatorFocus = Color3.fromRGB(255, 195, 50),
		Dialog = Color3.fromRGB(45, 26, 9),
		DialogHolder = Color3.fromRGB(36, 20, 7),
		DialogHolderLine = Color3.fromRGB(105, 65, 18),
		DialogButton = Color3.fromRGB(50, 30, 10),
		DialogButtonBorder = Color3.fromRGB(155, 100, 28),
		DialogBorder = Color3.fromRGB(125, 80, 22),
		DialogInput = Color3.fromRGB(55, 34, 12),
		DialogInputLine = Color3.fromRGB(220, 172, 58),
		Text = Color3.fromRGB(255, 238, 200),
		SubText = Color3.fromRGB(210, 178, 125),
		Hover = Color3.fromRGB(190, 138, 52),
		HoverChange = 0.05
	},
	...
	Mint = {
		...
		AcrylicMain = Color3.fromRGB(240, 255, 250),
		AcrylicBorder = Color3.fromRGB(160, 230, 200),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(245, 255, 252), Color3.fromRGB(238, 252, 246)),
		AcrylicNoise = 0.96,
		TitleBarLine = Color3.fromRGB(150, 220, 190),
		Tab = Color3.fromRGB(90, 185, 145),
		Element = Color3.fromRGB(195, 242, 222),
		ElementBorder = Color3.fromRGB(155, 225, 195),
		InElementBorder = Color3.fromRGB(175, 235, 210),
		ElementTransparency = 0.72,
		ToggleSlider = Color3.fromRGB(60, 220, 150),
		ToggleToggled = Color3.fromRGB(230, 252, 244),
		SliderRail = Color3.fromRGB(90, 210, 160),
		DropdownFrame = Color3.fromRGB(180, 238, 218),
		DropdownHolder = Color3.fromRGB(238, 252, 246),
		DropdownBorder = Color3.fromRGB(155, 228, 200),
		DropdownOption = Color3.fromRGB(110, 200, 165),
		Keybind = Color3.fromRGB(110, 200, 165),
		Input = Color3.fromRGB(180, 238, 216),
		InputFocused = Color3.fromRGB(120, 190, 158),
		InputIndicator = Color3.fromRGB(95, 220, 165),
		InputIndicatorFocus = Color3.fromRGB(60, 220, 150),
		Dialog = Color3.fromRGB(245, 254, 252),
		DialogHolder = Color3.fromRGB(238, 252, 246),
		DialogHolderLine = Color3.fromRGB(210, 245, 230),
		DialogButton = Color3.fromRGB(248, 255, 253),
		DialogButtonBorder = Color3.fromRGB(168, 232, 208),
		DialogBorder = Color3.fromRGB(155, 226, 200),
		DialogInput = Color3.fromRGB(232, 252, 244),
		DialogInputLine = Color3.fromRGB(90, 210, 162),
		Text = Color3.fromRGB(20, 70, 50),
		SubText = Color3.fromRGB(60, 140, 105),
		Hover = Color3.fromRGB(180, 238, 218),
		HoverChange = 0.07
	},
	...
	Infrared = {
		...
		AcrylicMain = Color3.fromRGB(20, 5, 0),
		AcrylicBorder = Color3.fromRGB(180, 60, 0),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(25, 6, 0), Color3.fromRGB(18, 4, 0)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(160, 55, 0),
		Tab = Color3.fromRGB(200, 90, 10),
		Element = Color3.fromRGB(160, 60, 5),
		ElementBorder = Color3.fromRGB(70, 22, 0),
		InElementBorder = Color3.fromRGB(145, 55, 5),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(255, 115, 30),
		ToggleToggled = Color3.fromRGB(14, 3, 0),
		SliderRail = Color3.fromRGB(220, 85, 10),
		DropdownFrame = Color3.fromRGB(210, 105, 25),
		DropdownHolder = Color3.fromRGB(24, 7, 0),
		DropdownBorder = Color3.fromRGB(130, 45, 0),
		DropdownOption = Color3.fromRGB(195, 80, 10),
		Keybind = Color3.fromRGB(195, 80, 10),
		Input = Color3.fromRGB(168, 64, 8),
		InputFocused = Color3.fromRGB(10, 2, 0),
		InputIndicator = Color3.fromRGB(230, 100, 20),
		InputIndicatorFocus = Color3.fromRGB(255, 85, 0),
		Dialog = Color3.fromRGB(28, 9, 0),
		DialogHolder = Color3.fromRGB(22, 6, 0),
		DialogHolderLine = Color3.fromRGB(105, 38, 0),
		DialogButton = Color3.fromRGB(32, 10, 0),
		DialogButtonBorder = Color3.fromRGB(155, 55, 5),
		DialogBorder = Color3.fromRGB(120, 42, 0),
		DialogInput = Color3.fromRGB(36, 12, 0),
		DialogInputLine = Color3.fromRGB(220, 90, 15),
		Text = Color3.fromRGB(255, 225, 210),
		SubText = Color3.fromRGB(210, 165, 140),
		Hover = Color3.fromRGB(190, 78, 10),
		HoverChange = 0.05
	},
	...
	SlateStorm = {
		...
		AcrylicMain = Color3.fromRGB(22, 25, 32),
		AcrylicBorder = Color3.fromRGB(50, 60, 80),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(18, 20, 28), Color3.fromRGB(22, 25, 32)),
		AcrylicNoise = 0.94,
		TitleBarLine = Color3.fromRGB(40, 48, 65),
		Tab = Color3.fromRGB(80, 95, 128),
		Element = Color3.fromRGB(48, 55, 72),
		ElementBorder = Color3.fromRGB(28, 33, 44),
		InElementBorder = Color3.fromRGB(60, 70, 92),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(100, 160, 255),
		ToggleToggled = Color3.fromRGB(14, 16, 22),
		SliderRail = Color3.fromRGB(70, 130, 220),
		DropdownFrame = Color3.fromRGB(90, 115, 160),
		DropdownHolder = Color3.fromRGB(26, 30, 40),
		DropdownBorder = Color3.fromRGB(44, 52, 70),
		DropdownOption = Color3.fromRGB(78, 95, 128),
		Keybind = Color3.fromRGB(78, 95, 128),
		Input = Color3.fromRGB(56, 66, 88),
		InputFocused = Color3.fromRGB(12, 14, 20),
		InputIndicator = Color3.fromRGB(85, 140, 230),
		InputIndicatorFocus = Color3.fromRGB(100, 160, 255),
		Dialog = Color3.fromRGB(28, 32, 44),
		DialogHolder = Color3.fromRGB(22, 26, 36),
		DialogHolderLine = Color3.fromRGB(40, 48, 65),
		DialogButton = Color3.fromRGB(32, 36, 50),
		DialogButtonBorder = Color3.fromRGB(58, 70, 94),
		DialogBorder = Color3.fromRGB(48, 58, 78),
		DialogInput = Color3.fromRGB(36, 42, 58),
		DialogInputLine = Color3.fromRGB(80, 135, 225),
		Text = Color3.fromRGB(200, 210, 230),
		SubText = Color3.fromRGB(130, 148, 178),
		Hover = Color3.fromRGB(76, 95, 128),
		HoverChange = 0.04
	},
	...
	Candy = {
		...
		AcrylicMain = Color3.fromRGB(255, 240, 255),
		AcrylicBorder = Color3.fromRGB(255, 180, 235),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 245, 255), Color3.fromRGB(252, 238, 252)),
		AcrylicNoise = 0.96,
		TitleBarLine = Color3.fromRGB(240, 195, 235),
		Tab = Color3.fromRGB(220, 120, 190),
		Element = Color3.fromRGB(248, 210, 245),
		ElementBorder = Color3.fromRGB(230, 175, 228),
		InElementBorder = Color3.fromRGB(240, 195, 240),
		ElementTransparency = 0.72,
		ToggleSlider = Color3.fromRGB(255, 80, 180),
		ToggleToggled = Color3.fromRGB(252, 240, 252),
		SliderRail = Color3.fromRGB(245, 140, 215),
		DropdownFrame = Color3.fromRGB(245, 195, 240),
		DropdownHolder = Color3.fromRGB(252, 242, 252),
		DropdownBorder = Color3.fromRGB(232, 182, 230),
		DropdownOption = Color3.fromRGB(228, 155, 218),
		Keybind = Color3.fromRGB(228, 155, 218),
		Input = Color3.fromRGB(245, 198, 242),
		InputFocused = Color3.fromRGB(210, 160, 210),
		InputIndicator = Color3.fromRGB(255, 150, 225),
		InputIndicatorFocus = Color3.fromRGB(255, 80, 180),
		Dialog = Color3.fromRGB(255, 246, 255),
		DialogHolder = Color3.fromRGB(252, 242, 252),
		DialogHolderLine = Color3.fromRGB(242, 218, 242),
		DialogButton = Color3.fromRGB(255, 248, 255),
		DialogButtonBorder = Color3.fromRGB(235, 188, 234),
		DialogBorder = Color3.fromRGB(228, 178, 228),
		DialogInput = Color3.fromRGB(250, 238, 250),
		DialogInputLine = Color3.fromRGB(245, 145, 220),
		Text = Color3.fromRGB(90, 30, 80),
		SubText = Color3.fromRGB(180, 100, 165),
		Hover = Color3.fromRGB(240, 195, 238),
		HoverChange = 0.06
	},
...
Components.TitleBar = (function()
	...
	return function(Config)
		...
		TitleBar.CloseButton = BarButton(Components.Assets.Close, UDim2.new(1, -4, 0, 5), TitleBar.Frame, function()
		...
		TitleBar.MaxButton = BarButton(Components.Assets.Max, UDim2.new(1, -40, 0, 5), TitleBar.Frame, function()
			Config.Window.Maximize(not Config.Window.Maximized)
		end)
		TitleBar.MinButton = BarButton(Components.Assets.Min, UDim2.new(1, -80, 0, 5), TitleBar.Frame, function()
...
-- FEATURE 1: Rainbow / Animated Accent Color Mode
Library.RainbowMode = false
Library.RainbowHue = 0
function Library:EnableRainbowAccent(speed)
	speed = speed or 0.5
	Library.RainbowMode = true
	task.spawn(function()
		while Library.RainbowMode and not Library.Unloaded do
			Library.RainbowHue = (Library.RainbowHue + speed / 60) % 1
			local color = Color3.fromHSV(Library.RainbowHue, 1, 1)
...
function Library:DisableRainbowAccent()
	Library.RainbowMode = false
end

-- FEATURE 2: Custom Accent Color
function Library:SetAccentColor(color)
	if typeof(color) == "Color3" and Themes[Library.Theme] then
		Library.RainbowMode = false
		Themes[Library.Theme].Accent = color
		Creator.UpdateTheme()
	end
...
-- FEATURE 3: Window Shake / Alert Animation
function Library:ShakeWindow(intensity, duration)
	intensity = intensity or 6
	duration = duration or 0.4
	if not Library.Window or not Library.Window.Root then return end
	local originalPos = Library.Window.Root.Position
	local elapsed = 0
	local conn
	conn = RunService.RenderStepped:Connect(function(dt)
		elapsed = elapsed + dt
		if elapsed >= duration then
			Library.Window.Root.Position = originalPos
			conn:Disconnect()
			return
		end
		local t = elapsed / duration
		local shake = intensity * (1 - t)
		local offsetX = (math.random() * 2 - 1) * shake
		local offsetY = (math.random() * 2 - 1) * shake
...
-- FEATURE 4: Toast / Badge Notification (small, auto-dismiss)
function Library:Toast(message, duration, color)
	duration = duration or 2.5
	color = color or Color3.fromRGB(60, 200, 120)
...
-- FEATURE 5: Typing Sound Effect on UI interactions
Library.ClickSoundEnabled = false
Library.ClickSoundId = "rbxassetid://6895079853"
function Library:EnableClickSound(soundId)
	Library.ClickSoundEnabled = true
	if soundId then Library.ClickSoundId = soundId end
end
function Library:DisableClickSound()
	Library.ClickSoundEnabled = false
end
function Library:PlayClickSound()
	if not Library.ClickSoundEnabled then return end
	pcall(function()
		local s = Instance.new("Sound")
		s.SoundId = Library.ClickSoundId
		s.Volume = 0.4
		s.RollOffMaxDistance = 1
		s.Parent = GUI
		s:Play()
...
-- FEATURE 6: Blur Background when window open
Library.BackgroundBlurEnabled = false
Library.BackgroundBlurEffect = nil
function Library:EnableBackgroundBlur(size)
	size = size or 10
	if Library.BackgroundBlurEnabled then return end
	Library.BackgroundBlurEnabled = true
	local blur = Instance.new("BlurEffect")
	blur.Size = size
	blur.Parent = game:GetService("Lighting")
	Library.BackgroundBlurEffect = blur
end
function Library:DisableBackgroundBlur()
	Library.BackgroundBlurEnabled = false
...
-- FEATURE 7: Set Window Opacity
function Library:SetWindowOpacity(opacity)
	opacity = math.clamp(opacity or 0.9, 0, 1)
	if Library.Window and Library.Window.Root then
		Library.Window.Root.BackgroundTransparency = 1 - opacity
	end
end

-- FEATURE 8: Show/Hide Window with animation
function Library:Show(animTime)
	animTime = animTime or 0.35
	if Library.Window and Library.Window.Root then
		Library.Window.Root.Visible = true
		Library.Window.Minimized = false
		TweenService:Create(Library.Window.Root, TweenInfo.new(animTime, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
			Size = Library.Window.Size,
		}):Play()
	end
end
function Library:Hide(animTime)
	animTime = animTime or 0.25
	if Library.Window and Library.Window.Root then
		Library.Window.Minimized = true
		TweenService:Create(Library.Window.Root, TweenInfo.new(animTime, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
			Size = UDim2.fromOffset(Library.Window.Size.X.Offset, 0),
		}):Play()
...
-- FEATURE 9: Get Theme List
function Library:GetThemes()
	return Library.Themes
end

-- FEATURE 10: Cycle through themes
Library._themeIndex = 1
function Library:NextTheme()
	Library._themeIndex = (Library._themeIndex % #Library.Themes) + 1
	local theme = Library.Themes[Library._themeIndex]
	Library:SetTheme(theme)
	Library:Toast("Theme: " .. theme, 1.5, Creator.GetThemeProperty("Accent"))
	return theme
end
function Library:PreviousTheme()
	Library._themeIndex = ((Library._themeIndex - 2) % #Library.Themes) + 1
	local theme = Library.Themes[Library._themeIndex]
	Library:SetTheme(theme)
	Library:Toast("Theme: " .. theme, 1.5, Creator.GetThemeProperty("Accent"))
	return theme
...
-- FEATURE 11: Screenshot / Watermark overlay
Library.WatermarkEnabled = false
Library.WatermarkLabel = nil
function Library:SetWatermark(text, position)
	text = text or "Bata v2.0"
	if Library.WatermarkLabel then Library.WatermarkLabel:Destroy() end
	local pos = position or UDim2.new(0, 10, 0, 10)
	Library.WatermarkEnabled = true
	Library.WatermarkLabel = New("TextLabel", {
		Text = text,
		TextColor3 = Color3.fromRGB(255, 255, 255),
		TextSize = 14,
...
function Library:RemoveWatermark()
	Library.WatermarkEnabled = false
	if Library.WatermarkLabel then
		Library.WatermarkLabel:Destroy()
		Library.WatermarkLabel = nil
	end
end

-- FEATURE 12: FPS Counter display
Library.FPSCounterEnabled = false
Library.FPSLabel = nil
function Library:ShowFPSCounter(position)
	if Library.FPSCounterEnabled then return end
	Library.FPSCounterEnabled = true
	local pos = position or UDim2.new(1, -80, 0, 10)
	Library.FPSLabel = New("TextLabel", {
		Text = "FPS: --",
	...
	task.spawn(function()
		...
		conn = RunService.RenderStepped:Connect(function()
			if not Library.FPSCounterEnabled then conn:Disconnect() return end
			frames = frames + 1
			local now = tick()
			if now - lastTime >= 0.5 then
				local fps = math.floor(frames / (now - lastTime))
				if Library.FPSLabel and Library.FPSLabel.Parent then
					Library.FPSLabel.Text = "FPS: " .. fps
					Library.FPSLabel.TextColor3 = fps >= 50 and Color3.fromRGB(100, 255, 120) or fps >= 30 and Color3.fromRGB(255, 200, 50) or Color3.fromRGB(255, 80, 80)
				else
					conn:Disconnect()
				end
				frames = 0
...
function Library:HideFPSCounter()
	Library.FPSCounterEnabled = false
	if Library.FPSLabel then
		Library.FPSLabel:Destroy()
		Library.FPSLabel = nil
	end
end

-- FEATURE 13: Tab Badge / Indicator (dot badge on tab)
function Library:SetTabBadge(tab, count, color)
	if not tab or not tab.Frame then return end
	local existingBadge = tab.Frame:FindFirstChild("_Badge")
	if existingBadge then existingBadge:Destroy() end
	if count and count > 0 then
		local badgeColor = color or Color3.fromRGB(255, 60, 60)
		local badge = New("Frame", {
			Name = "_Badge",
			Size = UDim2.fromOffset(count > 9 and 22 or 18, 18),
...
function Library:ClearTabBadge(tab)
	if not tab or not tab.Frame then return end
	local badge = tab.Frame:FindFirstChild("_Badge")
	if badge then badge:Destroy() end
end

-- FEATURE 14: Confirmation Dialog shortcut
...
-- FEATURE 15: Lock/Unlock Window (prevent dragging)
Library.WindowLocked = false
function Library:LockWindow()
	Library.WindowLocked = true
	if Library.Window and Library.Window.TitleBar then
		Library.Window.TitleBar.Frame.Active = false
	end
end
function Library:UnlockWindow()
	Library.WindowLocked = false
	if Library.Window and Library.Window.TitleBar then
		Library.Window.TitleBar.Frame.Active = true
	end
end

-- FEATURE 16: Smooth Window Position Tween
function Library:MoveTo(x, y, time)
	time = time or 0.5
	if Library.Window and Library.Window.Root then
		TweenService:Create(Library.Window.Root, TweenInfo.new(time, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
			Position = UDim2.fromOffset(x, y)
		}):Play()
		Library.Window.Position = UDim2.fromOffset(x, y)
	end
end

-- FEATURE 17: Resize Window Tween
function Library:ResizeTo(width, height, time)
	time = time or 0.5
	if Library.Window then
		Library.Window.Size = UDim2.fromOffset(width, height)
		Library.Window.Maximize(false, false, false)
	end
end

-- FEATURE 18: Quick Element Highlight (pulse glow)
function Library:HighlightElement(frame, color, duration)
	...
	TweenService:Create(highlight, TweenInfo.new(duration, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, 0), {
		BackgroundTransparency = 1,
	}):Play()
	task.delay(duration, function()
...
-- FEATURE 19: Search Keyboard Shortcut (CTRL+F)
Creator.AddSignal(UserInputService.InputBegan, function(Input, Processed)
	...
	if Input.KeyCode == Enum.KeyCode.F and UserInputService:IsKeyDown(Enum.KeyCode.LeftControl) then
		if Library.Window and Library.Window.ShowSearch == false then
			Library.Window:ToggleSearch()
		elseif Library.Window and Library.Window.AllElements then
			-- Focus search if already visible
			pcall(function()
				local searchInput = Library.Window.Root and Library.Window.Root:FindFirstChild("SearchFrame", true)
				if searchInput then
					local tb = searchInput:FindFirstChildOfClass("TextBox")
...
-- FEATURE 20: Theme Export / Import (to/from string)
function Library:ExportTheme(themeName)
...
function Library:ImportTheme(themeName, jsonStr)
	local ok, data = pcall(function() return game:GetService("HttpService"):JSONDecode(jsonStr) end)
	if not ok or type(data) ~= "table" then return false end
	local theme = {}
	for k, v in pairs(data) do
		if type(v) == "table" and #v == 3 then
			theme[k] = Color3.fromRGB(v[1]*255, v[2]*255, v[3]*255)
...
-- ===== REWORKED UI ENHANCEMENTS =====

-- Enhanced Element hover with ripple effect
...
Library.AddRippleEffect = AddRippleEffect

-- Pulsing Accent Indicator on selector bar
task.spawn(function()
	while not Library.Unloaded do
		task.wait(2)
		if Library.Window and Library.Window.Root and not Library.Window.Minimized then
			local selector = Library.Window.Root:FindFirstChild("Frame", true)
			-- subtle pulse handled via theme
		end
	end
end)
