...
local Themes = {
	...
	Arctic = {
        ...
        Cyberpunk = {
		Name = "Cyberpunk",
		Accent = Color3.fromRGB(255, 238, 88), 
		AcrylicMain = Color3.fromRGB(13, 2, 33), 
		AcrylicBorder = Color3.fromRGB(255, 0, 127), 
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(13, 2, 33), Color3.fromRGB(25, 5, 55)),
		AcrylicNoise = 0.9,
		TitleBarLine = Color3.fromRGB(255, 0, 127),
		Tab = Color3.fromRGB(45, 15, 75),
		Element = Color3.fromRGB(34, 10, 60),
		ElementBorder = Color3.fromRGB(255, 0, 127),
		InElementBorder = Color3.fromRGB(255, 0, 127),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(80, 25, 120),
		ToggleToggled = Color3.fromRGB(255, 238, 88),
		SliderRail = Color3.fromRGB(80, 25, 120),
		DropdownFrame = Color3.fromRGB(45, 15, 75),
		DropdownHolder = Color3.fromRGB(20, 5, 40),
		DropdownBorder = Color3.fromRGB(255, 0, 127),
		DropdownOption = Color3.fromRGB(60, 20, 90),
		Keybind = Color3.fromRGB(60, 20, 90),
		Input = Color3.fromRGB(45, 15, 75),
		InputFocused = Color3.fromRGB(20, 5, 40),
		InputIndicator = Color3.fromRGB(255, 0, 127),
		InputIndicatorFocus = Color3.fromRGB(255, 238, 88),
		Dialog = Color3.fromRGB(34, 10, 60),
		DialogHolder = Color3.fromRGB(20, 5, 40),
		DialogHolderLine = Color3.fromRGB(255, 0, 127),
		DialogButton = Color3.fromRGB(45, 15, 75),
		DialogButtonBorder = Color3.fromRGB(255, 0, 127),
		DialogBorder = Color3.fromRGB(255, 0, 127),
		DialogInput = Color3.fromRGB(20, 5, 40),
		DialogInputLine = Color3.fromRGB(255, 238, 88),
		Text = Color3.fromRGB(0, 255, 255), -- ตัวหนังสือฟ้า Cyan
		SubText = Color3.fromRGB(180, 180, 180),
		Hover = Color3.fromRGB(60, 20, 90),
		HoverChange = 0.05
	},
	Matcha = {
		Name = "Matcha",
		Accent = Color3.fromRGB(136, 171, 142), 
		AcrylicMain = Color3.fromRGB(242, 241, 235), 
		AcrylicBorder = Color3.fromRGB(175, 200, 173),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 255, 255), Color3.fromRGB(242, 241, 235)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(175, 200, 173),
		Tab = Color3.fromRGB(220, 225, 215),
		Element = Color3.fromRGB(255, 255, 255),
		ElementBorder = Color3.fromRGB(200, 210, 200),
		InElementBorder = Color3.fromRGB(175, 200, 173),
		ElementTransparency = 0.7,
		ToggleSlider = Color3.fromRGB(200, 210, 200),
		ToggleToggled = Color3.fromRGB(136, 171, 142),
		SliderRail = Color3.fromRGB(200, 210, 200),
		DropdownFrame = Color3.fromRGB(255, 255, 255),
		DropdownHolder = Color3.fromRGB(242, 241, 235),
		DropdownBorder = Color3.fromRGB(200, 210, 200),
		DropdownOption = Color3.fromRGB(220, 225, 215),
		Keybind = Color3.fromRGB(220, 225, 215),
		Input = Color3.fromRGB(255, 255, 255),
		InputFocused = Color3.fromRGB(242, 241, 235),
		InputIndicator = Color3.fromRGB(200, 210, 200),
		InputIndicatorFocus = Color3.fromRGB(136, 171, 142),
		Dialog = Color3.fromRGB(255, 255, 255),
		DialogHolder = Color3.fromRGB(242, 241, 235),
		DialogHolderLine = Color3.fromRGB(200, 210, 200),
		DialogButton = Color3.fromRGB(255, 255, 255),
		DialogButtonBorder = Color3.fromRGB(200, 210, 200),
		DialogBorder = Color3.fromRGB(175, 200, 173),
		DialogInput = Color3.fromRGB(242, 241, 235),
		DialogInputLine = Color3.fromRGB(136, 171, 142),
		Text = Color3.fromRGB(40, 40, 40),
		SubText = Color3.fromRGB(100, 110, 100),
		Hover = Color3.fromRGB(230, 235, 225),
		HoverChange = 0.08
	},
	Dracula = {
		Name = "Dracula",
		...
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 42, 54), Color3.fromRGB(30, 31, 40)),
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(68, 71, 90),
		Tab = Color3.fromRGB(68, 71, 90),
		Element = Color3.fromRGB(50, 52, 66),
		ElementBorder = Color3.fromRGB(68, 71, 90),
		InElementBorder = Color3.fromRGB(98, 114, 164),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(68, 71, 90),
		ToggleToggled = Color3.fromRGB(255, 85, 85),
		SliderRail = Color3.fromRGB(68, 71, 90),
		DropdownFrame = Color3.fromRGB(68, 71, 90),
		DropdownHolder = Color3.fromRGB(40, 42, 54),
		DropdownBorder = Color3.fromRGB(68, 71, 90),
		DropdownOption = Color3.fromRGB(50, 52, 66),
		Keybind = Color3.fromRGB(68, 71, 90),
		Input = Color3.fromRGB(50, 52, 66),
		InputFocused = Color3.fromRGB(30, 31, 40),
		InputIndicator = Color3.fromRGB(68, 71, 90),
		InputIndicatorFocus = Color3.fromRGB(255, 85, 85),
		Dialog = Color3.fromRGB(40, 42, 54),
		DialogHolder = Color3.fromRGB(30, 31, 40),
		DialogHolderLine = Color3.fromRGB(68, 71, 90),
		DialogButton = Color3.fromRGB(50, 52, 66),
		DialogButtonBorder = Color3.fromRGB(68, 71, 90),
		DialogBorder = Color3.fromRGB(98, 114, 164),
		DialogInput = Color3.fromRGB(30, 31, 40),
		DialogInputLine = Color3.fromRGB(255, 85, 85),
		Text = Color3.fromRGB(248, 248, 242),
		SubText = Color3.fromRGB(150, 150, 155),
		Hover = Color3.fromRGB(68, 71, 90),
		HoverChange = 0.05
	},
	Nebula = {
		Name = "Nebula",
		Accent = Color3.fromRGB(199, 125, 255), 
		AcrylicMain = Color3.fromRGB(15, 10, 40), 
		AcrylicBorder = Color3.fromRGB(50, 35, 90),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(15, 10, 40), Color3.fromRGB(5, 5, 20)),
		AcrylicNoise = 0.9,
		TitleBarLine = Color3.fromRGB(70, 40, 130),
		Tab = Color3.fromRGB(45, 30, 85),
		Element = Color3.fromRGB(35, 25, 70),
		ElementBorder = Color3.fromRGB(50, 35, 90),
		InElementBorder = Color3.fromRGB(100, 60, 180),
		ElementTransparency = 0.88,
		ToggleSlider = Color3.fromRGB(60, 40, 110),
		ToggleToggled = Color3.fromRGB(199, 125, 255),
		SliderRail = Color3.fromRGB(60, 40, 110),
		DropdownFrame = Color3.fromRGB(45, 30, 85),
		DropdownHolder = Color3.fromRGB(15, 10, 40),
		DropdownBorder = Color3.fromRGB(50, 35, 90),
		DropdownOption = Color3.fromRGB(45, 30, 85),
		Keybind = Color3.fromRGB(45, 30, 85),
		Input = Color3.fromRGB(45, 30, 85),
		InputFocused = Color3.fromRGB(10, 5, 25),
		InputIndicator = Color3.fromRGB(70, 40, 130),
		InputIndicatorFocus = Color3.fromRGB(199, 125, 255),
		Dialog = Color3.fromRGB(35, 25, 70),
		DialogHolder = Color3.fromRGB(15, 10, 40),
		DialogHolderLine = Color3.fromRGB(50, 35, 90),
		DialogButton = Color3.fromRGB(45, 30, 85),
		DialogButtonBorder = Color3.fromRGB(70, 40, 130),
		DialogBorder = Color3.fromRGB(100, 60, 180),
		DialogInput = Color3.fromRGB(15, 10, 40),
		DialogInputLine = Color3.fromRGB(199, 125, 255),
		Text = Color3.fromRGB(240, 240, 255),
		SubText = Color3.fromRGB(160, 150, 200),
		Hover = Color3.fromRGB(55, 40, 100),
		HoverChange = 0.04
	},
	Luxury = {
		Name = "Luxury",
		...
		AcrylicNoise = 0.98,
		TitleBarLine = Color3.fromRGB(212, 175, 55),
		Tab = Color3.fromRGB(35, 35, 35),
		Element = Color3.fromRGB(25, 25, 25),
		ElementBorder = Color3.fromRGB(45, 45, 45),
		InElementBorder = Color3.fromRGB(212, 175, 55),
		ElementTransparency = 0.95,
		ToggleSlider = Color3.fromRGB(50, 50, 50),
		ToggleToggled = Color3.fromRGB(212, 175, 55),
		...
		InputIndicator = Color3.fromRGB(70, 70, 70),
		...
		DialogBorder = Color3.fromRGB(212, 175, 55),
...
-- ====================================================================
-- 📊 GZUS MODIFICATIONS : LIVE SERVER STATS (FPS, PING, TIME)
-- ====================================================================

function Library:EnableLiveStats()
    local RunService = game:GetService("RunService")
    local Stats = game:GetService("Stats")
    local CoreGui = gethui and gethui() or game:GetService("CoreGui")
    
    -- หน่วงเวลา 1 วินาทีรอให้ UI ของ Fluent สร้างเสร็จก่อน
    task.delay(1, function()
        local mainFrame = nil
        
        -- ค้นหาหน้าต่างหลักของ Fluent แบบออโต้
        for _, gui in pairs(CoreGui:GetChildren()) do
            if gui:IsA("ScreenGui") then
                for _, child in pairs(gui:GetDescendants()) do
                    if child:IsA("Frame") and child.AbsoluteSize.X > 300 and child.AbsoluteSize.Y > 200 then
        ...
        if not mainFrame then return end -- ถ้าหาหน้าต่างไม่เจอให้ข้าม

        -- สร้าง TextLabel สำหรับแสดงข้อมูล
        local StatsLabel = Instance.new("TextLabel")
        StatsLabel.Name = "Gzus_LiveStats"
        StatsLabel.Size = UDim2.new(0, 300, 0, 20)
        StatsLabel.Position = UDim2.new(1, -315, 0, 12) -- วางมุมขวาบนของ UI
        StatsLabel.BackgroundTransparency = 1
        StatsLabel.Text = "FPS: ... | Ping: ... | 00:00"
        StatsLabel.TextColor3 = Color3.fromRGB(180, 180, 180) -- สีเทาอ่อนๆ สไตล์มินิมอล
        StatsLabel.TextXAlignment = Enum.TextXAlignment.Right
        StatsLabel.Font = Enum.Font.GothamMedium
        StatsLabel.TextSize = 13
        StatsLabel.ZIndex = mainFrame.ZIndex + 5
        ...
        RunService.RenderStepped:Connect(function()
            ...
            if tick() - lastUpdate >= 1 then
                ...
                -- 2. ดึงค่า Ping จริงของเซิร์ฟเวอร์
                local ping = 0
                pcall(function()
                    ping = math.floor(Stats.Network.ServerStatsItem["Data Ping"]:GetValue())
                end)
                
                -- 3. ดึงเวลาเครื่อง (รูปแบบ 24 ชั่วโมง)
                local timeStr = os.date("%H:%M:%S")
                
                -- อัปเดตข้อความบน UI
                StatsLabel.Text = string.format("FPS: %d  |  Ping: %dms  |  %s", fps, ping, timeStr)
                
                -- ลูกเล่น: เปลี่ยนสี FPS ถ้าเฟรมตก
                if fps < 30 then
                    StatsLabel.TextColor3 = Color3.fromRGB(255, 85, 85) -- สีแดง
                elseif ping > 200 then
                    StatsLabel.TextColor3 = Color3.fromRGB(255, 170, 0) -- สีส้ม
                else
                    StatsLabel.TextColor3 = Color3.fromRGB(180, 180, 180) -- สีปกติ
                end
            end
        end)
    end)
