...
local Themes = {
	...
	-- ============================================================
	-- NEW THEMES v2.0 - 10 BRAND NEW THEMES
	-- ============================================================
	...
	Neon = {
		...
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(5, 5, 15), Color3.fromRGB(10, 10, 22)),
		AcrylicNoise = 0.96,
		TitleBarLine = Color3.fromRGB(0, 180, 120),
		Tab = Color3.fromRGB(0, 200, 150),
		Element = Color3.fromRGB(15, 40, 35),
		ElementBorder = Color3.fromRGB(0, 150, 100),
		InElementBorder = Color3.fromRGB(0, 180, 130),
		ElementTransparency = 0.88,
		ToggleSlider = Color3.fromRGB(0, 200, 150),
		ToggleToggled = Color3.fromRGB(5, 15, 12),
		SliderRail = Color3.fromRGB(0, 200, 150),
		DropdownFrame = Color3.fromRGB(0, 220, 160),
		DropdownHolder = Color3.fromRGB(10, 25, 22),
		DropdownBorder = Color3.fromRGB(0, 150, 100),
		DropdownOption = Color3.fromRGB(0, 200, 150),
		Keybind = Color3.fromRGB(0, 200, 150),
		Input = Color3.fromRGB(0, 180, 130),
		InputFocused = Color3.fromRGB(5, 10, 8),
		InputIndicator = Color3.fromRGB(0, 220, 160),
		InputIndicatorFocus = Color3.fromRGB(0, 255, 180),
		Dialog = Color3.fromRGB(10, 25, 22),
		DialogHolder = Color3.fromRGB(8, 18, 15),
		DialogHolderLine = Color3.fromRGB(0, 130, 90),
		DialogButton = Color3.fromRGB(12, 28, 24),
		DialogButtonBorder = Color3.fromRGB(0, 160, 110),
		DialogBorder = Color3.fromRGB(0, 200, 150),
		DialogInput = Color3.fromRGB(15, 35, 28),
		DialogInputLine = Color3.fromRGB(0, 200, 150),
		Text = Color3.fromRGB(220, 255, 245),
		SubText = Color3.fromRGB(100, 200, 170),
	...
	Cyberpunk = {
		...
		AcrylicBorder = Color3.fromRGB(180, 0, 120),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(15, 5, 25), Color3.fromRGB(8, 3, 18)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(200, 0, 140),
		Tab = Color3.fromRGB(220, 10, 160),
		Element = Color3.fromRGB(40, 10, 55),
		ElementBorder = Color3.fromRGB(180, 0, 120),
		InElementBorder = Color3.fromRGB(220, 10, 160),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(220, 10, 160),
		ToggleToggled = Color3.fromRGB(15, 5, 25),
		SliderRail = Color3.fromRGB(220, 10, 160),
		DropdownFrame = Color3.fromRGB(255, 240, 0),
		DropdownHolder = Color3.fromRGB(18, 8, 28),
		DropdownBorder = Color3.fromRGB(180, 0, 120),
		DropdownOption = Color3.fromRGB(220, 10, 160),
		Keybind = Color3.fromRGB(220, 10, 160),
		Input = Color3.fromRGB(200, 0, 140),
		InputFocused = Color3.fromRGB(8, 3, 15),
		InputIndicator = Color3.fromRGB(255, 240, 0),
		InputIndicatorFocus = Color3.fromRGB(255, 240, 0),
		Dialog = Color3.fromRGB(18, 8, 28),
		DialogHolder = Color3.fromRGB(12, 5, 20),
		DialogHolderLine = Color3.fromRGB(160, 0, 100),
		DialogButton = Color3.fromRGB(20, 10, 32),
		DialogButtonBorder = Color3.fromRGB(200, 0, 140),
		DialogBorder = Color3.fromRGB(255, 240, 0),
		DialogInput = Color3.fromRGB(25, 12, 38),
		DialogInputLine = Color3.fromRGB(255, 240, 0),
		Text = Color3.fromRGB(255, 245, 220),
		SubText = Color3.fromRGB(200, 150, 220),
		Hover = Color3.fromRGB(220, 10, 160),
		HoverChange = 0.04
	},
	Sakura = {
		Name = "Sakura",
		Accent = Color3.fromRGB(255, 105, 150),
		AcrylicMain = Color3.fromRGB(35, 18, 22),
		AcrylicBorder = Color3.fromRGB(220, 130, 160),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(50, 20, 30), Color3.fromRGB(45, 18, 26)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(200, 120, 150),
		Tab = Color3.fromRGB(230, 140, 165),
		Element = Color3.fromRGB(90, 45, 60),
		ElementBorder = Color3.fromRGB(180, 100, 130),
		InElementBorder = Color3.fromRGB(210, 130, 155),
		ElementTransparency = 0.84,
		ToggleSlider = Color3.fromRGB(230, 140, 165),
		ToggleToggled = Color3.fromRGB(35, 15, 22),
		SliderRail = Color3.fromRGB(230, 140, 165),
		DropdownFrame = Color3.fromRGB(255, 160, 185),
		DropdownHolder = Color3.fromRGB(50, 25, 35),
		DropdownBorder = Color3.fromRGB(180, 100, 130),
		DropdownOption = Color3.fromRGB(230, 140, 165),
		Keybind = Color3.fromRGB(230, 140, 165),
		Input = Color3.fromRGB(210, 120, 150),
		InputFocused = Color3.fromRGB(20, 10, 14),
		InputIndicator = Color3.fromRGB(255, 160, 185),
		InputIndicatorFocus = Color3.fromRGB(255, 105, 150),
		Dialog = Color3.fromRGB(50, 25, 35),
		DialogHolder = Color3.fromRGB(40, 20, 28),
		DialogHolderLine = Color3.fromRGB(160, 90, 115),
		DialogButton = Color3.fromRGB(55, 28, 38),
		DialogButtonBorder = Color3.fromRGB(200, 115, 145),
		DialogBorder = Color3.fromRGB(230, 140, 165),
		DialogInput = Color3.fromRGB(65, 32, 44),
		DialogInputLine = Color3.fromRGB(230, 140, 165),
		Text = Color3.fromRGB(255, 240, 245),
		SubText = Color3.fromRGB(220, 170, 190),
		Hover = Color3.fromRGB(230, 140, 165),
		HoverChange = 0.04
	},
	Lava = {
		Name = "Lava",
		...
		AcrylicBorder = Color3.fromRGB(180, 60, 20),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(28, 10, 5), Color3.fromRGB(22, 8, 3)),
		AcrylicNoise = 0.94,
		TitleBarLine = Color3.fromRGB(200, 70, 25),
		Tab = Color3.fromRGB(210, 80, 30),
		Element = Color3.fromRGB(70, 28, 12),
		ElementBorder = Color3.fromRGB(160, 55, 18),
		InElementBorder = Color3.fromRGB(200, 70, 25),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(210, 80, 30),
		ToggleToggled = Color3.fromRGB(18, 8, 3),
		SliderRail = Color3.fromRGB(210, 80, 30),
		DropdownFrame = Color3.fromRGB(240, 100, 40),
		DropdownHolder = Color3.fromRGB(30, 12, 6),
		DropdownBorder = Color3.fromRGB(160, 55, 18),
		DropdownOption = Color3.fromRGB(210, 80, 30),
		Keybind = Color3.fromRGB(210, 80, 30),
		Input = Color3.fromRGB(190, 65, 22),
		InputFocused = Color3.fromRGB(12, 5, 2),
		InputIndicator = Color3.fromRGB(240, 100, 40),
		InputIndicatorFocus = Color3.fromRGB(255, 80, 20),
		Dialog = Color3.fromRGB(30, 12, 6),
		DialogHolder = Color3.fromRGB(22, 8, 4),
		DialogHolderLine = Color3.fromRGB(140, 48, 15),
		DialogButton = Color3.fromRGB(35, 14, 7),
		DialogButtonBorder = Color3.fromRGB(180, 65, 20),
		DialogBorder = Color3.fromRGB(210, 80, 30),
		DialogInput = Color3.fromRGB(40, 16, 8),
		DialogInputLine = Color3.fromRGB(210, 80, 30),
		Text = Color3.fromRGB(255, 240, 230),
		SubText = Color3.fromRGB(220, 160, 130),
		Hover = Color3.fromRGB(210, 80, 30),
		HoverChange = 0.04
	},
	Matrix = {
		Name = "Matrix",
		Accent = Color3.fromRGB(0, 255, 70),
		AcrylicMain = Color3.fromRGB(0, 10, 2),
		AcrylicBorder = Color3.fromRGB(0, 170, 45),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 12, 3), Color3.fromRGB(0, 8, 2)),
		AcrylicNoise = 0.97,
		TitleBarLine = Color3.fromRGB(0, 180, 50),
		Tab = Color3.fromRGB(0, 200, 55),
		Element = Color3.fromRGB(0, 35, 10),
		ElementBorder = Color3.fromRGB(0, 140, 38),
		InElementBorder = Color3.fromRGB(0, 170, 45),
		ElementTransparency = 0.88,
		ToggleSlider = Color3.fromRGB(0, 200, 55),
		ToggleToggled = Color3.fromRGB(0, 8, 2),
		SliderRail = Color3.fromRGB(0, 200, 55),
		DropdownFrame = Color3.fromRGB(0, 220, 60),
		DropdownHolder = Color3.fromRGB(0, 18, 5),
		DropdownBorder = Color3.fromRGB(0, 140, 38),
		DropdownOption = Color3.fromRGB(0, 200, 55),
		Keybind = Color3.fromRGB(0, 200, 55),
		Input = Color3.fromRGB(0, 180, 48),
		InputFocused = Color3.fromRGB(0, 6, 1),
		InputIndicator = Color3.fromRGB(0, 220, 60),
		InputIndicatorFocus = Color3.fromRGB(0, 255, 70),
		Dialog = Color3.fromRGB(0, 18, 5),
		DialogHolder = Color3.fromRGB(0, 12, 3),
		DialogHolderLine = Color3.fromRGB(0, 120, 32),
		DialogButton = Color3.fromRGB(0, 20, 6),
		DialogButtonBorder = Color3.fromRGB(0, 160, 44),
		DialogBorder = Color3.fromRGB(0, 200, 55),
		DialogInput = Color3.fromRGB(0, 24, 7),
		DialogInputLine = Color3.fromRGB(0, 200, 55),
		Text = Color3.fromRGB(180, 255, 200),
		SubText = Color3.fromRGB(80, 200, 100),
		Hover = Color3.fromRGB(0, 200, 55),
		HoverChange = 0.04
	},
	Nord = {
		Name = "Nord",
		Accent = Color3.fromRGB(136, 192, 208),
		AcrylicMain = Color3.fromRGB(36, 41, 51),
		AcrylicBorder = Color3.fromRGB(67, 76, 94),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(46, 52, 64), Color3.fromRGB(59, 66, 82)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(76, 86, 106),
		Tab = Color3.fromRGB(129, 161, 193),
		Element = Color3.fromRGB(59, 66, 82),
		ElementBorder = Color3.fromRGB(67, 76, 94),
		InElementBorder = Color3.fromRGB(76, 86, 106),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(129, 161, 193),
		ToggleToggled = Color3.fromRGB(46, 52, 64),
		SliderRail = Color3.fromRGB(129, 161, 193),
		DropdownFrame = Color3.fromRGB(136, 192, 208),
		DropdownHolder = Color3.fromRGB(46, 52, 64),
		DropdownBorder = Color3.fromRGB(67, 76, 94),
		DropdownOption = Color3.fromRGB(129, 161, 193),
		Keybind = Color3.fromRGB(129, 161, 193),
		Input = Color3.fromRGB(100, 130, 160),
		InputFocused = Color3.fromRGB(36, 41, 51),
		InputIndicator = Color3.fromRGB(136, 192, 208),
		InputIndicatorFocus = Color3.fromRGB(136, 192, 208),
		Dialog = Color3.fromRGB(46, 52, 64),
		DialogHolder = Color3.fromRGB(59, 66, 82),
		DialogHolderLine = Color3.fromRGB(67, 76, 94),
		DialogButton = Color3.fromRGB(59, 66, 82),
		DialogButtonBorder = Color3.fromRGB(76, 86, 106),
		DialogBorder = Color3.fromRGB(129, 161, 193),
		DialogInput = Color3.fromRGB(67, 76, 94),
		DialogInputLine = Color3.fromRGB(129, 161, 193),
		Text = Color3.fromRGB(236, 239, 244),
		SubText = Color3.fromRGB(165, 180, 203),
		Hover = Color3.fromRGB(129, 161, 193),
		HoverChange = 0.05
	},
	Coffee = {
		Name = "Coffee",
		Accent = Color3.fromRGB(195, 140, 80),
		AcrylicMain = Color3.fromRGB(22, 15, 10),
		AcrylicBorder = Color3.fromRGB(100, 70, 40),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(32, 20, 12), Color3.fromRGB(28, 18, 10)),
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(110, 75, 45),
		Tab = Color3.fromRGB(160, 110, 65),
		Element = Color3.fromRGB(55, 38, 22),
		ElementBorder = Color3.fromRGB(90, 62, 36),
		InElementBorder = Color3.fromRGB(110, 78, 46),
		ElementTransparency = 0.86,
		ToggleSlider = Color3.fromRGB(160, 110, 65),
		ToggleToggled = Color3.fromRGB(22, 15, 9),
		SliderRail = Color3.fromRGB(160, 110, 65),
		DropdownFrame = Color3.fromRGB(195, 140, 80),
		DropdownHolder = Color3.fromRGB(35, 24, 14),
		DropdownBorder = Color3.fromRGB(90, 62, 36),
		DropdownOption = Color3.fromRGB(160, 110, 65),
		Keybind = Color3.fromRGB(160, 110, 65),
		Input = Color3.fromRGB(140, 95, 55),
		InputFocused = Color3.fromRGB(15, 10, 6),
		InputIndicator = Color3.fromRGB(195, 140, 80),
		InputIndicatorFocus = Color3.fromRGB(215, 160, 100),
		Dialog = Color3.fromRGB(35, 24, 14),
		DialogHolder = Color3.fromRGB(28, 19, 11),
		DialogHolderLine = Color3.fromRGB(80, 55, 32),
		DialogButton = Color3.fromRGB(40, 27, 16),
		DialogButtonBorder = Color3.fromRGB(110, 78, 46),
		DialogBorder = Color3.fromRGB(160, 110, 65),
		DialogInput = Color3.fromRGB(48, 32, 18),
		DialogInputLine = Color3.fromRGB(160, 110, 65),
		Text = Color3.fromRGB(255, 245, 230),
		SubText = Color3.fromRGB(200, 170, 130),
		Hover = Color3.fromRGB(160, 110, 65),
		HoverChange = 0.04
	},
	Galaxy = {
		Name = "Galaxy",
		Accent = Color3.fromRGB(170, 100, 255),
		AcrylicMain = Color3.fromRGB(8, 5, 20),
		AcrylicBorder = Color3.fromRGB(80, 50, 160),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(12, 8, 30), Color3.fromRGB(15, 10, 35)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(90, 55, 175),
		Tab = Color3.fromRGB(140, 80, 240),
		Element = Color3.fromRGB(30, 18, 65),
		ElementBorder = Color3.fromRGB(70, 44, 140),
		InElementBorder = Color3.fromRGB(90, 55, 175),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(140, 80, 240),
		ToggleToggled = Color3.fromRGB(8, 5, 18),
		SliderRail = Color3.fromRGB(140, 80, 240),
		DropdownFrame = Color3.fromRGB(170, 100, 255),
		DropdownHolder = Color3.fromRGB(18, 10, 42),
		DropdownBorder = Color3.fromRGB(70, 44, 140),
		DropdownOption = Color3.fromRGB(140, 80, 240),
		Keybind = Color3.fromRGB(140, 80, 240),
		Input = Color3.fromRGB(120, 68, 210),
		InputFocused = Color3.fromRGB(6, 4, 14),
		InputIndicator = Color3.fromRGB(170, 100, 255),
		InputIndicatorFocus = Color3.fromRGB(200, 140, 255),
		Dialog = Color3.fromRGB(18, 10, 42),
		DialogHolder = Color3.fromRGB(12, 7, 28),
		DialogHolderLine = Color3.fromRGB(60, 38, 120),
		DialogButton = Color3.fromRGB(22, 13, 50),
		DialogButtonBorder = Color3.fromRGB(100, 60, 190),
		DialogBorder = Color3.fromRGB(140, 80, 240),
		DialogInput = Color3.fromRGB(26, 16, 58),
		DialogInputLine = Color3.fromRGB(140, 80, 240),
		Text = Color3.fromRGB(240, 230, 255),
		SubText = Color3.fromRGB(170, 140, 230),
		Hover = Color3.fromRGB(140, 80, 240),
		HoverChange = 0.04
	},
	Holographic = {
		Name = "Holographic",
		Accent = Color3.fromRGB(100, 240, 230),
		AcrylicMain = Color3.fromRGB(15, 15, 25),
		AcrylicBorder = Color3.fromRGB(80, 200, 220),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 18, 35), Color3.fromRGB(18, 15, 30)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(100, 200, 220),
		Tab = Color3.fromRGB(120, 220, 240),
		Element = Color3.fromRGB(28, 30, 55),
		ElementBorder = Color3.fromRGB(70, 170, 200),
		InElementBorder = Color3.fromRGB(100, 200, 220),
		ElementTransparency = 0.85,
		ToggleSlider = Color3.fromRGB(120, 220, 240),
		ToggleToggled = Color3.fromRGB(12, 12, 22),
		SliderRail = Color3.fromRGB(120, 220, 240),
		DropdownFrame = Color3.fromRGB(150, 240, 255),
		DropdownHolder = Color3.fromRGB(18, 20, 38),
		DropdownBorder = Color3.fromRGB(70, 170, 200),
		DropdownOption = Color3.fromRGB(120, 220, 240),
		Keybind = Color3.fromRGB(120, 220, 240),
		Input = Color3.fromRGB(100, 200, 220),
		InputFocused = Color3.fromRGB(10, 10, 18),
		InputIndicator = Color3.fromRGB(150, 240, 255),
		InputIndicatorFocus = Color3.fromRGB(200, 255, 255),
		Dialog = Color3.fromRGB(18, 20, 38),
		DialogHolder = Color3.fromRGB(14, 15, 28),
		DialogHolderLine = Color3.fromRGB(60, 150, 180),
		DialogButton = Color3.fromRGB(22, 24, 44),
		DialogButtonBorder = Color3.fromRGB(90, 190, 210),
		DialogBorder = Color3.fromRGB(120, 220, 240),
		DialogInput = Color3.fromRGB(26, 28, 50),
		DialogInputLine = Color3.fromRGB(120, 220, 240),
		Text = Color3.fromRGB(220, 250, 255),
		SubText = Color3.fromRGB(150, 220, 235),
		Hover = Color3.fromRGB(120, 220, 240),
		HoverChange = 0.04
	},
	Toxic = {
		Name = "Toxic",
		Accent = Color3.fromRGB(160, 255, 0),
		AcrylicMain = Color3.fromRGB(10, 15, 5),
		AcrylicBorder = Color3.fromRGB(100, 180, 0),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(12, 18, 5), Color3.fromRGB(8, 14, 3)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(110, 190, 5),
		Tab = Color3.fromRGB(140, 220, 0),
		Element = Color3.fromRGB(28, 40, 10),
		ElementBorder = Color3.fromRGB(85, 155, 0),
		InElementBorder = Color3.fromRGB(110, 190, 5),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(140, 220, 0),
		ToggleToggled = Color3.fromRGB(8, 12, 3),
		SliderRail = Color3.fromRGB(140, 220, 0),
		DropdownFrame = Color3.fromRGB(160, 240, 0),
		DropdownHolder = Color3.fromRGB(15, 22, 6),
		DropdownBorder = Color3.fromRGB(85, 155, 0),
		DropdownOption = Color3.fromRGB(140, 220, 0),
		Keybind = Color3.fromRGB(140, 220, 0),
		Input = Color3.fromRGB(120, 195, 0),
		InputFocused = Color3.fromRGB(6, 10, 2),
		InputIndicator = Color3.fromRGB(160, 240, 0),
		InputIndicatorFocus = Color3.fromRGB(190, 255, 20),
		Dialog = Color3.fromRGB(15, 22, 6),
		DialogHolder = Color3.fromRGB(10, 16, 4),
		DialogHolderLine = Color3.fromRGB(75, 135, 0),
		DialogButton = Color3.fromRGB(18, 26, 7),
		DialogButtonBorder = Color3.fromRGB(110, 175, 0),
		DialogBorder = Color3.fromRGB(140, 220, 0),
		DialogInput = Color3.fromRGB(22, 32, 8),
		DialogInputLine = Color3.fromRGB(140, 220, 0),
		Text = Color3.fromRGB(220, 255, 180),
		SubText = Color3.fromRGB(140, 220, 80),
		Hover = Color3.fromRGB(140, 220, 0),
		HoverChange = 0.04
	},
...
-- ================================================================
-- NEW ELEMENTS v2.0 - 30+ NEW ELEMENTS FOCUSED ON BUTTONS
-- ================================================================

-- [1] SEPARATOR - Plain line divider
ElementsTable.Separator = (function()
	...
	function Element:New(Config)
		...
		local SepFrame = New("Frame", {
			...
			BackgroundTransparency = Config.Transparency or 0.6,
		...
		local wrapper = New("Frame", {
			Size = UDim2.new(1, 0, 0, (Config.Padding or 6) * 2 + (Config.Height or 1)),
			BackgroundTransparency = 1,
			Parent = self.Container,
		}, { SepFrame })
		SepFrame.Position = UDim2.new(0, 0, 0.5, 0)
		SepFrame.AnchorPoint = Vector2.new(0, 0.5)
...
-- [2] LABELED SEPARATOR - Line with centered text
ElementsTable.LabeledSeparator = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "LabeledSeparator"

	function Element:New(Config)
		Config = Config or {}
		assert(Config.Title, "LabeledSeparator - Missing Title")
		local New = Creator.New
...
-- [3] SPACER - Invisible spacing element
ElementsTable.Spacer = (function()
	...
	function Element:New(Config)
		...
		local frame = New("Frame", {
			Size = UDim2.new(1, 0, 0, Config.Size or 8),
			BackgroundTransparency = 1,
			Parent = self.Container,
		})
		return { Frame = frame }
...
-- [4] ICON BUTTON - Button with prominent icon
ElementsTable.IconButton = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "IconButton"

	function Element:New(Config)
		assert(Config.Title, "IconButton - Missing Title")
		Config.Callback = Config.Callback or function() end
		local New = Creator.New

		local ButtonFrame = Components.Element(Config.Title, Config.Description, self.Container, true, Config)

		local iconId = Config.Icon and Library:GetIcon(Config.Icon) or "rbxassetid://10709791437"
		if not Library:GetIcon(Config.Icon) and Config.Icon and Config.Icon:find("rbxassetid") then
			iconId = Config.Icon
		end
...
-- [5] GRADIENT BUTTON - Accent-colored gradient button
ElementsTable.GradientButton = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "GradientButton"

	function Element:New(Config)
		assert(Config.Title, "GradientButton - Missing Title")
		Config.Callback = Config.Callback or function() end
		local New = Creator.New
		...
		local function UpdateGradient()
			local theme = Themes[Library.Theme or "Dark"]
			if theme and theme.Accent then
				local accent = theme.Accent
				gradient.Color = ColorSequence.new({
					ColorSequenceKeypoint.new(0, Color3.fromRGB(
						math.min(255, math.floor(accent.R * 255 + 30)),
						math.min(255, math.floor(accent.G * 255 + 30)),
						math.min(255, math.floor(accent.B * 255 + 30))
					)),
		...
		local function watchTheme()
			while pcall(function() return Btn.Parent ~= nil end) and Btn.Parent do
				pcall(UpdateGradient)
				task.wait(1)
			end
		end
		task.spawn(watchTheme)
		...
		local Motor, SetTransparency = Creator.SpringMotor(0, Btn, "BackgroundTransparency")
		Creator.AddSignal(Btn.MouseEnter, function() SetTransparency(0.1) end)
		Creator.AddSignal(Btn.MouseLeave, function() SetTransparency(0) end)
		Creator.AddSignal(Btn.MouseButton1Down, function() SetTransparency(0.2) end)
		Creator.AddSignal(Btn.MouseButton1Up, function() SetTransparency(0.1) end)
...
-- [6] DANGER BUTTON - Red warning button
ElementsTable.DangerButton = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "DangerButton"

	function Element:New(Config)
		assert(Config.Title, "DangerButton - Missing Title")
		Config.Callback = Config.Callback or function() end
		local New = Creator.New
		...
		local BorderFrame = ButtonFrame.Frame:FindFirstChildOfClass("UIStroke")
		if BorderFrame then
			Creator.OverrideTag(ButtonFrame.Frame, {})
			ButtonFrame.Frame.BackgroundColor3 = Color3.fromRGB(90, 28, 28)
			ButtonFrame.Frame.BackgroundTransparency = 0.8
			New("UIStroke", {
				ApplyStrokeMode = Enum.ApplyStrokeMode.Border,
		...
		Creator.AddSignal(ButtonFrame.Frame.MouseButton1Click, function()
			if Config.Confirm then
				Library.Window:Dialog({
					...
					Content = Config.ConfirmMessage or "Are you sure you want to proceed?",
					Buttons = {
						{ Title = "Confirm", Callback = Config.Callback },
						{ Title = "Cancel" },
					},
				})
			else
...
-- [7] SUCCESS BUTTON - Green confirm button
ElementsTable.SuccessButton = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "SuccessButton"

	function Element:New(Config)
		assert(Config.Title, "SuccessButton - Missing Title")
		Config.Callback = Config.Callback or function() end
		local New = Creator.New

		local ButtonFrame = Components.Element(Config.Title, Config.Description, self.Container, true, Config)

		ButtonFrame.Frame.BackgroundColor3 = Color3.fromRGB(20, 80, 35)
		ButtonFrame.Frame.BackgroundTransparency = 0.7
		...
		local CheckIco = New("ImageLabel", {
			Image = "rbxassetid://10709791437",
			Size = UDim2.fromOffset(16, 16),
			AnchorPoint = Vector2.new(1, 0.5),
			Position = UDim2.new(1, -10, 0.5, 0),
			BackgroundTransparency = 1,
			ImageColor3 = Color3.fromRGB(60, 220, 100),
			Parent = ButtonFrame.Frame,
		})
...
-- [8] WARNING BUTTON - Orange caution button
ElementsTable.WarnButton = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "WarnButton"

	function Element:New(Config)
		assert(Config.Title, "WarnButton - Missing Title")
		Config.Callback = Config.Callback or function() end
		local New = Creator.New

		local ButtonFrame = Components.Element(Config.Title, Config.Description, self.Container, true, Config)

		ButtonFrame.Frame.BackgroundColor3 = Color3.fromRGB(90, 60, 10)
		ButtonFrame.Frame.BackgroundTransparency = 0.7
...
-- [9] COPY BUTTON - Button that copies text to clipboard
ElementsTable.CopyButton = (function()
	...
	function Element:New(Config)
		...
		assert(Config.Value, "CopyButton - Missing Value to copy")
		local New = Creator.New

		local ButtonFrame = Components.Element(Config.Title, Config.Description, self.Container, true, Config)

		local CopyIco = New("ImageLabel", {
			Image = "rbxassetid://10734947892",
			Size = UDim2.fromOffset(16, 16),
			AnchorPoint = Vector2.new(1, 0.5),
			Position = UDim2.new(1, -10, 0.5, 0),
			BackgroundTransparency = 1,
		...
		Creator.AddSignal(ButtonFrame.Frame.MouseButton1Click, function()
			...
			copied = true
			local value = type(Config.Value) == "function" and Config.Value() or Config.Value
			pcall(function() setclipboard(value) end)
			CopyIco.ImageColor3 = Color3.fromRGB(80, 220, 120)
			Library:Notify({ Title = "Copied!", Content = Config.Title, SubContent = "Copied to clipboard", Duration = 2 })
			task.wait(1.5)
			CopyIco.ImageColor3 = Color3.fromRGB(170, 170, 170)
			copied = false
		end)
...
-- [10] COUNTER BUTTON - Button with +/- counter
ElementsTable.CounterButton = (function()
	...
	function Element:New(Idx, Config)
		...
		local New = Creator.New
		local ButtonFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)
		ButtonFrame.DescLabel.Size = UDim2.new(1, -140, 0, 14)
		...
		function Counter:SetValue(v)
			v = math.clamp(math.floor(v / self.Step + 0.5) * self.Step, self.Min, self.Max)
			self.Value = v
		...
		Creator.AddSignal(MinusBtn.MouseButton1Click, function()
			Counter:SetValue(Counter.Value - Counter.Step)
		end)
		Creator.AddSignal(PlusBtn.MouseButton1Click, function()
			Counter:SetValue(Counter.Value + Counter.Step)
		end)

		Counter:SetValue(Counter.Value)
		if Idx then Library.Options[Idx] = Counter end
		return Counter
	end
...
-- [11] TIMER BUTTON - Button with countdown cooldown
ElementsTable.TimerButton = (function()
	...
	function Element:New(Config)
		...
		Creator.AddSignal(ButtonFrame.Frame.MouseButton1Click, function()
			...
			running = true
			Library:SafeCallback(Config.Callback)
			ButtonFrame.Frame.Active = false

			task.spawn(function()
				for i = Cooldown, 1, -1 do
					TimerLabel.Text = tostring(i) .. "s"
					TimerLabel.ThemeTag = nil
					TimerLabel.TextColor3 = Color3.fromRGB(200, 100, 100)
					task.wait(1)
				end
				TimerLabel.Text = "▶"
				TimerLabel.ThemeTag = { TextColor3 = "Accent" }
				Creator.OverrideTag(TimerLabel, { TextColor3 = "Accent" })
				ButtonFrame.Frame.Active = true
				running = false
			end)
		end)
...
-- [12] SPLIT BUTTON - Button with left action + right dropdown
ElementsTable.SplitButton = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "SplitButton"

	function Element:New(Config)
		assert(Config.Title, "SplitButton - Missing Title")
		assert(Config.Options, "SplitButton - Missing Options table")
		Config.Callback = Config.Callback or function() end
		local New = Creator.New
		...
		Creator.AddSignal(ArrowBtn.MouseButton1Click, function()
			local items = {}
			for _, v in ipairs(Config.Options) do
				table.insert(items, {
					Title = v.Title or tostring(v),
...
-- [13] TOGGLE BUTTON - Looks like button but acts as toggle
ElementsTable.ToggleButton = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "ToggleButton"

	function Element:New(Idx, Config)
		assert(Config.Title, "ToggleButton - Missing Title")
		...
		local StatusLabel = New("TextLabel", {
			Text = TB.Value and (Config.OnText or "ON") or (Config.OffText or "OFF"),
			FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.SemiBold, Enum.FontStyle.Normal),
			TextSize = 11,
			Size = UDim2.fromOffset(36, 18),
			AnchorPoint = Vector2.new(1, 0.5),
		...
		function TB:SetValue(v)
			...
			StatusLabel.Text = self.Value and (Config.OnText or "ON") or (Config.OffText or "OFF")
			StatusLabel.BackgroundColor3 = self.Value and Color3.fromRGB(60, 200, 100) or Color3.fromRGB(180, 50, 50)
		...
		Creator.AddSignal(ButtonFrame.Frame.MouseButton1Click, function()
			TB:SetValue(not TB.Value)
		end)

		if Idx then Library.Options[Idx] = TB end
		return TB
	end
...
-- [14] BADGE LABEL - Text label with a colored badge
ElementsTable.BadgeLabel = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "BadgeLabel"

	function Element:New(Config)
		assert(Config.Title, "BadgeLabel - Missing Title")
		local New = Creator.New
		...
		local badgeColor = Config.Color or Color3.fromRGB(100, 170, 255)
		...
		local BadgeObj = { Frame = Frame, BadgeFrame = BadgeFrame }

		function BadgeObj:SetBadge(text, color)
			BadgeFrame:FindFirstChildOfClass("TextLabel").Text = text
			if color then BadgeFrame.BackgroundColor3 = color end
		end
...
-- [15] INFO BOX - Read-only info display with label
ElementsTable.InfoBox = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "InfoBox"

	function Element:New(Config)
		assert(Config.Title, "InfoBox - Missing Title")
		local New = Creator.New
		...
		function obj:SetValue(v) ValueLabel.Text = tostring(v) end
		return obj
	end
...
-- [16] LINK BUTTON - Opens URL or fires callback, shows external icon
ElementsTable.LinkButton = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "LinkButton"

	function Element:New(Config)
		assert(Config.Title, "LinkButton - Missing Title")
		Config.Callback = Config.Callback or function() end
		local New = Creator.New
...
-- [17] PROGRESS BUTTON - Button with progress bar underneath
ElementsTable.ProgressButton = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "ProgressButton"

	function Element:New(Config)
		assert(Config.Title, "ProgressButton - Missing Title")
		Config.Callback = Config.Callback or function() end
		local New = Creator.New
		...
		local ProgressFill = New("Frame", {
			Size = UDim2.new(Config.Progress or 0, 0, 1, 0),
			BackgroundTransparency = 0,
			Parent = RailBg,
			ThemeTag = { BackgroundColor3 = "Accent" },
		}, { New("UICorner", { CornerRadius = UDim.new(1, 0) }) })
		...
		local PercentLabel = New("TextLabel", {
			Text = math.floor((Config.Progress or 0) * 100) .. "%",
			FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json"),
			TextSize = 11,
...
-- [18] BUTTON GROUP - Multiple buttons side by side
ElementsTable.ButtonGroup = (function()
	...
	function Element:New(Config)
		assert(Config.Buttons, "ButtonGroup - Missing Buttons table")
		local New = Creator.New
		...
		for i, btnCfg in ipairs(Config.Buttons) do
			...
			if btnCfg.Accent then
				Btn.ThemeTag = { BackgroundColor3 = "Accent", TextColor3 = "Text" }
				Btn.BackgroundTransparency = 0.6
			end

			Creator.AddSignal(Btn.MouseButton1Click, function()
				Library:SafeCallback(btnCfg.Callback or function() end)
			end)
		end
...
-- [19] NOTIFICATION BUTTON - Button that fires a notification
ElementsTable.NotifyButton = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "NotifyButton"

	function Element:New(Config)
		assert(Config.Title, "NotifyButton - Missing Title")
		local New = Creator.New
		...
		Creator.AddSignal(ButtonFrame.Frame.MouseButton1Click, function()
			Library:SafeCallback(Config.Callback or function() end)
			Library:Notify({
				Title = Config.NotifTitle or Config.Title,
				Content = Config.NotifContent or "Button pressed",
				SubContent = Config.NotifSub or "",
...
-- [20] CONFIRM BUTTON - Requires double-click to confirm
ElementsTable.ConfirmButton = (function()
	...
	function Element:New(Config)
		...
		Creator.AddSignal(ButtonFrame.Frame.MouseButton1Click, function()
			if waiting then
				waiting = false
				if waitThread then task.cancel(waitThread) end
				HintLabel.TextTransparency = 1
				ButtonFrame.TitleLabel.Text = originalTitle
				Library:SafeCallback(Config.Callback)
			else
				waiting = true
				HintLabel.TextTransparency = 0
				ButtonFrame.TitleLabel.Text = "⚠ " .. originalTitle
				waitThread = task.delay(2, function()
					waiting = false
					HintLabel.TextTransparency = 1
					ButtonFrame.TitleLabel.Text = originalTitle
				end)
...
-- [21] HOTKEY DISPLAY - Shows current active key bindings
...
-- [22] STAT DISPLAY - Shows a stat with colored value
ElementsTable.StatDisplay = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "StatDisplay"

	function Element:New(Config)
		assert(Config.Title, "StatDisplay - Missing Title")
		local New = Creator.New
		...
		local obj = { Frame = Frame }
		function obj:SetValue(v, c)
			ValueLabel.Text = tostring(v)
			if c then ValueLabel.TextColor3 = c end
		end
		return obj
	end
...
-- [23] ACCORDION SECTION - Expandable/collapsible content area
ElementsTable.Accordion = (function()
	...
	function Element:New(Config)
		...
		local function updateSize()
			if Open then
				local contentH = ContentHolder.AbsoluteSize.Y + 4
				TweenService:Create(Wrapper, TweenInfo.new(0.2, Enum.EasingStyle.Quart), {
					Size = UDim2.new(1, 0, 0, 40 + contentH)
				}):Play()
			else
				TweenService:Create(Wrapper, TweenInfo.new(0.2, Enum.EasingStyle.Quart), {
					Size = UDim2.new(1, 0, 0, 36)
		...
		local SectionObj = { Container = ContentHolder, Frame = Wrapper, Type = "Section" }
		-- ใช้ lazy metatable เพื่อให้ Elements พร้อมก่อนเสมอ
		setmetatable(SectionObj, {
			__index = function(t, k)
				return Library.Elements[k]
			end,
...
-- [24] COLOR BUTTON - Quick accent-colored button (full width, prominent)
ElementsTable.ColorButton = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "ColorButton"

	function Element:New(Config)
		assert(Config.Title, "ColorButton - Missing Title")
		Config.Callback = Config.Callback or function() end
		local New = Creator.New

		local color = Config.Color or Color3.fromRGB(96, 205, 255)
		local Btn = New("TextButton", {
			Size = UDim2.new(1, 0, 0, 36),
		...
		if Config.Icon then
			local ico = Library:GetIcon(Config.Icon)
			if ico then
				New("ImageLabel", {
					Image = ico,
					Size = UDim2.fromOffset(16, 16),
...
-- [25] RADIO GROUP - Exclusive option picker
	...
	function Element:New(Idx, Config)
		...
		for _, option in ipairs(Config.Options) do
			local Row = New("Frame", {
				...
				New("UICorner", { CornerRadius = UDim.new(0, 7) }),
				New("UIStroke", { Transparency = 0.65, ThemeTag = { Color = "InElementBorder" } }),
			})

			local RadioCircle = New("Frame", {
				Size = UDim2.fromOffset(16, 16),
				Position = UDim2.new(0, 12, 0.5, 0),
				AnchorPoint = Vector2.new(0, 0.5),
				BackgroundTransparency = 1,
				...
				New("UICorner", { CornerRadius = UDim.new(1, 0) }),
				New("UIStroke", { Thickness = 2, ThemeTag = { Color = "SubText" } }),
			})
			...
			table.insert(Buttons, { dot = RadioDot, stroke = RadioCircle:FindFirstChildOfClass("UIStroke"), value = option })

			Creator.AddSignal(RowBtn.MouseButton1Click, function()
				Radio:SetValue(option)
			end)
		end

		function Radio:SetValue(v)
			self.Value = v
			for _, btn in ipairs(Buttons) do
				local selected = (btn.value == v)
				btn.dot.BackgroundTransparency = selected and 0 or 1
				if btn.stroke then
					Creator.OverrideTag(btn.stroke, { Color = selected and "Accent" or "SubText" })
				end
			end
			Library:SafeCallback(self.Callback, v)
		end

		Radio:SetValue(Radio.Value)
...
-- [26] CHIP SELECTOR - Horizontal chips/tags as option picker
ElementsTable.ChipSelector = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "ChipSelector"

	function Element:New(Idx, Config)
		assert(Config.Options, "ChipSelector - Missing Options table")
		Config.Callback = Config.Callback or function() end
		...
		local function updateChip(frame, selected)
			TweenService:Create(frame, TweenInfo.new(0.15), {
				BackgroundTransparency = selected and 0.5 or 0.88
			}):Play()
		end
		...
		for _, option in ipairs(Config.Options) do
			local ChipBtn = New("TextButton", {
				...
				New("UIStroke", { Transparency = 0.6, ThemeTag = { Color = "Accent" } }),
			})

			table.insert(chipFrames, { frame = ChipBtn, value = option })

			Creator.AddSignal(ChipBtn.MouseButton1Click, function()
				if Chip.Multi then
					Chip.Selected[option] = not Chip.Selected[option]
					updateChip(ChipBtn, Chip.Selected[option])
				else
					Chip.Value = option
					for _, c in ipairs(chipFrames) do
						updateChip(c.frame, c.value == option)
					end
				end
				Library:SafeCallback(Chip.Callback, Chip.Multi and Chip.Selected or Chip.Value)
			end)
		end

		if Chip.Value then
			for _, c in ipairs(chipFrames) do
				updateChip(c.frame, c.value == Chip.Value)
			end
		end

		if Idx then Library.Options[Idx] = Chip end
		return Chip
	end
...
-- [27] STEPPER - Visual step indicator (like a wizard step bar)
ElementsTable.Stepper = (function()
	...
	function Element:New(Idx, Config)
		assert(Config.Steps, "Stepper - Missing Steps table")
		Config.Callback = Config.Callback or function() end
		...
		for i, stepName in ipairs(Config.Steps) do
			local pct = (i - 1) / math.max(count - 1, 1)

			local DotHolder = New("Frame", {
				Size = UDim2.fromOffset(24, 24),
				Position = UDim2.new(pct, -12, 0.5, 0),
				AnchorPoint = Vector2.new(0, 0.5),
				BackgroundTransparency = 1,
				Parent = StepperFrame,
			})
			...
			local Dot = New("Frame", {
				...
				New("UICorner", { CornerRadius = UDim.new(1, 0) }),
				New("UIStroke", { Transparency = 0.4, ThemeTag = { Color = "SubText" } }),
				New("TextLabel", {
					Text = tostring(i),
					FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal),
					TextSize = 10,
			...
			table.insert(stepDots, { dot = Dot, stroke = Dot:FindFirstChildOfClass("UIStroke"), num = Dot:FindFirstChildOfClass("TextLabel") })
			...
			local stepIdx = i
			Creator.AddSignal(DotBtn.MouseButton1Click, function()
				Stepper:SetValue(stepIdx)
			end)
		end

		function Stepper:SetValue(v)
			self.Value = math.clamp(v, 1, count)
			for i2, d in ipairs(stepDots) do
				local active = i2 <= self.Value
				Creator.OverrideTag(d.dot, { BackgroundColor3 = active and "Accent" or "Element" })
				d.dot.BackgroundTransparency = active and 0.4 or 0.7
				if d.stroke then Creator.OverrideTag(d.stroke, { Color = active and "Accent" or "SubText" }) end
				if d.num then Creator.OverrideTag(d.num, { TextColor3 = active and "Text" or "SubText" }) end
			end
			Library:SafeCallback(self.Callback, self.Value, Config.Steps[self.Value])
		end

		Stepper:SetValue(Stepper.Value)
		if Idx then Library.Options[Idx] = Stepper end
		return Stepper
	end
...
-- [28] DOUBLE BUTTON - Two buttons side by side, left/right labeled
ElementsTable.DoubleButton = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "DoubleButton"

	function Element:New(Config)
		assert(Config.LeftTitle and Config.RightTitle, "DoubleButton - Missing LeftTitle or RightTitle")
		Config.LeftCallback = Config.LeftCallback or function() end
		Config.RightCallback = Config.RightCallback or function() end
		local New = Creator.New
		...
		local function makeBtn(title, xPos, width, callback)
			local Btn = New("TextButton", {
				Size = UDim2.new(width, -3, 1, 0),
				Position = UDim2.new(xPos, 3, 0, 0),
				BackgroundTransparency = 0.85,
				Text = title,
				FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Medium, Enum.FontStyle.Normal),
				TextSize = 12,
		...
		makeBtn(Config.LeftTitle, 0, 0.5, Config.LeftCallback)
		makeBtn(Config.RightTitle, 0.5, 0.5, Config.RightCallback)
...
-- [29] ANIMATION BUTTON - Button with ripple click animation
ElementsTable.AnimButton = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "AnimButton"

	function Element:New(Config)
		assert(Config.Title, "AnimButton - Missing Title")
		Config.Callback = Config.Callback or function() end
		local New = Creator.New
		...
		Creator.AddSignal(ButtonFrame.Frame.MouseButton1Click, function()
			...
			local absPos = ButtonFrame.Frame.AbsolutePosition
...
-- [30] PULSE BUTTON - Animated glowing button
ElementsTable.PulseButton = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "PulseButton"

	function Element:New(Config)
		assert(Config.Title, "PulseButton - Missing Title")
		Config.Callback = Config.Callback or function() end
		local New = Creator.New

		local ButtonFrame = Components.Element(Config.Title, Config.Description, self.Container, true, Config)

		local PulseStroke = New("UIStroke", {
			ApplyStrokeMode = Enum.ApplyStrokeMode.Border,
			Transparency = 0.4,
			Thickness = 1.5,
			Parent = ButtonFrame.Frame,
		...
		local pulsing = true
		task.spawn(function()
			while pulsing and ButtonFrame.Frame.Parent do
				TweenService:Create(PulseStroke, TweenInfo.new(0.8, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
					Transparency = 0,
					Thickness = 2.5,
				}):Play()
				task.wait(0.8)
...
-- Elements that need a string Idx as first argument (saved to Library.Options)
local IndexedElements = {
	Toggle = true, Dropdown = true, Slider = true,
	Keybind = true, Colorpicker = true, Input = true,
	CounterButton = true, ToggleButton = true,
	RadioGroup = true, ChipSelector = true, Stepper = true,
}

for _, ElementComponent in pairs(ElementsTable) do
	local etype = ElementComponent.__type
	if IndexedElements[etype] then
		-- Indexed call: section:AddToggle("MyIdx", { Title = "..." })
		Elements["Add" .. etype] = function(self, Idx, Config)
		...
		-- Non-indexed call: section:AddButton({ Title = "..." })
		Elements["Add" .. etype] = function(self, Config)
			ElementComponent.Container = self.Container
			ElementComponent.Type = self.Type
			ElementComponent.ScrollFrame = self.ScrollFrame
			ElementComponent.Library = Library
