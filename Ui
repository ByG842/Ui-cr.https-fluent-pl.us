...
ElementsTable.ProgressBar = (function()
	...
	function Element:New(Idx, Config)
		...
		-- PercentLabel อยู่ขวา track อยู่ซ้าย — ไม่ทับกัน
		local PercentLabel = New("TextLabel", {
			Text = "0%",
			FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Medium),
			TextSize = 11,
			Position = UDim2.new(1, -10, 1, -19),
			AnchorPoint = Vector2.new(1, 0.5),
			BackgroundTransparency = 1,
		...
		-- Track หลีกทาง label: -20 (margin left) -46 (label width + gap)
...
ElementsTable.Badge = (function()
	...
	function Element:New(Idx, Config)
		...
		function Badge:Destroy() BadgeFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end

		if Idx then Library.Options[Idx] = Badge end
		return Badge
	end
	return Element
end)()
...
ElementsTable.Rating = (function()
	...
	function Element:New(Idx, Config)
		...
		function Rating:Destroy() RatingFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end
...
ElementsTable.ConfirmButton = (function()
	...
	function Element:New(Idx, Config)
		...
		function CFB:Destroy() CFBFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end
		if Idx then Library.Options[Idx] = CFB end
		return CFB
	end
	return Element
end)()
...
ElementsTable.MultiSlider = (function()
	...
	function Element:New(Idx, Config)
		...
		function MS:Destroy() MSFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end

		updateVisual()
		if Idx then Library.Options[Idx] = MS end
		return MS
	end
	return Element
end)()
...
ElementsTable.Accordion = (function()
	...
	function Element:New(Idx, Config)
		...
		-- ใช้ pattern เดียวกับ Section: setmetatable กับ Elements
		-- เพื่อให้ AddToggle/AddSlider/AddButton ฯลฯ ทำงานได้ถูกต้อง
		Acc.Container   = ContentFrame
		Acc.ScrollFrame = self.ScrollFrame or ContentFrame

		setmetatable(Acc, Library.Elements)

		-- override เฉพาะ Open/Close/Destroy ที่ Accordion ต้องการเพิ่ม
		function Acc:Open()    toggle(true)  end
		function Acc:Close()   toggle(false) end
		function Acc:Destroy() Root:Destroy() if Idx then Library.Options[Idx] = nil end end
...
ElementsTable.ScrollableList = (function()
	...
	function Element:New(Idx, Config)
		...
		function SL:Destroy() SLFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end

		if Idx then Library.Options[Idx] = SL end
		return SL
	end
	return Element
end)()
...
ElementsTable.HotkeyRecorder = (function()
	...
	function Element:New(Idx, Config)
		...
		function HR:Destroy() HRFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end

		if Idx then Library.Options[Idx] = HR end
		return HR
	end
	return Element
end)()
...
ElementsTable.ImagePicker = (function()
	...
	function Element:New(Idx, Config)
		...
		function IP:Destroy() IPFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end

		if Idx then Library.Options[Idx] = IP end
		return IP
	end
	return Element
end)()
...
ElementsTable.ColorSwatch = (function()
	...
	function Element:New(Idx, Config)
		...
		function CS:Destroy() CSFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end

		if Idx then Library.Options[Idx] = CS end
		return CS
	end
	return Element
end)()
...
ElementsTable.GradientBar = (function()
	...
	function Element:New(Idx, Config)
		...
		function GB:Destroy() GBFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end
		if Idx then Library.Options[Idx] = GB end
		return GB
	end
	return Element
end)()
...
ElementsTable.InfoCard = (function()
	...
	function Element:New(Idx, Config)
		...
		function IC:Destroy() ICFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end
		if Idx then Library.Options[Idx] = IC end
		return IC
	end
	return Element
end)()
...
ElementsTable.AnimatedLabel = (function()
	...
	function Element:New(Idx, Config)
		...
		function AL:Destroy() ALFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end
		if Idx then Library.Options[Idx] = AL end
		return AL
	end
	return Element
end)()
...
ElementsTable.FavoriteButton = (function()
	...
	function Element:New(Idx, Config)
		...
		function FB:Destroy() FBFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end

		updateStar(Config.Default or false)
		if Idx then Library.Options[Idx] = FB end
		return FB
	end
	return Element
end)()
...
ElementsTable.TextCounter = (function()
	...
	function Element:New(Idx, Config)
		...
		function TC:Destroy() TCFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end

		if Idx then Library.Options[Idx] = TC end
		return TC
	end
	return Element
end)()
